...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(wbr6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 152, 0, 10893);
			attr_dev(a6, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a6, "rel", "nofollow");
			add_location(a6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 154, 3, 10946);
			attr_dev(a7, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 159, 0, 11220);
			add_location(li4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 154, 0, 10906);
			add_location(li5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 164, 0, 11396);
			add_location(li6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 166, 0, 11614);
			add_location(ul, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 153, 0, 10901);
			attr_dev(a8, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 169, 19, 11747);
			add_location(p9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 169, 0, 11727);
			add_location(brb12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 173, 0, 11857);
			attr_dev(a9, "href", "https://www.shadertoy.com/view/4dX3zl");
			add_location(a9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 177, 0, 11986);
			add_location(p10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 174, 0, 11867);
			add_location(p11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 178, 0, 12073);
			add_location(brb13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 180, 0, 12125);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 181, 0, 12133);
			add_location(brb14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 206, 0, 19406);
			attr_dev(a10, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a10, "rel", "nofollow");
			add_location(a10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 207, 9, 19422);
			attr_dev(a11, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 210, 4, 19565);
			add_location(p12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 207, 0, 19413);
			attr_dev(a12, "href", "https://registry.khronos.org/OpenGL/extensions/NV/NV_shader_atomic_float.txt");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 214, 0, 19743);
			attr_dev(a13, "href", "https://en.wikipedia.org/wiki/Compare-and-swap");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 218, 0, 19879);
			add_location(p13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 214, 0, 19661);
			add_location(p14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 222, 0, 19992);
			add_location(p15, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 223, 0, 20050);
...
<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>uv <span class="token operator">+</span> anti_aliasing <span class="token operator">+</span> dof_sample<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(a15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 178, 6, 18514);
			attr_dev(a16, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a16, "rel", "nofollow");
			add_location(a16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 181, 1, 18657);
			add_location(p8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 178, 0, 18505);
			add_location(brb16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 185, 0, 18753);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 186, 0, 18761);
			attr_dev(a17, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a17, "rel", "nofollow");
			add_location(a17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 188, 7, 19286);
			attr_dev(a18, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a18, "rel", "nofollow");
			add_location(a18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 193, 0, 19560);
			add_location(li10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 188, 0, 19246);
			add_location(li11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 198, 0, 19736);
			add_location(li12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 200, 0, 19954);
			add_location(ul3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 187, 0, 19241);
			attr_dev(a19, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a19, "rel", "nofollow");
			add_location(a19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 203, 7, 20087);
			add_location(p9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 203, 0, 20067);
			add_location(brb17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 207, 0, 20197);
			add_location(strong2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 208, 0, 20209);
			add_location(h22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 208, 0, 20205);
			attr_dev(pre3, "class", "language-glsl");
			add_location(pre3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 209, 0, 20247);
			add_location(brb18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 225, 0, 25932);
			add_location(p10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 226, 0, 25940);
			attr_dev(a20, "href", "https://en.wikipedia.org/wiki/Affine_transformation");
			attr_dev(a20, "rel", "nofollow");
			add_location(a20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 227, 56, 26042);
			add_location(p11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 227, 0, 25981);
			attr_dev(a21, "href", "https://en.wikipedia.org/wiki/Inversive_geometry");
			attr_dev(a21, "rel", "nofollow");
			add_location(a21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 231, 0, 26181);
			add_location(code, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 234, 0, 26284);
			attr_dev(a22, "href", "https://en.wikipedia.org/wiki/M%C3%B6bius_transformation");
			attr_dev(a22, "rel", "nofollow");
			add_location(a22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 234, 0, 26333);
			attr_dev(a23, "href", "https://en.wikipedia.org/wiki/Conformal_map");
			attr_dev(a23, "rel", "nofollow");
			add_location(a23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 238, 39, 26527);
			add_location(p12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 231, 0, 26178);
			add_location(brb19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 242, 0, 26661);
			add_location(brb20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 244, 0, 26705);
			add_location(brb21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 245, 0, 26713);
			attr_dev(a24, "href", "https://github.com/bezo97/IFSRenderer");
			attr_dev(a24, "rel", "nofollow");
			add_location(a24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 3, 26724);
			...
			add_location(a25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 21, 26805);
			add_location(p13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 0, 26721);
			add_location(brb22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 250, 0, 27004);
			add_location(strong3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 251, 0, 27016);
			add_location(h23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 251, 0, 27012);
			attr_dev(a26, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a26, "rel", "nofollow");
			add_location(a26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 7, 27101);
			add_location(p14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 0, 27060);
			add_location(p15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 256, 0, 27327);
			attr_dev(a27, "href", "https://64.github.io/tonemapping/");
			attr_dev(a27, "rel", "nofollow");
			add_location(a27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 257, 71, 27494);
			add_location(p16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 257, 0, 27372);
			attr_dev(a28, "href", "https://www-old.cs.utah.edu/docs/techreports/2002/pdf/UUCS-02-001.pdf");
			attr_dev(a28, "rel", "nofollow");
			add_location(a28, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 261, 0, 27686);
			add_location(p17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 261, 0, 27586);
			add_location(brb23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 267, 1, 28028);
			attr_dev(pre4, "class", "language-glsl");
			add_location(pre4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 268, 1, 28036);
			add_location(strong4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32123);
			add_location(h24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32119);
			attr_dev(a29, "href", "https://www.pouet.net/prod.php?which=82417");
			attr_dev(a29, "rel", "nofollow");
			add_location(a29, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32163);
			add_location(p18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32160);
			add_location(brb24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32417);
			attr_dev(pre5, "class", "language-glsl");
			add_location(pre5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32425);
			add_location(brb25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 34496);
			add_location(p19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 34504);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function NavBar_svelte_add_css(target) {
	append_styles(target, "svelte-n55t47", "#bar.svelte-n55t47.svelte-n55t47{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-n55t47 #bar-left.svelte-n55t47{display:flex;flex-direction:column}#bar.svelte-n55t47 mark.svelte-n55t47{background:var(--accent-dark)}#bar.svelte-n55t47 .logo.svelte-n55t47{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-n55t47 .logo.logo-behind.svelte-n55t47{position:absolute}#bar.svelte-n55t47 .logo.hovered.svelte-n55t47{color:var(--accent-dark) !important}#bar.svelte-n55t47 .logo.hovered.hover-effect-0.svelte-n55t47{animation:svelte-n55t47-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-n55t47-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-n55t47-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-n55t47-glitch-anim3{0%{clip:rect(3.5rem, 9999px, 1rem, 0);transform-origin:center}2%{clip:rect(0.2rem, 9999px, 1.5rem, 0);transform-origin:center}4%{clip:rect(0.2rem, 9999px, 2.5rem, 0);transform-origin:center}6%{clip:rect(2.9rem, 9999px, 4.5rem, 0);transform-origin:center}8%{clip:rect(0.6rem, 9999px, 4.5rem, 0);transform-origin:center}10%{clip:rect(0.7rem, 9999px, 3.5rem, 0);transform-origin:center}12%{clip:rect(0.7rem, 9999px, 4.5rem, 0);transform-origin:center}14%{clip:rect(3.2rem, 9999px, 0.5rem, 0);transform-origin:center}16%{clip:rect(1.6rem, 9999px, 3rem, 0);transform-origin:center}18%{clip:rect(3.9rem, 9999px, 5rem, 0);transform-origin:center}20%{clip:rect(2rem, 9999px, 5rem, 0);transform-origin:center}22%{clip:rect(0.2rem, 9999px, 2.5rem, 0);transform-origin:center}24%{clip:rect(1rem, 9999px, 2rem, 0);transform-origin:center}26%{clip:rect(3.2rem, 9999px, 1rem, 0);transform-origin:center}28%{clip:rect(1.3rem, 9999px, 5rem, 0);transform-origin:center}30%{clip:rect(2.6rem, 9999px, 1.5rem, 0);transform-origin:center}32%{clip:rect(1.6rem, 9999px, 2rem, 0);transform-origin:center}34%{clip:rect(3.6rem, 9999px, 2rem, 0);transform-origin:center}36%{clip:rect(1.5rem, 9999px, 2rem, 0);transform-origin:center}38%{clip:rect(4rem, 9999px, 5rem, 0);transform-origin:center}40%{clip:rect(1.6rem, 9999px, 4rem, 0);transform-origin:center}42%{clip:rect(2.1rem, 9999px, 4rem, 0);transform-origin:center}44%{clip:rect(3.1rem, 9999px, 4.5rem, 0);transform-origin:center}46%{clip:rect(2.6rem, 9999px, 4rem, 0);transform-origin:center}48%{clip:rect(1.8rem, 9999px, 2rem, 0);transform-origin:center}50%{clip:rect(0.1rem, 9999px, 4.5rem, 0);transform-origin:center}52%{clip:rect(0.2rem, 9999px, 4rem, 0);transform-origin:center}54%{clip:rect(4rem, 9999px, 3.5rem, 0);transform-origin:center}56%{clip:rect(3.1rem, 9999px, 3.5rem, 0);transform-origin:center}58%{clip:rect(2.6rem, 9999px, 3rem, 0);transform-origin:center}60%{clip:rect(2.3rem, 9999px, 4.5rem, 0);transform-origin:center}62%{clip:rect(1.8rem, 9999px, 1rem, 0);transform-origin:center}64%{clip:rect(0.3rem, 9999px, 3rem, 0);transform-origin:center}66%{clip:rect(0.9rem, 9999px, 2rem, 0);transform-origin:center}68%{clip:rect(1.8rem, 9999px, 0.5rem, 0);transform-origin:center}70%{clip:rect(0.5rem, 9999px, 3.5rem, 0);transform-origin:center}72%{clip:rect(3.4rem, 9999px, 5rem, 0);transform-origin:center}74%{clip:rect(3.8rem, 9999px, 2.5rem, 0);transform-origin:center}76%{clip:rect(0.4rem, 9999px, 2rem, 0);transform-origin:center}78%{clip:rect(0.4rem, 9999px, 3rem, 0);transform-origin:center}80%{clip:rect(0.1rem, 9999px, 0.5rem, 0);transform-origin:center}82%{clip:rect(2rem, 9999px, 0.5rem, 0);transform-origin:center}84%{clip:rect(1.6rem, 9999px, 4rem, 0);transform-origin:center}86%{clip:rect(0.8rem, 9999px, 0.5rem, 0);transform-origin:center}88%{clip:rect(3.1rem, 9999px, 4rem, 0);transform-origin:center}90%{clip:rect(1.5rem, 9999px, 3rem, 0);transform-origin:center}92%{clip:rect(2.1rem, 9999px, 4rem, 0);transform-origin:center}94%{clip:rect(3.4rem, 9999px, 1rem, 0);transform-origin:center}96%{clip:rect(1.7rem, 9999px, 4rem, 0);transform-origin:center}98%{clip:rect(2.8rem, 9999px, 4rem, 0);transform-origin:center}}@keyframes svelte-n55t47-cooool{0%{color:red !important}2%{color:red !important}4%{color:red !important}6%{color:red !important}8%{color:red !important}10%{color:red !important}12%{color:red !important}14%{color:red !important}16%{color:red !important}18%{color:red !important}20%{color:red !important}22%{color:red !important}24%{color:red !important}26%{color:red !important}28%{color:red !important}30%{color:red !important}32%{color:red !important}34%{color:red !important}36%{color:red !important}38%{color:red !important}40%{color:red !important}42%{color:red !important}44%{color:red !important}46%{color:red !important}48%{color:red !important}50%{color:red !important}52%{color:red !important}54%{color:red !important}56%{color:red !important}58%{color:red !important}60%{color:red !important}62%{color:red !important}64%{color:red !important}66%{color:red !important}68%{color:red !important}70%{color:red !important}72%{color:red !important}74%{color:red !important}76%{color:red !important}78%{color:red !important}80%{color:red !important}82%{color:red !important}84%{color:red !important}86%{color:red !important}88%{color:red !important}90%{color:red !important}92%{color:red !important}94%{color:red !important}96%{color:red !important}98%{color:red !important}}#bar.svelte-n55t47 .logo.hovered.hover-effect-0.logo-behind-a.svelte-n55t47{color:#ffc800 !important;animation:svelte-n55t47-distort1 300ms linear infinite, svelte-n55t47-glitch-anim3 5s infinite linear alternate-reverse, svelte-n55t47-cooool 5s infinite linear alternate-reverse}#bar.svelte-n55t47 .logo.hovered.hover-effect-0.logo-behind-b.svelte-n55t47{color:#aa10f2 !important;animation:svelte-n55t47-distort2 300ms linear infinite, svelte-n55t47-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-n55t47 .logo.hover-effect-1.svelte-n55t47{animation:svelte-n55t47-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-n55t47-glitch-anim{0%{clip:rect(3.6rem, 9999px, 4rem, 0);transform:skew(7deg);z-index:4}2%{clip:rect(1.5rem, 9999px, 0.5rem, 0);transform:skew(1.1deg);z-index:3}4%{clip:rect(2.2rem, 9999px, 3rem, 0);transform:skew(8.8deg);z-index:4}6%{clip:rect(3.4rem, 9999px, 5rem, 0);transform:skew(1deg);z-index:3}8%{clip:rect(2.1rem, 9999px, 3.5rem, 0);transform:skew(0.4deg);z-index:4}10%{clip:rect(0.7rem, 9999px, 0.5rem, 0);transform:skew(5.2deg);z-index:4}12%{clip:rect(3.1rem, 9999px, 4rem, 0);transform:skew(4.3deg);z-index:1}14%{clip:rect(2.6rem, 9999px, 1.5rem, 0);transform:skew(3deg);z-index:2}16%{clip:rect(2.9rem, 9999px, 1.5rem, 0);transform:skew(4.6deg);z-index:1}18%{clip:rect(0.7rem, 9999px, 4.5rem, 0);transform:skew(1.8deg);z-index:2}20%{clip:rect(3.5rem, 9999px, 3.5rem, 0);transform:skew(5.7deg);z-index:3}22%{clip:rect(2.5rem, 9999px, 2rem, 0);transform:skew(2.6deg);z-index:4}24%{clip:rect(0.1rem, 9999px, 0.5rem, 0);transform:skew(9.4deg);z-index:2}26%{clip:rect(0.1rem, 9999px, 4rem, 0);transform:skew(3.3deg);z-index:4}28%{clip:rect(0.1rem, 9999px, 1rem, 0);transform:skew(4.9deg);z-index:2}30%{clip:rect(2.3rem, 9999px, 5rem, 0);transform:skew(6.6deg);z-index:4}32%{clip:rect(1.4rem, 9999px, 3rem, 0);transform:skew(1.7deg);z-index:3}34%{clip:rect(2.8rem, 9999px, 2rem, 0);transform:skew(4.8deg);z-index:4}36%{clip:rect(2.8rem, 9999px, 4.5rem, 0);transform:skew(6.4deg);z-index:1}38%{clip:rect(1.9rem, 9999px, 4rem, 0);transform:skew(9.9deg);z-index:1}40%{clip:rect(2.1rem, 9999px, 1rem, 0);transform:skew(1.8deg);z-index:2}42%{clip:rect(2rem, 9999px, 1rem, 0);transform:skew(8.1deg);z-index:4}44%{clip:rect(1.4rem, 9999px, 2.5rem, 0);transform:skew(0.8deg);z-index:1}46%{clip:rect(0.9rem, 9999px, 1rem, 0);transform:skew(10deg);z-index:1}48%{clip:rect(2.2rem, 9999px, 4rem, 0);transform:skew(5.7deg);z-index:3}50%{clip:rect(3.3rem, 9999px, 2rem, 0);transform:skew(8.3deg);z-index:3}52%{clip:rect(3.4rem, 9999px, 3rem, 0);transform:skew(5.5deg);z-index:1}54%{clip:rect(2.1rem, 9999px, 1rem, 0);transform:skew(6deg);z-index:1}56%{clip:rect(2.4rem, 9999px, 3.5rem, 0);transform:skew(1.5deg);z-index:4}58%{clip:rect(2.7rem, 9999px, 0.5rem, 0);transform:skew(0.6deg);z-index:2}60%{clip:rect(2.8rem, 9999px, 3.5rem, 0);transform:skew(8.4deg);z-index:4}62%{clip:rect(3.8rem, 9999px, 4rem, 0);transform:skew(0.9deg);z-index:1}64%{clip:rect(3.9rem, 9999px, 4rem, 0);transform:skew(1.7deg);z-index:1}66%{clip:rect(2.3rem, 9999px, 2rem, 0);transform:skew(5.6deg);z-index:2}68%{clip:rect(2.5rem, 9999px, 4.5rem, 0);transform:skew(7.9deg);z-index:4}70%{clip:rect(0.1rem, 9999px, 1rem, 0);transform:skew(6.3deg);z-index:1}72%{clip:rect(0.5rem, 9999px, 4rem, 0);transform:skew(4.4deg);z-index:1}74%{clip:rect(1.6rem, 9999px, 4rem, 0);transform:skew(9.2deg);z-index:3}76%{clip:rect(0.3rem, 9999px, 2rem, 0);transform:skew(9.2deg);z-index:4}78%{clip:rect(2.1rem, 9999px, 3.5rem, 0);transform:skew(1.7deg);z-index:1}80%{clip:rect(1.1rem, 9999px, 1.5rem, 0);transform:skew(9.7deg);z-index:2}82%{clip:rect(3.7rem, 9999px, 5rem, 0);transform:skew(0.8deg);z-index:4}84%{clip:rect(4rem, 9999px, 1.5rem, 0);transform:skew(4.4deg);z-index:2}86%{clip:rect(1.4rem, 9999px, 2rem, 0);transform:skew(0.3deg);z-index:2}88%{clip:rect(0.8rem, 9999px, 1.5rem, 0);transform:skew(0.4deg);z-index:4}90%{clip:rect(2.3rem, 9999px, 3rem, 0);transform:skew(2.8deg);z-index:2}92%{clip:rect(2.6rem, 9999px, 4.5rem, 0);transform:skew(8.1deg);z-index:4}94%{clip:rect(2.8rem, 9999px, 1rem, 0);transform:skew(8.4deg);z-index:2}96%{clip:rect(2.6rem, 9999px, 2.5rem, 0);transform:skew(3deg);z-index:4}98%{clip:rect(1.1rem, 9999px, 1.5rem, 0);transform:skew(2.4deg);z-index:1}}@keyframes svelte-n55t47-glitch-anim2{0%{clip:rect(0.2rem, 99999px, 3.2rem, 0);transform:skew(2.8deg);transform:translateX(0.4259259259rem)}0.6666666667%{clip:rect(0.12rem, 99999px, 9.3rem, 0);transform:skew(9.5deg);transform:translateX(0.0555555556rem)}1.3333333333%{clip:rect(0.12rem, 99999px, 6.4rem, 0);transform:skew(9.2deg);transform:translateX(0.1666666667rem)}2%{clip:rect(0.04rem, 99999px, 1.2rem, 0);transform:skew(3.9deg);transform:translateX(0.3888888889rem)}2.6666666667%{clip:rect(0.12rem, 99999px, 7.1rem, 0);transform:skew(10.5deg);transform:translateX(0.3888888889rem)}3.3333333333%{clip:rect(0.04rem, 99999px, 1.8rem, 0);transform:skew(6.7deg);transform:translateX(0.0555555556rem)}4%{clip:rect(0.14rem, 99999px, 3.3rem, 0);transform:skew(7deg);transform:translateX(-0.1666666667rem)}4.6666666667%{clip:rect(0.08rem, 99999px, 3.9rem, 0);transform:skew(13.6deg);transform:translateX(0.2777777778rem)}5.3333333333%{clip:rect(0.14rem, 99999px, 7.4rem, 0);transform:skew(8.1deg);transform:translateX(0.3333333333rem)}6%{clip:rect(0.18rem, 99999px, 4.2rem, 0);transform:skew(14deg);transform:translateX(0.1666666667rem)}6.6666666667%{clip:rect(0.2rem, 99999px, 4.9rem, 0);transform:skew(10.5deg);transform:translateX(0.4259259259rem)}7.3333333333%{clip:rect(0.1rem, 99999px, 1.3rem, 0);transform:skew(6.8deg);transform:translateX(0.2777777778rem)}8%{clip:rect(0.2rem, 99999px, 9.7rem, 0);transform:skew(2.1deg);transform:translateX(0.0555555556rem)}8.6666666667%{clip:rect(0.16rem, 99999px, 4.7rem, 0);transform:skew(12.2deg);transform:translateX(0.2777777778rem)}9.3333333333%{clip:rect(0.16rem, 99999px, 8rem, 0);transform:skew(3.8deg);transform:translateX(0.4259259259rem)}10%{clip:rect(0.2rem, 99999px, 4.9rem, 0);transform:skew(12.8deg);transform:translateX(0.2777777778rem)}10.6666666667%{clip:rect(0.12rem, 99999px, 3.3rem, 0);transform:skew(1.5deg);transform:translateX(0.2777777778rem)}11.3333333333%{clip:rect(0.1rem, 99999px, 9rem, 0);transform:skew(11.6deg);transform:translateX(0.4259259259rem)}12%{clip:rect(0.1rem, 99999px, 7.9rem, 0);transform:skew(5.8deg);transform:translateX(0.3888888889rem)}12.6666666667%{clip:rect(0.18rem, 99999px, 5.3rem, 0);transform:skew(7.5deg);transform:translateX(0.2777777778rem)}13.3333333333%{clip:rect(0.2rem, 99999px, 8.1rem, 0);transform:skew(7.9deg);transform:translateX(0.2777777778rem)}14%{clip:rect(0.08rem, 99999px, 6.8rem, 0);transform:skew(4deg);transform:translateX(0.1666666667rem)}14.6666666667%{clip:rect(0.1rem, 99999px, 2.1rem, 0);transform:skew(9.5deg);transform:translateX(0.4444444444rem)}15.3333333333%{clip:rect(0.1rem, 99999px, 6rem, 0);transform:skew(1.4deg);transform:translateX(0.2037037037rem)}16%{clip:rect(0.14rem, 99999px, 7rem, 0);transform:skew(7.6deg);transform:translateX(0.3333333333rem)}16.6666666667%{clip:rect(0.02rem, 99999px, 4rem, 0);transform:skew(12.9deg);transform:translateX(0.4444444444rem)}17.3333333333%{clip:rect(0.04rem, 99999px, 7.5rem, 0);transform:skew(5.5deg);transform:translateX(0.4444444444rem)}18%{clip:rect(0.1rem, 99999px, 8.5rem, 0);transform:skew(12.6deg);transform:translateX(0.0555555556rem)}18.6666666667%{clip:rect(0.18rem, 99999px, 5.2rem, 0);transform:skew(5.9deg);transform:translateX(0.2777777778rem)}19.3333333333%{clip:rect(0.18rem, 99999px, 7.8rem, 0);transform:skew(14.1deg);transform:translateX(-0.5rem)}20%{clip:rect(0.1rem, 99999px, 9.2rem, 0);transform:skew(6.9deg);transform:translateX(0.462962963rem)}20.6666666667%{clip:rect(0.2rem, 99999px, 9.5rem, 0);transform:skew(12.7deg);transform:translateX(0.0555555556rem)}21.3333333333%{clip:rect(0.1rem, 99999px, 4.6rem, 0);transform:skew(14.3deg);transform:translateX(0.2777777778rem)}22%{clip:rect(0.04rem, 99999px, 5.5rem, 0);transform:skew(0.3deg);transform:translateX(0.4259259259rem)}22.6666666667%{clip:rect(0.02rem, 99999px, 3.1rem, 0);transform:skew(8deg);transform:translateX(0.2777777778rem)}23.3333333333%{clip:rect(0.08rem, 99999px, 0.5rem, 0);transform:skew(10.6deg);transform:translateX(-0.1666666667rem)}24%{clip:rect(0.2rem, 99999px, 3.9rem, 0);transform:skew(13.9deg);transform:translateX(0.4259259259rem)}24.6666666667%{clip:rect(0.04rem, 99999px, 9rem, 0);transform:skew(4.4deg);transform:translateX(0.2777777778rem)}25.3333333333%{clip:rect(0.02rem, 99999px, 4.2rem, 0);transform:skew(9.4deg);transform:translateX(-0.1666666667rem)}26%{clip:rect(0.04rem, 99999px, 1.8rem, 0);transform:skew(4.8deg);transform:translateX(0.4444444444rem)}26.6666666667%{clip:rect(0.06rem, 99999px, 2.4rem, 0);transform:skew(5.2deg);transform:translateX(0.3518518519rem)}27.3333333333%{clip:rect(0.1rem, 99999px, 3.2rem, 0);transform:skew(8.9deg);transform:translateX(0.4259259259rem)}28%{clip:rect(0.16rem, 99999px, 3.7rem, 0);transform:skew(1.3deg);transform:translateX(0.4444444444rem)}28.6666666667%{clip:rect(0.06rem, 99999px, 4.8rem, 0);transform:skew(7.1deg);transform:translateX(0.462962963rem)}29.3333333333%{clip:rect(0.14rem, 99999px, 9.9rem, 0);transform:skew(2.5deg);transform:translateX(0.4259259259rem)}30%{clip:rect(0.04rem, 99999px, 8.3rem, 0);transform:skew(10.4deg);transform:translateX(0.0555555556rem)}30.6666666667%{clip:rect(0.16rem, 99999px, 7.3rem, 0);transform:skew(9.2deg);transform:translateX(0.2777777778rem)}31.3333333333%{clip:rect(0.14rem, 99999px, 4.9rem, 0);transform:skew(7.2deg);transform:translateX(0.1666666667rem)}32%{clip:rect(0.02rem, 99999px, 5.1rem, 0);transform:skew(12.5deg);transform:translateX(0.1666666667rem)}32.6666666667%{clip:rect(0.1rem, 99999px, 7.5rem, 0);transform:skew(7.3deg);transform:translateX(0.1666666667rem)}33.3333333333%{clip:rect(0.06rem, 99999px, 7.4rem, 0);transform:skew(12.7deg);transform:translateX(0.2777777778rem)}34%{clip:rect(0.14rem, 99999px, 6.6rem, 0);transform:skew(1.9deg);transform:translateX(0.2777777778rem)}34.6666666667%{clip:rect(0.04rem, 99999px, 3.1rem, 0);transform:skew(3.5deg);transform:translateX(0.3888888889rem)}35.3333333333%{clip:rect(0.18rem, 99999px, 4.2rem, 0);transform:skew(9.9deg);transform:translateX(0.3888888889rem)}36%{clip:rect(0.14rem, 99999px, 1.8rem, 0);transform:skew(11deg);transform:translateX(0.3888888889rem)}36.6666666667%{clip:rect(0.16rem, 99999px, 6.2rem, 0);transform:skew(1.1deg);transform:translateX(0.1666666667rem)}37.3333333333%{clip:rect(0.06rem, 99999px, 8.3rem, 0);transform:skew(11.4deg);transform:translateX(0.2777777778rem)}38%{clip:rect(0.18rem, 99999px, 1.1rem, 0);transform:skew(2.4deg);transform:translateX(0.3518518519rem)}38.6666666667%{clip:rect(0.06rem, 99999px, 4.1rem, 0);transform:skew(14.7deg);transform:translateX(0.1666666667rem)}39.3333333333%{clip:rect(0.06rem, 99999px, 3.5rem, 0);transform:skew(8.9deg);transform:translateX(0.0555555556rem)}40%{clip:rect(0.08rem, 99999px, 2.4rem, 0);transform:skew(1.2deg);transform:translateX(0.1666666667rem)}40.6666666667%{clip:rect(0.08rem, 99999px, 5.1rem, 0);transform:skew(5.3deg);transform:translateX(0.4444444444rem)}41.3333333333%{clip:rect(0.12rem, 99999px, 0.4rem, 0);transform:skew(10.1deg);transform:translateX(-0.1666666667rem)}42%{clip:rect(0.18rem, 99999px, 9.3rem, 0);transform:skew(11.2deg);transform:translateX(0.2037037037rem)}42.6666666667%{clip:rect(0.18rem, 99999px, 5.8rem, 0);transform:skew(14.9deg);transform:translateX(0.462962963rem)}43.3333333333%{clip:rect(0.16rem, 99999px, 9.6rem, 0);transform:skew(7.5deg);transform:translateX(0.4259259259rem)}44%{clip:rect(0.04rem, 99999px, 8.8rem, 0);transform:skew(4.7deg);transform:translateX(0.3888888889rem)}44.6666666667%{clip:rect(0.18rem, 99999px, 7.5rem, 0);transform:skew(4.6deg);transform:translateX(0.1666666667rem)}45.3333333333%{clip:rect(0.16rem, 99999px, 7.8rem, 0);transform:skew(12.8deg);transform:translateX(0.1666666667rem)}46%{clip:rect(0.08rem, 99999px, 2.6rem, 0);transform:skew(14.6deg);transform:translateX(0.4259259259rem)}46.6666666667%{clip:rect(0.06rem, 99999px, 9.1rem, 0);transform:skew(10.4deg);transform:translateX(0.3888888889rem)}47.3333333333%{clip:rect(0.16rem, 99999px, 8.5rem, 0);transform:skew(13.6deg);transform:translateX(0.0555555556rem)}48%{clip:rect(0.16rem, 99999px, 7.5rem, 0);transform:skew(13.6deg);transform:translateX(0.1666666667rem)}48.6666666667%{clip:rect(0.04rem, 99999px, 5.7rem, 0);transform:skew(12.6deg);transform:translateX(0.3888888889rem)}49.3333333333%{clip:rect(0.08rem, 99999px, 8rem, 0);transform:skew(2.7deg);transform:translateX(0.3888888889rem)}50%{clip:rect(0.04rem, 99999px, 7.2rem, 0);transform:skew(2.8deg);transform:translateX(0.1666666667rem)}50.6666666667%{clip:rect(0.2rem, 99999px, 3.8rem, 0);transform:skew(13.8deg);transform:translateX(0.4259259259rem)}51.3333333333%{clip:rect(0.16rem, 99999px, 0.6rem, 0);transform:skew(13.8deg);transform:translateX(0.3518518519rem)}52%{clip:rect(0.18rem, 99999px, 0.1rem, 0);transform:skew(14deg);transform:translateX(0.462962963rem)}52.6666666667%{clip:rect(0.18rem, 99999px, 5.5rem, 0);transform:skew(13.7deg);transform:translateX(0.2777777778rem)}53.3333333333%{clip:rect(0.16rem, 99999px, 5.8rem, 0);transform:skew(9.6deg);transform:translateX(0.3888888889rem)}54%{clip:rect(0.02rem, 99999px, 4.2rem, 0);transform:skew(3.7deg);transform:translateX(0.3518518519rem)}54.6666666667%{clip:rect(0.08rem, 99999px, 1.5rem, 0);transform:skew(10.1deg);transform:translateX(0.3888888889rem)}55.3333333333%{clip:rect(0.16rem, 99999px, 1.7rem, 0);transform:skew(12deg);transform:translateX(0.3518518519rem)}56%{clip:rect(0.14rem, 99999px, 8.7rem, 0);transform:skew(9.5deg);transform:translateX(0.1666666667rem)}56.6666666667%{clip:rect(0.2rem, 99999px, 1.8rem, 0);transform:skew(6.4deg);transform:translateX(0.4259259259rem)}57.3333333333%{clip:rect(0.06rem, 99999px, 8rem, 0);transform:skew(5.8deg);transform:translateX(0.1666666667rem)}58%{clip:rect(0.18rem, 99999px, 2.3rem, 0);transform:skew(14.5deg);transform:translateX(0.2777777778rem)}58.6666666667%{clip:rect(0.08rem, 99999px, 7rem, 0);transform:skew(5.6deg);transform:translateX(0.4444444444rem)}59.3333333333%{clip:rect(0.06rem, 99999px, 5.8rem, 0);transform:skew(2.6deg);transform:translateX(0.2777777778rem)}60%{clip:rect(0.14rem, 99999px, 1.1rem, 0);transform:skew(7.1deg);transform:translateX(0.1666666667rem)}60.6666666667%{clip:rect(0.02rem, 99999px, 1.1rem, 0);transform:skew(1.1deg);transform:translateX(0.3888888889rem)}61.3333333333%{clip:rect(0.02rem, 99999px, 5rem, 0);transform:skew(12.6deg);transform:translateX(0.3518518519rem)}62%{clip:rect(0.04rem, 99999px, 5.6rem, 0);transform:skew(14.9deg);transform:translateX(0.3518518519rem)}62.6666666667%{clip:rect(0.16rem, 99999px, 7.2rem, 0);transform:skew(7.6deg);transform:translateX(0.2777777778rem)}63.3333333333%{clip:rect(0.06rem, 99999px, 6.6rem, 0);transform:skew(12.2deg);transform:translateX(0.3888888889rem)}64%{clip:rect(0.14rem, 99999px, 7rem, 0);transform:skew(8.1deg);transform:translateX(0.4259259259rem)}64.6666666667%{clip:rect(0.14rem, 99999px, 3.8rem, 0);transform:skew(8.8deg);transform:translateX(0.4259259259rem)}65.3333333333%{clip:rect(0.02rem, 99999px, 4.5rem, 0);transform:skew(0.7deg);transform:translateX(0.1666666667rem)}66%{clip:rect(0.1rem, 99999px, 8.6rem, 0);transform:skew(2deg);transform:translateX(0.1666666667rem)}66.6666666667%{clip:rect(0.12rem, 99999px, 1.9rem, 0);transform:skew(6.2deg);transform:translateX(0.4814814815rem)}67.3333333333%{clip:rect(0.06rem, 99999px, 2.9rem, 0);transform:skew(8.4deg);transform:translateX(0.2037037037rem)}68%{clip:rect(0.04rem, 99999px, 6.5rem, 0);transform:skew(3.4deg);transform:translateX(0.3888888889rem)}68.6666666667%{clip:rect(0.16rem, 99999px, 4.5rem, 0);transform:skew(7.4deg);transform:translateX(0.3333333333rem)}69.3333333333%{clip:rect(0.16rem, 99999px, 8rem, 0);transform:skew(13deg);transform:translateX(0.3518518519rem)}70%{clip:rect(0.16rem, 99999px, 6.2rem, 0);transform:skew(10.1deg);transform:translateX(0.1666666667rem)}70.6666666667%{clip:rect(0.04rem, 99999px, 2.6rem, 0);transform:skew(14.4deg);transform:translateX(0.2777777778rem)}71.3333333333%{clip:rect(0.2rem, 99999px, 0.9rem, 0);transform:skew(14.9deg);transform:translateX(0.2777777778rem)}72%{clip:rect(0.14rem, 99999px, 1.5rem, 0);transform:skew(6.9deg);transform:translateX(0.2037037037rem)}72.6666666667%{clip:rect(0.18rem, 99999px, 6.7rem, 0);transform:skew(13deg);transform:translateX(-0.1666666667rem)}73.3333333333%{clip:rect(0.12rem, 99999px, 6.2rem, 0);transform:skew(13.6deg);transform:translateX(0.2777777778rem)}74%{clip:rect(0.08rem, 99999px, 6.8rem, 0);transform:skew(3.2deg);transform:translateX(0.2777777778rem)}74.6666666667%{clip:rect(0.12rem, 99999px, 5.4rem, 0);transform:skew(5.9deg);transform:translateX(0.2777777778rem)}75.3333333333%{clip:rect(0.08rem, 99999px, 1.1rem, 0);transform:skew(6.1deg);transform:translateX(0.3888888889rem)}76%{clip:rect(0.02rem, 99999px, 8rem, 0);transform:skew(3.2deg);transform:translateX(-0.1666666667rem)}76.6666666667%{clip:rect(0.2rem, 99999px, 5.3rem, 0);transform:skew(13.8deg);transform:translateX(0.3888888889rem)}77.3333333333%{clip:rect(0.1rem, 99999px, 7.7rem, 0);transform:skew(8deg);transform:translateX(0.4444444444rem)}78%{clip:rect(0.1rem, 99999px, 7.7rem, 0);transform:skew(2.7deg);transform:translateX(0.4259259259rem)}78.6666666667%{clip:rect(0.02rem, 99999px, 0.9rem, 0);transform:skew(4.2deg);transform:translateX(0.4259259259rem)}79.3333333333%{clip:rect(0.02rem, 99999px, 0.2rem, 0);transform:skew(10.5deg);transform:translateX(0.4259259259rem)}80%{clip:rect(0.02rem, 99999px, 5.7rem, 0);transform:skew(9.7deg);transform:translateX(0.4259259259rem)}80.6666666667%{clip:rect(0.2rem, 99999px, 6rem, 0);transform:skew(12.7deg);transform:translateX(-0.5rem)}81.3333333333%{clip:rect(0.06rem, 99999px, 3.4rem, 0);transform:skew(0.4deg);transform:translateX(0.3518518519rem)}82%{clip:rect(0.1rem, 99999px, 3.7rem, 0);transform:skew(13.7deg);transform:translateX(0.2777777778rem)}82.6666666667%{clip:rect(0.18rem, 99999px, 6.8rem, 0);transform:skew(4.4deg);transform:translateX(0.3888888889rem)}83.3333333333%{clip:rect(0.04rem, 99999px, 4.4rem, 0);transform:skew(14.5deg);transform:translateX(0.462962963rem)}84%{clip:rect(0.12rem, 99999px, 1.8rem, 0);transform:skew(1.4deg);transform:translateX(0.3333333333rem)}84.6666666667%{clip:rect(0.08rem, 99999px, 6.3rem, 0);transform:skew(3.1deg);transform:translateX(0.4444444444rem)}85.3333333333%{clip:rect(0.08rem, 99999px, 8.7rem, 0);transform:skew(0.2deg);transform:translateX(0.3333333333rem)}86%{clip:rect(0.2rem, 99999px, 9.7rem, 0);transform:skew(9.8deg);transform:translateX(0.3888888889rem)}86.6666666667%{clip:rect(0.06rem, 99999px, 8.1rem, 0);transform:skew(12.6deg);transform:translateX(0.462962963rem)}87.3333333333%{clip:rect(0.02rem, 99999px, 7.6rem, 0);transform:skew(1.4deg);transform:translateX(0.3888888889rem)}88%{clip:rect(0.2rem, 99999px, 8rem, 0);transform:skew(9.3deg);transform:translateX(0.2777777778rem)}88.6666666667%{clip:rect(0.12rem, 99999px, 2.9rem, 0);transform:skew(14.5deg);transform:translateX(0.3888888889rem)}89.3333333333%{clip:rect(0.18rem, 99999px, 7.4rem, 0);transform:skew(3.4deg);transform:translateX(0.462962963rem)}90%{clip:rect(0.1rem, 99999px, 4.7rem, 0);transform:skew(5.8deg);transform:translateX(0.2777777778rem)}90.6666666667%{clip:rect(0.2rem, 99999px, 4.6rem, 0);transform:skew(5.8deg);transform:translateX(0.4259259259rem)}91.3333333333%{clip:rect(0.16rem, 99999px, 2.7rem, 0);transform:skew(11deg);transform:translateX(0.3333333333rem)}92%{clip:rect(0.2rem, 99999px, 1.7rem, 0);transform:skew(12.4deg);transform:translateX(0.462962963rem)}92.6666666667%{clip:rect(0.1rem, 99999px, 6.6rem, 0);transform:skew(2.1deg);transform:translateX(0.4259259259rem)}93.3333333333%{clip:rect(0.16rem, 99999px, 5.5rem, 0);transform:skew(14.9deg);transform:translateX(0.4259259259rem)}94%{clip:rect(0.04rem, 99999px, 6.3rem, 0);transform:skew(15deg);transform:translateX(0.3518518519rem)}94.6666666667%{clip:rect(0.02rem, 99999px, 1.1rem, 0);transform:skew(12deg);transform:translateX(0.3518518519rem)}95.3333333333%{clip:rect(0.08rem, 99999px, 7.2rem, 0);transform:skew(6.8deg);transform:translateX(0.4259259259rem)}96%{clip:rect(0.18rem, 99999px, 3.4rem, 0);transform:skew(14.2deg);transform:translateX(-0.1666666667rem)}96.6666666667%{clip:rect(0.18rem, 99999px, 8.9rem, 0);transform:skew(10.8deg);transform:translateX(0.3888888889rem)}97.3333333333%{clip:rect(0.06rem, 99999px, 3.5rem, 0);transform:skew(4deg);transform:translateX(0.3888888889rem)}98%{clip:rect(0.08rem, 99999px, 0.6rem, 0);transform:skew(3.9deg);transform:translateX(0.4444444444rem)}98.6666666667%{clip:rect(0.18rem, 99999px, 9.7rem, 0);transform:skew(7.2deg);transform:translateX(0.4259259259rem)}99.3333333333%{clip:rect(0.14rem, 99999px, 4.6rem, 0);transform:skew(11.9deg);transform:translateX(0.1666666667rem)}}@keyframes svelte-n55t47-glitch-skew{0%{transform:skew(2deg)}10%{transform:skew(2deg)}20%{transform:skew(5deg)}30%{transform:skew(2deg)}40%{transform:skew(-1deg)}50%{transform:skew(-2deg)}60%{transform:skew(-2deg)}70%{transform:skew(3deg)}80%{transform:skew(3deg)}90%{transform:skew(1deg)}}#bar.svelte-n55t47 .logo.hover-effect-1.logo-behind-a.svelte-n55t47{color:var(--accent-light);transform:translateX(-0.5rem);color:#ffc800 !important;text-shadow:-2px 0 #ffc800, 2px 2px #ffc800;clip:rect(44px, 450px, 56px, 0);animation:svelte-n55t47-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-n55t47 .logo.hover-effect-1.logo-behind-b.svelte-n55t47{color:rgb(165, 49, 49) !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #aa10f2;clip:rect(44px, 450px, 56px, 0);animation:svelte-n55t47-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-n55t47 .logo.logo-behind.svelte-n55t47{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-n55t47 .logo.logo-behind.svelte-n55t47:not(.hovered){display:none}#bar.svelte-n55t47 #bar-right.svelte-n55t47{margin-left:auto;display:flex;margin-right:1rem;margin-top:1rem;position:relative}#bar.svelte-n55t47 #bar-right #menus.svelte-n55t47{display:flex}#bar.svelte-n55t47 #bar-right #menus #menu.svelte-n55t47{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-n55t47 #bar-right #menus #menu.svelte-n55t47 .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function NavBar_svelte_create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			style = dom_element("style");
			style.innerHTML = ``;
			add_location(style, NavBar_svelte_file, -1, 36992);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(style, NavBar_svelte_file, -1, 36875);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function NavBar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-n55t47");
			add_location(mark, NavBar_svelte_file, -1, 37225);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-n55t47");
			add_location(a0, NavBar_svelte_file, -1, 37153);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-n55t47");
			add_location(a1, NavBar_svelte_file, -1, 37268);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-n55t47");
			add_location(a2, NavBar_svelte_file, -1, 37360);
			attr_dev(div0, "id", "logo-container");
			add_location(div0, NavBar_svelte_file, -1, 37124);
			attr_dev(div1, "id", "bar-left");
			attr_dev(div1, "class", "svelte-n55t47");
			add_location(div1, NavBar_svelte_file, -1, 37077);
			attr_dev(div2, "id", "menu");
			attr_dev(div2, "class", "svelte-n55t47");
			add_location(div2, NavBar_svelte_file, -1, 37662);
			attr_dev(div3, "id", "menu");
			attr_dev(div3, "class", "svelte-n55t47");
			add_location(div3, NavBar_svelte_file, -1, 37963);
			attr_dev(div4, "id", "menus");
			attr_dev(div4, "class", "svelte-n55t47");
			add_location(div4, NavBar_svelte_file, -1, 37616);
			attr_dev(div5, "id", "bar-right");
			attr_dev(div5, "class", "svelte-n55t47");
			add_location(div5, NavBar_svelte_file, -1, 37517);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-n55t47");
			add_location(nav, NavBar_svelte_file, -1, 37034);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*hovered_class*/ 64 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-n55t47")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-n55t47")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-n55t47")) {
