...
<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>uv <span class="token operator">+</span> anti_aliasing <span class="token operator">+</span> dof_sample<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			t181 = space();
			p21 = dom_element("p");
			p21.textContent = "Here are some of my artworks:";
			t183 = space();
			...
			add_location(a29, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 262, 76, 27688);
			...
			add_location(brb24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 301, 0, 34498);
			add_location(strong5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 302, 4, 34510);
			add_location(h25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 302, 0, 34506);
			attr_dev(a31, "href", "https://www.pouet.net/prod.php?which=82417");
			attr_dev(a31, "rel", "nofollow");
			add_location(a31, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 303, 0, 34560);
			add_location(p19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 303, 0, 34544);
			add_location(brb25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 308, 0, 34878);
			add_location(strong6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 309, 0, 34890);
			add_location(h26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 309, 0, 34886);
			add_location(brb26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 310, 0, 34924);
			add_location(p20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 311, 0, 34932);
			add_location(brb27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 312, 0, 34995);
			add_location(p21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 313, 0, 35003);
...
function NavBar_svelte_add_css(target) {
	append_styles(target, "svelte-2cmtd6", "#bar.svelte-2cmtd6.svelte-2cmtd6{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-2cmtd6 #bar-left.svelte-2cmtd6{display:flex;flex-direction:column}#bar.svelte-2cmtd6 mark.svelte-2cmtd6{background:var(--accent-dark)}#bar.svelte-2cmtd6 .logo.svelte-2cmtd6{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-2cmtd6 .logo.logo-behind.svelte-2cmtd6{position:absolute}#bar.svelte-2cmtd6 .logo.hovered.svelte-2cmtd6{color:var(--accent-dark) !important}#bar.svelte-2cmtd6 .logo.hovered.hover-effect-0.svelte-2cmtd6{animation:svelte-2cmtd6-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-2cmtd6-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-2cmtd6-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-2cmtd6-glitch-anim3{0%{clip:rect(0.6rem, 9999px, 2.5rem, 0);transform-origin:center}2%{clip:rect(1rem, 9999px, 5rem, 0);transform-origin:center}4%{clip:rect(2rem, 9999px, 1.5rem, 0);transform-origin:center}6%{clip:rect(3.4rem, 9999px, 2rem, 0);transform-origin:center}8%{clip:rect(2.1rem, 9999px, 3rem, 0);transform-origin:center}10%{clip:rect(2.4rem, 9999px, 5rem, 0);transform-origin:center}12%{clip:rect(0.3rem, 9999px, 1rem, 0);transform-origin:center}14%{clip:rect(3.9rem, 9999px, 4.5rem, 0);transform-origin:center}16%{clip:rect(0.9rem, 9999px, 3rem, 0);transform-origin:center}18%{clip:rect(3.9rem, 9999px, 0.5rem, 0);transform-origin:center}20%{clip:rect(3.7rem, 9999px, 2rem, 0);transform-origin:center}22%{clip:rect(1.1rem, 9999px, 3.5rem, 0);transform-origin:center}24%{clip:rect(2.7rem, 9999px, 1.5rem, 0);transform-origin:center}26%{clip:rect(2.5rem, 9999px, 5rem, 0);transform-origin:center}28%{clip:rect(1.6rem, 9999px, 3rem, 0);transform-origin:center}30%{clip:rect(2.4rem, 9999px, 1rem, 0);transform-origin:center}32%{clip:rect(1.8rem, 9999px, 1.5rem, 0);transform-origin:center}34%{clip:rect(0.2rem, 9999px, 2.5rem, 0);transform-origin:center}36%{clip:rect(0.6rem, 9999px, 0.5rem, 0);transform-origin:center}38%{clip:rect(1.2rem, 9999px, 4.5rem, 0);transform-origin:center}40%{clip:rect(2.9rem, 9999px, 2.5rem, 0);transform-origin:center}42%{clip:rect(2.6rem, 9999px, 4.5rem, 0);transform-origin:center}44%{clip:rect(0.3rem, 9999px, 2.5rem, 0);transform-origin:center}46%{clip:rect(2.4rem, 9999px, 1.5rem, 0);transform-origin:center}48%{clip:rect(2.3rem, 9999px, 2rem, 0);transform-origin:center}50%{clip:rect(0.4rem, 9999px, 3rem, 0);transform-origin:center}52%{clip:rect(2.8rem, 9999px, 4rem, 0);transform-origin:center}54%{clip:rect(2.9rem, 9999px, 2rem, 0);transform-origin:center}56%{clip:rect(2.7rem, 9999px, 2rem, 0);transform-origin:center}58%{clip:rect(1.9rem, 9999px, 2.5rem, 0);transform-origin:center}60%{clip:rect(2rem, 9999px, 3rem, 0);transform-origin:center}62%{clip:rect(1.7rem, 9999px, 1.5rem, 0);transform-origin:center}64%{clip:rect(0.9rem, 9999px, 4rem, 0);transform-origin:center}66%{clip:rect(3.2rem, 9999px, 4.5rem, 0);transform-origin:center}68%{clip:rect(2rem, 9999px, 5rem, 0);transform-origin:center}70%{clip:rect(3.5rem, 9999px, 0.5rem, 0);transform-origin:center}72%{clip:rect(3rem, 9999px, 2.5rem, 0);transform-origin:center}74%{clip:rect(2.1rem, 9999px, 3.5rem, 0);transform-origin:center}76%{clip:rect(2.7rem, 9999px, 4.5rem, 0);transform-origin:center}78%{clip:rect(3.9rem, 9999px, 3rem, 0);transform-origin:center}80%{clip:rect(3.3rem, 9999px, 4rem, 0);transform-origin:center}82%{clip:rect(1.4rem, 9999px, 0.5rem, 0);transform-origin:center}84%{clip:rect(1.8rem, 9999px, 2rem, 0);transform-origin:center}86%{clip:rect(0.1rem, 9999px, 4rem, 0);transform-origin:center}88%{clip:rect(2.7rem, 9999px, 4.5rem, 0);transform-origin:center}90%{clip:rect(2.4rem, 9999px, 5rem, 0);transform-origin:center}92%{clip:rect(2.7rem, 9999px, 1.5rem, 0);transform-origin:center}94%{clip:rect(3.4rem, 9999px, 3rem, 0);transform-origin:center}96%{clip:rect(0.8rem, 9999px, 3.5rem, 0);transform-origin:center}98%{clip:rect(2.1rem, 9999px, 3.5rem, 0);transform-origin:center}}@keyframes svelte-2cmtd6-cooool{0%{color:pink !important}2%{color:pink !important}4%{color:pink !important}6%{color:pink !important}8%{color:pink !important}10%{color:pink !important}12%{color:pink !important}14%{color:pink !important}16%{color:pink !important}18%{color:pink !important}20%{color:pink !important}22%{color:pink !important}24%{color:pink !important}26%{color:pink !important}28%{color:pink !important}30%{color:pink !important}32%{color:pink !important}34%{color:pink !important}36%{color:pink !important}38%{color:pink !important}40%{color:pink !important}42%{color:pink !important}44%{color:pink !important}46%{color:pink !important}48%{color:pink !important}50%{color:pink !important}52%{color:pink !important}54%{color:pink !important}56%{color:pink !important}58%{color:pink !important}60%{color:pink !important}62%{color:pink !important}64%{color:pink !important}66%{color:pink !important}68%{color:pink !important}70%{color:pink !important}72%{color:pink !important}74%{color:pink !important}76%{color:pink !important}78%{color:pink !important}80%{color:pink !important}82%{color:pink !important}84%{color:pink !important}86%{color:pink !important}88%{color:pink !important}90%{color:pink !important}92%{color:pink !important}94%{color:pink !important}96%{color:pink !important}98%{color:pink !important}}#bar.svelte-2cmtd6 .logo.hovered.hover-effect-0.logo-behind-a.svelte-2cmtd6{color:#ff5500 !important;animation:svelte-2cmtd6-distort1 300ms linear infinite, svelte-2cmtd6-glitch-anim3 5s infinite linear alternate-reverse, svelte-2cmtd6-cooool 5s infinite linear alternate-reverse}#bar.svelte-2cmtd6 .logo.hovered.hover-effect-0.logo-behind-b.svelte-2cmtd6{color:#450f8b !important;animation:svelte-2cmtd6-distort2 300ms linear infinite, svelte-2cmtd6-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-2cmtd6 .logo.hover-effect-1.svelte-2cmtd6{animation:svelte-2cmtd6-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-2cmtd6-glitch-anim{0%{clip:rect(0.9rem, 9999px, 4rem, 0);transform:skew(5.9deg);z-index:2}2%{clip:rect(1.5rem, 9999px, 4.5rem, 0);transform:skew(3deg);z-index:4}4%{clip:rect(2.2rem, 9999px, 4.5rem, 0);transform:skew(4.2deg);z-index:3}6%{clip:rect(2.1rem, 9999px, 4.5rem, 0);transform:skew(0.6deg);z-index:2}8%{clip:rect(1.9rem, 9999px, 3.5rem, 0);transform:skew(8.2deg);z-index:3}10%{clip:rect(1.7rem, 9999px, 5rem, 0);transform:skew(5.2deg);z-index:3}12%{clip:rect(2.7rem, 9999px, 1.5rem, 0);transform:skew(5.2deg);z-index:3}14%{clip:rect(2.9rem, 9999px, 4.5rem, 0);transform:skew(9.7deg);z-index:1}16%{clip:rect(2.6rem, 9999px, 3rem, 0);transform:skew(4.7deg);z-index:2}18%{clip:rect(2.5rem, 9999px, 3rem, 0);transform:skew(3.8deg);z-index:3}20%{clip:rect(3.8rem, 9999px, 4.5rem, 0);transform:skew(4.3deg);z-index:4}22%{clip:rect(0.1rem, 9999px, 5rem, 0);transform:skew(8.6deg);z-index:1}24%{clip:rect(3.5rem, 9999px, 4rem, 0);transform:skew(0.6deg);z-index:1}26%{clip:rect(1.5rem, 9999px, 3rem, 0);transform:skew(3.3deg);z-index:4}28%{clip:rect(1.5rem, 9999px, 3rem, 0);transform:skew(2.6deg);z-index:2}30%{clip:rect(1.7rem, 9999px, 5rem, 0);transform:skew(2.3deg);z-index:2}32%{clip:rect(3rem, 9999px, 2rem, 0);transform:skew(7.5deg);z-index:1}34%{clip:rect(0.5rem, 9999px, 2rem, 0);transform:skew(4.7deg);z-index:4}36%{clip:rect(1.7rem, 9999px, 0.5rem, 0);transform:skew(0.6deg);z-index:1}38%{clip:rect(1.4rem, 9999px, 2.5rem, 0);transform:skew(1.7deg);z-index:3}40%{clip:rect(3.7rem, 9999px, 2rem, 0);transform:skew(1.8deg);z-index:3}42%{clip:rect(3.2rem, 9999px, 0.5rem, 0);transform:skew(6.2deg);z-index:3}44%{clip:rect(1.8rem, 9999px, 4.5rem, 0);transform:skew(7.3deg);z-index:1}46%{clip:rect(3rem, 9999px, 1rem, 0);transform:skew(8.7deg);z-index:4}48%{clip:rect(0.6rem, 9999px, 2rem, 0);transform:skew(9.6deg);z-index:1}50%{clip:rect(0.4rem, 9999px, 3rem, 0);transform:skew(8.6deg);z-index:4}52%{clip:rect(0.6rem, 9999px, 0.5rem, 0);transform:skew(9.6deg);z-index:1}54%{clip:rect(3rem, 9999px, 1.5rem, 0);transform:skew(10deg);z-index:3}56%{clip:rect(3.9rem, 9999px, 3.5rem, 0);transform:skew(5.9deg);z-index:2}58%{clip:rect(3.5rem, 9999px, 4rem, 0);transform:skew(6.7deg);z-index:2}60%{clip:rect(1.4rem, 9999px, 1rem, 0);transform:skew(4.3deg);z-index:1}62%{clip:rect(0.4rem, 9999px, 2.5rem, 0);transform:skew(3.5deg);z-index:4}64%{clip:rect(0.8rem, 9999px, 0.5rem, 0);transform:skew(7.2deg);z-index:2}66%{clip:rect(3.7rem, 9999px, 2rem, 0);transform:skew(8.8deg);z-index:4}68%{clip:rect(1.6rem, 9999px, 0.5rem, 0);transform:skew(5.4deg);z-index:1}70%{clip:rect(3.9rem, 9999px, 1.5rem, 0);transform:skew(3.7deg);z-index:2}72%{clip:rect(0.6rem, 9999px, 3.5rem, 0);transform:skew(1deg);z-index:4}74%{clip:rect(4rem, 9999px, 2rem, 0);transform:skew(9.4deg);z-index:3}76%{clip:rect(3.3rem, 9999px, 2rem, 0);transform:skew(1.9deg);z-index:1}78%{clip:rect(1.1rem, 9999px, 5rem, 0);transform:skew(0.5deg);z-index:4}80%{clip:rect(0.3rem, 9999px, 0.5rem, 0);transform:skew(2.5deg);z-index:2}82%{clip:rect(2.3rem, 9999px, 3.5rem, 0);transform:skew(7.5deg);z-index:1}84%{clip:rect(3rem, 9999px, 2.5rem, 0);transform:skew(1.4deg);z-index:4}86%{clip:rect(2.6rem, 9999px, 5rem, 0);transform:skew(5.2deg);z-index:1}88%{clip:rect(2.5rem, 9999px, 4rem, 0);transform:skew(1.6deg);z-index:3}90%{clip:rect(0.5rem, 9999px, 5rem, 0);transform:skew(5.4deg);z-index:2}92%{clip:rect(1.4rem, 9999px, 0.5rem, 0);transform:skew(5.4deg);z-index:4}94%{clip:rect(0.2rem, 9999px, 4rem, 0);transform:skew(2.3deg);z-index:4}96%{clip:rect(0.6rem, 9999px, 5rem, 0);transform:skew(0.7deg);z-index:3}98%{clip:rect(2.6rem, 9999px, 4.5rem, 0);transform:skew(2deg);z-index:4}}@keyframes svelte-2cmtd6-glitch-anim2{0%{clip:rect(0.18rem, 99999px, 2.4rem, 0)}0.6666666667%{clip:rect(0.2rem, 99999px, 3.8rem, 0)}1.3333333333%{clip:rect(0.18rem, 99999px, 3.9rem, 0)}2%{clip:rect(0.2rem, 99999px, 7.5rem, 0)}2.6666666667%{clip:rect(0.14rem, 99999px, 0.5rem, 0)}3.3333333333%{clip:rect(0.16rem, 99999px, 3.1rem, 0)}4%{clip:rect(0.14rem, 99999px, 7.4rem, 0)}4.6666666667%{clip:rect(0.18rem, 99999px, 3.8rem, 0)}5.3333333333%{clip:rect(0.04rem, 99999px, 9.1rem, 0)}6%{clip:rect(0.18rem, 99999px, 3.6rem, 0)}6.6666666667%{clip:rect(0.04rem, 99999px, 2.8rem, 0)}7.3333333333%{clip:rect(0.1rem, 99999px, 7.7rem, 0)}8%{clip:rect(0.12rem, 99999px, 6.1rem, 0)}8.6666666667%{clip:rect(0.16rem, 99999px, 8.8rem, 0)}9.3333333333%{clip:rect(0.06rem, 99999px, 3.7rem, 0)}10%{clip:rect(0.08rem, 99999px, 5.8rem, 0)}10.6666666667%{clip:rect(0.1rem, 99999px, 4.3rem, 0)}11.3333333333%{clip:rect(0.1rem, 99999px, 7.7rem, 0)}12%{clip:rect(0.1rem, 99999px, 0.6rem, 0)}12.6666666667%{clip:rect(0.08rem, 99999px, 4.7rem, 0)}13.3333333333%{clip:rect(0.18rem, 99999px, 6.6rem, 0)}14%{clip:rect(0.12rem, 99999px, 1.2rem, 0)}14.6666666667%{clip:rect(0.08rem, 99999px, 0.9rem, 0)}15.3333333333%{clip:rect(0.1rem, 99999px, 6.6rem, 0)}16%{clip:rect(0.1rem, 99999px, 8.8rem, 0)}16.6666666667%{clip:rect(0.08rem, 99999px, 2.9rem, 0)}17.3333333333%{clip:rect(0.04rem, 99999px, 9.9rem, 0)}18%{clip:rect(0.12rem, 99999px, 5.3rem, 0)}18.6666666667%{clip:rect(0.18rem, 99999px, 9.4rem, 0)}19.3333333333%{clip:rect(0.16rem, 99999px, 1.2rem, 0)}20%{clip:rect(0.08rem, 99999px, 0.1rem, 0)}20.6666666667%{clip:rect(0.14rem, 99999px, 8.7rem, 0)}21.3333333333%{clip:rect(0.06rem, 99999px, 2.6rem, 0)}22%{clip:rect(0.18rem, 99999px, 6.2rem, 0)}22.6666666667%{clip:rect(0.12rem, 99999px, 7.5rem, 0)}23.3333333333%{clip:rect(0.02rem, 99999px, 3.7rem, 0)}24%{clip:rect(0.14rem, 99999px, 3.9rem, 0)}24.6666666667%{clip:rect(0.18rem, 99999px, 3.4rem, 0)}25.3333333333%{clip:rect(0.1rem, 99999px, 9.4rem, 0)}26%{clip:rect(0.12rem, 99999px, 3.3rem, 0)}26.6666666667%{clip:rect(0.04rem, 99999px, 5.2rem, 0)}27.3333333333%{clip:rect(0.1rem, 99999px, 3.1rem, 0)}28%{clip:rect(0.04rem, 99999px, 2.2rem, 0)}28.6666666667%{clip:rect(0.18rem, 99999px, 4.7rem, 0)}29.3333333333%{clip:rect(0.12rem, 99999px, 0.3rem, 0)}30%{clip:rect(0.08rem, 99999px, 1.6rem, 0)}30.6666666667%{clip:rect(0.02rem, 99999px, 1.3rem, 0)}31.3333333333%{clip:rect(0.02rem, 99999px, 2rem, 0)}32%{clip:rect(0.08rem, 99999px, 2.4rem, 0)}32.6666666667%{clip:rect(0.02rem, 99999px, 1.6rem, 0)}33.3333333333%{clip:rect(0.16rem, 99999px, 9.9rem, 0)}34%{clip:rect(0.16rem, 99999px, 9.8rem, 0)}34.6666666667%{clip:rect(0.14rem, 99999px, 7.8rem, 0)}35.3333333333%{clip:rect(0.18rem, 99999px, 3.3rem, 0)}36%{clip:rect(0.2rem, 99999px, 2.2rem, 0)}36.6666666667%{clip:rect(0.16rem, 99999px, 4.7rem, 0)}37.3333333333%{clip:rect(0.08rem, 99999px, 2.5rem, 0)}38%{clip:rect(0.2rem, 99999px, 1.1rem, 0)}38.6666666667%{clip:rect(0.12rem, 99999px, 5.8rem, 0)}39.3333333333%{clip:rect(0.1rem, 99999px, 8.9rem, 0)}40%{clip:rect(0.18rem, 99999px, 1.2rem, 0)}40.6666666667%{clip:rect(0.1rem, 99999px, 2.5rem, 0)}41.3333333333%{clip:rect(0.16rem, 99999px, 5.4rem, 0)}42%{clip:rect(0.2rem, 99999px, 6.7rem, 0)}42.6666666667%{clip:rect(0.06rem, 99999px, 4.7rem, 0)}43.3333333333%{clip:rect(0.08rem, 99999px, 4.9rem, 0)}44%{clip:rect(0.14rem, 99999px, 0.9rem, 0)}44.6666666667%{clip:rect(0.12rem, 99999px, 4.2rem, 0)}45.3333333333%{clip:rect(0.16rem, 99999px, 1.1rem, 0)}46%{clip:rect(0.14rem, 99999px, 7.7rem, 0)}46.6666666667%{clip:rect(0.12rem, 99999px, 1.5rem, 0)}47.3333333333%{clip:rect(0.18rem, 99999px, 4.3rem, 0)}48%{clip:rect(0.12rem, 99999px, 4rem, 0)}48.6666666667%{clip:rect(0.14rem, 99999px, 9.6rem, 0)}49.3333333333%{clip:rect(0.18rem, 99999px, 1.6rem, 0)}50%{clip:rect(0.14rem, 99999px, 8.3rem, 0)}50.6666666667%{clip:rect(0.1rem, 99999px, 2.9rem, 0)}51.3333333333%{clip:rect(0.18rem, 99999px, 7.6rem, 0)}52%{clip:rect(0.14rem, 99999px, 3.8rem, 0)}52.6666666667%{clip:rect(0.04rem, 99999px, 9.5rem, 0)}53.3333333333%{clip:rect(0.06rem, 99999px, 0.6rem, 0)}54%{clip:rect(0.16rem, 99999px, 3.2rem, 0)}54.6666666667%{clip:rect(0.1rem, 99999px, 5.7rem, 0)}55.3333333333%{clip:rect(0.08rem, 99999px, 0.2rem, 0)}56%{clip:rect(0.08rem, 99999px, 2.7rem, 0)}56.6666666667%{clip:rect(0.06rem, 99999px, 7.3rem, 0)}57.3333333333%{clip:rect(0.02rem, 99999px, 3.6rem, 0)}58%{clip:rect(0.1rem, 99999px, 5.3rem, 0)}58.6666666667%{clip:rect(0.08rem, 99999px, 3.6rem, 0)}59.3333333333%{clip:rect(0.08rem, 99999px, 6.3rem, 0)}60%{clip:rect(0.06rem, 99999px, 2.2rem, 0)}60.6666666667%{clip:rect(0.06rem, 99999px, 5.4rem, 0)}61.3333333333%{clip:rect(0.16rem, 99999px, 8.6rem, 0)}62%{clip:rect(0.16rem, 99999px, 7.5rem, 0)}62.6666666667%{clip:rect(0.02rem, 99999px, 6.5rem, 0)}63.3333333333%{clip:rect(0.04rem, 99999px, 6.1rem, 0)}64%{clip:rect(0.14rem, 99999px, 7.1rem, 0)}64.6666666667%{clip:rect(0.1rem, 99999px, 1.9rem, 0)}65.3333333333%{clip:rect(0.06rem, 99999px, 6.8rem, 0)}66%{clip:rect(0.02rem, 99999px, 7.3rem, 0)}66.6666666667%{clip:rect(0.04rem, 99999px, 3.5rem, 0)}67.3333333333%{clip:rect(0.1rem, 99999px, 6.3rem, 0)}68%{clip:rect(0.06rem, 99999px, 9.8rem, 0)}68.6666666667%{clip:rect(0.02rem, 99999px, 1.5rem, 0)}69.3333333333%{clip:rect(0.02rem, 99999px, 5rem, 0)}70%{clip:rect(0.06rem, 99999px, 6.6rem, 0)}70.6666666667%{clip:rect(0.02rem, 99999px, 2.4rem, 0)}71.3333333333%{clip:rect(0.16rem, 99999px, 8.7rem, 0)}72%{clip:rect(0.14rem, 99999px, 7.7rem, 0)}72.6666666667%{clip:rect(0.06rem, 99999px, 8.6rem, 0)}73.3333333333%{clip:rect(0.2rem, 99999px, 5.4rem, 0)}74%{clip:rect(0.08rem, 99999px, 5.2rem, 0)}74.6666666667%{clip:rect(0.08rem, 99999px, 9.4rem, 0)}75.3333333333%{clip:rect(0.12rem, 99999px, 7.9rem, 0)}76%{clip:rect(0.14rem, 99999px, 4.9rem, 0)}76.6666666667%{clip:rect(0.14rem, 99999px, 9.1rem, 0)}77.3333333333%{clip:rect(0.04rem, 99999px, 6.5rem, 0)}78%{clip:rect(0.2rem, 99999px, 4.7rem, 0)}78.6666666667%{clip:rect(0.2rem, 99999px, 7.5rem, 0)}79.3333333333%{clip:rect(0.04rem, 99999px, 8.6rem, 0)}80%{clip:rect(0.12rem, 99999px, 3.2rem, 0)}80.6666666667%{clip:rect(0.04rem, 99999px, 7.6rem, 0)}81.3333333333%{clip:rect(0.04rem, 99999px, 0.3rem, 0)}82%{clip:rect(0.1rem, 99999px, 8.4rem, 0)}82.6666666667%{clip:rect(0.12rem, 99999px, 5.9rem, 0)}83.3333333333%{clip:rect(0.14rem, 99999px, 4.9rem, 0)}84%{clip:rect(0.02rem, 99999px, 3.9rem, 0)}84.6666666667%{clip:rect(0.2rem, 99999px, 7.2rem, 0)}85.3333333333%{clip:rect(0.04rem, 99999px, 8.5rem, 0)}86%{clip:rect(0.1rem, 99999px, 9.9rem, 0)}86.6666666667%{clip:rect(0.14rem, 99999px, 3.1rem, 0)}87.3333333333%{clip:rect(0.14rem, 99999px, 3.5rem, 0)}88%{clip:rect(0.1rem, 99999px, 7rem, 0)}88.6666666667%{clip:rect(0.16rem, 99999px, 7.1rem, 0)}89.3333333333%{clip:rect(0.08rem, 99999px, 6.7rem, 0)}90%{clip:rect(0.18rem, 99999px, 3rem, 0)}90.6666666667%{clip:rect(0.2rem, 99999px, 7.7rem, 0)}91.3333333333%{clip:rect(0.2rem, 99999px, 8.6rem, 0)}92%{clip:rect(0.02rem, 99999px, 6.7rem, 0)}92.6666666667%{clip:rect(0.06rem, 99999px, 9.1rem, 0)}93.3333333333%{clip:rect(0.2rem, 99999px, 5.3rem, 0)}94%{clip:rect(0.18rem, 99999px, 3.3rem, 0)}94.6666666667%{clip:rect(0.1rem, 99999px, 2.1rem, 0)}95.3333333333%{clip:rect(0.12rem, 99999px, 3.6rem, 0)}96%{clip:rect(0.14rem, 99999px, 7.9rem, 0)}96.6666666667%{clip:rect(0.12rem, 99999px, 1.3rem, 0)}97.3333333333%{clip:rect(0.2rem, 99999px, 9.5rem, 0)}98%{clip:rect(0.02rem, 99999px, 8.6rem, 0)}98.6666666667%{clip:rect(0.08rem, 99999px, 3.3rem, 0)}99.3333333333%{clip:rect(0.18rem, 99999px, 0.1rem, 0)}}@keyframes svelte-2cmtd6-glitch-skew{0%{transform:skew(1deg)}10%{transform:skew(-4deg)}20%{transform:skew(1deg)}30%{transform:skew(0deg)}40%{transform:skew(4deg)}50%{transform:skew(2deg)}60%{transform:skew(0deg)}70%{transform:skew(-1deg)}80%{transform:skew(5deg)}90%{transform:skew(1deg)}}#bar.svelte-2cmtd6 .logo.hover-effect-1.logo-behind-a.svelte-2cmtd6{color:var(--accent-light);transform:translateX(-0.5rem);color:#ff5500 !important;text-shadow:-2px 0 #ff5500, 2px 2px #ff5500;clip:rect(44px, 450px, 56px, 0);animation:svelte-2cmtd6-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-2cmtd6 .logo.hover-effect-1.logo-behind-b.svelte-2cmtd6{color:#bfcc2e !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #450f8b;clip:rect(44px, 450px, 56px, 0);animation:svelte-2cmtd6-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-2cmtd6 .logo.logo-behind.svelte-2cmtd6{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-2cmtd6 .logo.logo-behind.svelte-2cmtd6:not(.hovered){display:none}#bar.svelte-2cmtd6 #bar-right.svelte-2cmtd6{margin-left:auto;display:flex;margin-right:1rem;margin-top:1rem;position:relative}#bar.svelte-2cmtd6 #bar-right #menus.svelte-2cmtd6{display:flex}#bar.svelte-2cmtd6 #bar-right #menus #menu.svelte-2cmtd6{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-2cmtd6 #bar-right #menus #menu.svelte-2cmtd6 .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function NavBar_svelte_create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			style = dom_element("style");
			style.innerHTML = ``;
			add_location(style, NavBar_svelte_file, -1, 26001);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(style, NavBar_svelte_file, -1, 25884);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function NavBar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-2cmtd6");
			add_location(mark, NavBar_svelte_file, -1, 26234);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-2cmtd6");
			add_location(a0, NavBar_svelte_file, -1, 26162);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-2cmtd6");
			add_location(a1, NavBar_svelte_file, -1, 26277);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-2cmtd6");
			add_location(a2, NavBar_svelte_file, -1, 26369);
			attr_dev(div0, "id", "logo-container");
			add_location(div0, NavBar_svelte_file, -1, 26133);
			attr_dev(div1, "id", "bar-left");
			attr_dev(div1, "class", "svelte-2cmtd6");
			add_location(div1, NavBar_svelte_file, -1, 26086);
			attr_dev(div2, "id", "menu");
			attr_dev(div2, "class", "svelte-2cmtd6");
			add_location(div2, NavBar_svelte_file, -1, 26671);
			attr_dev(div3, "id", "menu");
			attr_dev(div3, "class", "svelte-2cmtd6");
			add_location(div3, NavBar_svelte_file, -1, 26972);
			attr_dev(div4, "id", "menus");
			attr_dev(div4, "class", "svelte-2cmtd6");
			add_location(div4, NavBar_svelte_file, -1, 26625);
			attr_dev(div5, "id", "bar-right");
			attr_dev(div5, "class", "svelte-2cmtd6");
			add_location(div5, NavBar_svelte_file, -1, 26526);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-2cmtd6");
			add_location(nav, NavBar_svelte_file, -1, 26043);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*hovered_class*/ 64 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-2cmtd6")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-2cmtd6")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-2cmtd6")) {
