...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 52, 7, 1841);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 66, 24, 2398);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, a, anchor);
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	video0 = new Video_svelte({
			props: {
				src: `${window.LFS_PREPEND}/images/generative_mograph/OUT (2).mp4`
			},
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			t31 = space();
			p3 = dom_element("p");
			t32 = dom_text("Displaying fluence is done in 2d pathtracing, possibly the first resource on which is this ");
			a3 = dom_element("a");
			a3.textContent = "blogpost";
			t34 = dom_text(" by lycium (also possibly the first time it was done).");
			t35 = space();
			p4 = dom_element("p");
			p4.textContent = "This is not physically accurate, because it’s a display of raw fluence¹, rather than irradiance².\nIt looks freaiking cool though :)";
			t37 = space();
			...
			t73 = space();
			wbr5 = dom_element("wbr");
			t74 = space();
			pre1 = dom_element("pre");
			t75 = space();
			wbr6 = dom_element("wbr");
			t76 = space();
			ul = dom_element("ul");
			li4 = dom_element("li");
			t77 = dom_text("“coherent” is needed when different ");
			a6 = dom_element("a");
			...
			t81 = dom_text(". It can look cool if you don’t enable it :)");
			t82 = space();
			li5 = dom_element("li");
			...
			t103 = dom_text("Add” lets multiple threads write/read a location without ");
			a11 = dom_element("a");
			a11.textContent = "data racing";
			t105 = dom_text(".");
			t106 = space();
			p13 = dom_element("p");
			t107 = dom_text("If you feel like accumulating to a float buffer/image, you can do that with an ");
			a12 = dom_element("a");
			a12.textContent = "nvidia extension";
			t109 = dom_text(",\nor the ");
			a13 = dom_element("a");
			a13.textContent = "compare-and-swap";
			t111 = dom_text(" algorithm.");
			t112 = space();
			p14 = dom_element("p");
			...
			add_location(strong, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 15, 7, 720);
			add_location(h1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 15, 7, 716);
			...
			add_location(brb0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 24, 0, 872);
			add_location(brb1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 25, 0, 882);
			attr_dev(a0, "href", "https://en.wikipedia.org/wiki/Lightmap");
			attr_dev(a0, "rel", "nofollow");
			add_location(a0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 26, 44, 943);
			...
			add_location(a1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 30, 2, 1033);
			add_location(p0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 26, 0, 890);
			add_location(p1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 35, 0, 1340);
			add_location(brb2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 36, 0, 1420);
			add_location(brb3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 37, 0, 1428);
			add_location(brb4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 54, 0, 1946);
			attr_dev(a2, "href", "https://en.wikipedia.org/wiki/Implicit_surface");
			attr_dev(a2, "rel", "nofollow");
			add_location(a2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 55, 38, 2030);
			add_location(p2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 55, 0, 1954);
			add_location(brb5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 62, 0, 2306);
			add_location(brb6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 63, 0, 2314);
			add_location(brb7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 68, 0, 2462);
			attr_dev(a3, "href", "https://web.archive.org/web/20040131013212/http://lycium.cfxweb.net/");
			attr_dev(a3, "rel", "nofollow");
			add_location(a3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 69, 7, 2564);
			add_location(p3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 69, 0, 2470);
			add_location(p4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 73, 0, 2735);
			add_location(wbr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 75, 0, 2875);
			add_location(hr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 77, 2, 2909);
			attr_dev(a4, "href", "https://cs.dartmouth.edu/wjarosz/publications/jarosz12theory.html");
			add_location(a4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 79, 6, 2932);
			add_location(brb8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 79, 6, 3126);
			attr_dev(a5, "href", "https://en.wikipedia.org/wiki/Irradiance");
			add_location(a5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 80, 0, 3143);
			add_location(ol0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 78, 2, 2918);
			add_location(hr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 82, 0, 3377);
			attr_dev(div1, "class", "footnotes");
			add_location(div1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 76, 0, 2883);
			add_location(wbr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 84, 0, 3391);
			add_location(p5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 85, 0, 3399);
			add_location(brb9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 86, 0, 3544);
			add_location(brb10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 92, 0, 3800);
			add_location(p6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 93, 0, 3808);
			add_location(wbr2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 94, 0, 3839);
			add_location(li0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 96, 0, 3852);
			add_location(li1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 97, 0, 3933);
			add_location(li2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 98, 0, 4027);
			add_location(li3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 99, 0, 4115);
			add_location(ol1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 95, 0, 3847);
			add_location(wbr3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 101, 0, 4242);
			add_location(p7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 102, 0, 4250);
			add_location(wbr4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 103, 0, 4300);
			attr_dev(pre0, "class", "language-glsl");
			add_location(pre0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 104, 0, 4308);
			add_location(brb11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 148, 0, 10696);
			add_location(p8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 149, 0, 10704);
			add_location(wbr5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 150, 0, 10732);
			attr_dev(pre1, "class", "language-undefined");
			add_location(pre1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 151, 0, 10740);
			add_location(wbr6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 152, 0, 10890);
			attr_dev(a6, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a6, "rel", "nofollow");
			add_location(a6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 154, 3, 10943);
			attr_dev(a7, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 159, 0, 11217);
			add_location(li4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 154, 0, 10903);
			add_location(li5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 164, 0, 11393);
			add_location(li6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 166, 0, 11611);
			add_location(ul, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 153, 0, 10898);
			attr_dev(a8, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 169, 19, 11744);
			add_location(p9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 169, 0, 11724);
			add_location(brb12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 173, 0, 11854);
			attr_dev(a9, "href", "https://www.shadertoy.com/view/4dX3zl");
			add_location(a9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 177, 0, 11983);
			add_location(p10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 174, 0, 11864);
			add_location(p11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 178, 0, 12070);
			add_location(brb13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 180, 0, 12122);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 181, 0, 12130);
			add_location(brb14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 206, 0, 19403);
			attr_dev(a10, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a10, "rel", "nofollow");
			add_location(a10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 207, 9, 19419);
			attr_dev(a11, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 210, 4, 19562);
			add_location(p12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 207, 0, 19410);
			attr_dev(a12, "href", "https://registry.khronos.org/OpenGL/extensions/NV/NV_shader_atomic_float.txt");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 214, 0, 19740);
			attr_dev(a13, "href", "https://en.wikipedia.org/wiki/Compare-and-swap");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 218, 0, 19876);
			add_location(p13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 214, 0, 19658);
			add_location(p14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 222, 0, 19989);
			add_location(p15, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 223, 0, 20047);
		...
		m: function mount(target, anchor) {
			...
			append_dev(article, wbr5);
			append_dev(article, t74);
			append_dev(article, pre1);
			pre1.innerHTML = raw1_value;
			append_dev(article, t75);
			append_dev(article, wbr6);
...
function _2023_08_17_flame_fractals_in_comp_shader_svelte_create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 52, 0, 2002);
			attr_dev(a1, "href", "https://www.technochroma.art");
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 52, 0, 2097);
		},
		m: function mount(target, anchor) {
...
function _2023_08_17_flame_fractals_in_comp_shader_svelte_create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 65, 0, 2551);
			attr_dev(a1, "href", "https://www.pouet.net/groups.php?which=12701");
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 65, 0, 2621);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a0, anchor);
			insert_dev(target, t1, anchor);
...
<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>uv <span class="token operator">+</span> anti_aliasing <span class="token operator">+</span> dof_sample<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(brb0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 18, 0, 812);
			add_location(brb1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 19, 0, 820);
			add_location(strong0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 20, 0, 832);
			add_location(h20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 20, 0, 828);
			attr_dev(a0, "href", "https://en.wikipedia.org/wiki/Fractal_flame");
			attr_dev(a0, "rel", "nofollow");
			add_location(a0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 21, 1, 870);
			attr_dev(a1, "href", "https://en.wikipedia.org/wiki/Scott_Draves");
			attr_dev(a1, "rel", "nofollow");
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 25, 0, 1067);
			attr_dev(a2, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a2, "rel", "nofollow");
			add_location(a2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 28, 7, 1162);
			attr_dev(a3, "href", "https://maths-people.anu.edu.au/~john/Assets/Research%20Papers/fractals_self-similarity.pdf");
			attr_dev(a3, "rel", "nofollow");
			add_location(a3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 29, 7, 1267);
			...
			add_location(a4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 32, 0, 1442);
			add_location(p0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 21, 0, 867);
			attr_dev(a5, "href", "https://github.com/bezo97/IFSRenderer");
			attr_dev(a5, "rel", "nofollow");
			add_location(a5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 37, 0, 1673);
			attr_dev(a6, "href", "https://www.chaoticafractals.com");
			attr_dev(a6, "rel", "nofollow");
			add_location(a6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 40, 0, 1748);
			attr_dev(a7, "href", "https://github.com/3Dickulus/FragM");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 43, 4, 1817);
			add_location(p1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 36, 0, 1599);
			add_location(brb2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 47, 0, 1912);
			add_location(brb3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 48, 0, 1920);
			attr_dev(a8, "href", "https://en.wikipedia.org/wiki/Demoscene");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 54, 7, 2220);
			attr_dev(a9, "href", "https://files.scene.org/view/parties/2019/assembly19/4k/terrarium_by_eos.zip");
			attr_dev(a9, "rel", "nofollow");
			add_location(a9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 57, 35, 2365);
			add_location(p2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 54, 0, 2165);
			add_location(brb4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 61, 0, 2486);
			add_location(brb5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 62, 0, 2494);
			add_location(brb6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 67, 0, 2696);
			add_location(brb7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 68, 0, 2704);
			attr_dev(a10, "href", "https://github.com/demoscene-source-archive/terrarium/blob/master/src/shaders/fragment.glsl");
			attr_dev(a10, "rel", "nofollow");
			add_location(a10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 69, 7, 2761);
			add_location(p3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 69, 0, 2712);
			add_location(p4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 73, 0, 2904);
			add_location(li0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 75, 0, 2977);
			add_location(em0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 76, 0, 3103);
			add_location(li1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 76, 0, 3072);
			add_location(li2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 77, 0, 3139);
			add_location(li3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 79, 0, 3211);
			add_location(em1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 80, 13, 3316);
			add_location(li4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 80, 0, 3249);
			add_location(li5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 81, 0, 3335);
			add_location(ul0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 78, 18, 3206);
			add_location(li6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 78, 0, 3176);
			add_location(li7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 83, 0, 3423);
			add_location(ul1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 74, 0, 2972);
			add_location(brb8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 85, 0, 3500);
			add_location(p5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 86, 0, 3508);
			add_location(brb9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 87, 0, 3567);
			add_location(brb10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 88, 0, 3575);
			add_location(brb11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 90, 0, 3619);
			add_location(brb12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 91, 0, 3627);
			attr_dev(a11, "href", "https://en.wikipedia.org/wiki/Chaos_game");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 92, 34, 3669);
			attr_dev(a12, "href", "https://en.wikipedia.org/wiki/Iterated_function_system");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 95, 24, 3823);
			add_location(p6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 92, 0, 3635);
			attr_dev(a13, "href", "https://en.wikipedia.org/wiki/Tone_mapping");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 101, 0, 3989);
			add_location(li8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 101, 0, 3985);
			add_location(li9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 102, 0, 4118);
			add_location(ul2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 100, 0, 3980);
			attr_dev(a14, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a14, "rel", "nofollow");
			add_location(a14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 104, 12, 4310);
			add_location(p7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 104, 0, 4268);
			add_location(brb13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 108, 0, 4496);
			add_location(brb14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 109, 0, 4504);
			add_location(strong1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 110, 4, 4516);
			add_location(h21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 110, 0, 4512);
			attr_dev(pre0, "class", "language-glsl");
			add_location(pre0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 111, 0, 4548);
			add_location(brb15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 176, 0, 18018);
			attr_dev(pre1, "class", "language-glsl");
			add_location(pre1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 177, 0, 18026);
			attr_dev(a15, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a15, "rel", "nofollow");
			add_location(a15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 178, 6, 18419);
			attr_dev(a16, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a16, "rel", "nofollow");
			add_location(a16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 181, 1, 18562);
			add_location(p8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 178, 0, 18410);
			add_location(brb16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 185, 0, 18658);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 186, 0, 18666);
			attr_dev(a17, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a17, "rel", "nofollow");
			add_location(a17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 188, 7, 19191);
			attr_dev(a18, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a18, "rel", "nofollow");
			add_location(a18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 193, 0, 19465);
			add_location(li10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 188, 0, 19151);
			add_location(li11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 198, 0, 19641);
			add_location(li12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 200, 0, 19859);
			add_location(ul3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 187, 0, 19146);
			attr_dev(a19, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a19, "rel", "nofollow");
			add_location(a19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 203, 7, 19992);
			add_location(p9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 203, 0, 19972);
			add_location(brb17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 207, 0, 20102);
			add_location(strong2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 208, 0, 20114);
			add_location(h22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 208, 0, 20110);
			attr_dev(pre3, "class", "language-glsl");
			add_location(pre3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 209, 0, 20152);
			add_location(brb18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 225, 0, 25837);
			add_location(p10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 226, 0, 25845);
			attr_dev(a20, "href", "https://en.wikipedia.org/wiki/Affine_transformation");
			attr_dev(a20, "rel", "nofollow");
			add_location(a20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 227, 56, 25947);
			add_location(p11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 227, 0, 25886);
			attr_dev(a21, "href", "https://en.wikipedia.org/wiki/Inversive_geometry");
			attr_dev(a21, "rel", "nofollow");
			add_location(a21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 231, 0, 26086);
			add_location(code, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 234, 0, 26189);
			attr_dev(a22, "href", "https://en.wikipedia.org/wiki/M%C3%B6bius_transformation");
			attr_dev(a22, "rel", "nofollow");
			add_location(a22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 234, 0, 26238);
			attr_dev(a23, "href", "https://en.wikipedia.org/wiki/Conformal_map");
			attr_dev(a23, "rel", "nofollow");
			add_location(a23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 238, 39, 26432);
			add_location(p12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 231, 0, 26083);
			add_location(brb19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 242, 0, 26566);
			add_location(brb20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 244, 0, 26610);
			add_location(brb21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 245, 0, 26618);
			attr_dev(a24, "href", "https://github.com/bezo97/IFSRenderer");
			attr_dev(a24, "rel", "nofollow");
			add_location(a24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 3, 26629);
			...
			add_location(a25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 21, 26710);
			add_location(p13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 0, 26626);
			add_location(brb22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 250, 0, 26909);
			add_location(strong3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 251, 0, 26921);
			add_location(h23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 251, 0, 26917);
			attr_dev(a26, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a26, "rel", "nofollow");
			add_location(a26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 7, 27006);
			add_location(p14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 0, 26965);
			add_location(p15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 256, 0, 27232);
			attr_dev(a27, "href", "https://64.github.io/tonemapping/");
			attr_dev(a27, "rel", "nofollow");
			add_location(a27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 257, 71, 27399);
			add_location(p16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 257, 0, 27277);
			attr_dev(a28, "href", "https://www-old.cs.utah.edu/docs/techreports/2002/pdf/UUCS-02-001.pdf");
			attr_dev(a28, "rel", "nofollow");
			add_location(a28, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 261, 0, 27591);
			add_location(p17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 261, 0, 27491);
			add_location(brb23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 267, 1, 27933);
			attr_dev(pre4, "class", "language-glsl");
			add_location(pre4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 268, 1, 27941);
			add_location(strong4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32028);
			add_location(h24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32024);
			attr_dev(a29, "href", "https://www.pouet.net/prod.php?which=82417");
			attr_dev(a29, "rel", "nofollow");
			add_location(a29, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32068);
			add_location(p18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32065);
			add_location(brb24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32322);
			attr_dev(pre5, "class", "language-glsl");
			add_location(pre5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 32330);
			add_location(brb25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 34401);
			add_location(p19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, -1, 34409);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			insert_dev(target, t0, anchor);
			insert_dev(target, brb0, anchor);
			insert_dev(target, t1, anchor);
			insert_dev(target, brb1, anchor);
			insert_dev(target, t2, anchor);
			...
			insert_dev(target, brb2, anchor);
			insert_dev(target, t22, anchor);
			insert_dev(target, brb3, anchor);
			...
			insert_dev(target, brb4, anchor);
			insert_dev(target, t32, anchor);
			insert_dev(target, brb5, anchor);
			insert_dev(target, t33, anchor);
			mount_component(youtubevideo0, target, anchor);
			insert_dev(target, t34, anchor);
			mount_component(subtitle1, target, anchor);
			insert_dev(target, t35, anchor);
			insert_dev(target, brb6, anchor);
			insert_dev(target, t36, anchor);
			insert_dev(target, brb7, anchor);
			...
			insert_dev(target, brb13, anchor);
			insert_dev(target, t86, anchor);
			insert_dev(target, brb14, anchor);
			...
			insert_dev(target, brb15, anchor);
			...
			insert_dev(target, brb16, anchor);
			...
			insert_dev(target, brb17, anchor);
			...
			insert_dev(target, brb18, anchor);
			...
			insert_dev(target, brb22, anchor);
			...
			insert_dev(target, brb23, anchor);
			...
			insert_dev(target, brb24, anchor);
...
function NavBar_svelte_add_css(target) {
	append_styles(target, "svelte-1r5zl3t", "#bar.svelte-1r5zl3t.svelte-1r5zl3t{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-1r5zl3t #bar-left.svelte-1r5zl3t{display:flex;flex-direction:column}#bar.svelte-1r5zl3t mark.svelte-1r5zl3t{background:var(--accent-dark)}#bar.svelte-1r5zl3t .logo.svelte-1r5zl3t{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-1r5zl3t .logo.logo-behind.svelte-1r5zl3t{position:absolute}#bar.svelte-1r5zl3t .logo.hovered.svelte-1r5zl3t{color:var(--accent-dark) !important}#bar.svelte-1r5zl3t .logo.hovered.hover-effect-0.svelte-1r5zl3t{animation:svelte-1r5zl3t-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-1r5zl3t-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-1r5zl3t-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-1r5zl3t-glitch-anim3{0%{clip:rect(1rem, 9999px, 1.5rem, 0);transform-origin:center}2%{clip:rect(1.8rem, 9999px, 0.5rem, 0);transform-origin:center}4%{clip:rect(4rem, 9999px, 1rem, 0);transform-origin:center}6%{clip:rect(2.7rem, 9999px, 2rem, 0);transform-origin:center}8%{clip:rect(0.7rem, 9999px, 4rem, 0);transform-origin:center}10%{clip:rect(0.5rem, 9999px, 2rem, 0);transform-origin:center}12%{clip:rect(0.8rem, 9999px, 0.5rem, 0);transform-origin:center}14%{clip:rect(3.6rem, 9999px, 2rem, 0);transform-origin:center}16%{clip:rect(1.1rem, 9999px, 4.5rem, 0);transform-origin:center}18%{clip:rect(0.5rem, 9999px, 2rem, 0);transform-origin:center}20%{clip:rect(0.8rem, 9999px, 2rem, 0);transform-origin:center}22%{clip:rect(2.8rem, 9999px, 5rem, 0);transform-origin:center}24%{clip:rect(0.1rem, 9999px, 4.5rem, 0);transform-origin:center}26%{clip:rect(3.6rem, 9999px, 4rem, 0);transform-origin:center}28%{clip:rect(1.7rem, 9999px, 4rem, 0);transform-origin:center}30%{clip:rect(2.9rem, 9999px, 3rem, 0);transform-origin:center}32%{clip:rect(0.6rem, 9999px, 3rem, 0);transform-origin:center}34%{clip:rect(0.3rem, 9999px, 0.5rem, 0);transform-origin:center}36%{clip:rect(2.1rem, 9999px, 1.5rem, 0);transform-origin:center}38%{clip:rect(1.9rem, 9999px, 4rem, 0);transform-origin:center}40%{clip:rect(0.2rem, 9999px, 4.5rem, 0);transform-origin:center}42%{clip:rect(2.7rem, 9999px, 2.5rem, 0);transform-origin:center}44%{clip:rect(2rem, 9999px, 3rem, 0);transform-origin:center}46%{clip:rect(0.7rem, 9999px, 0.5rem, 0);transform-origin:center}48%{clip:rect(0.3rem, 9999px, 2.5rem, 0);transform-origin:center}50%{clip:rect(4rem, 9999px, 2.5rem, 0);transform-origin:center}52%{clip:rect(3.6rem, 9999px, 2rem, 0);transform-origin:center}54%{clip:rect(1.3rem, 9999px, 3rem, 0);transform-origin:center}56%{clip:rect(2.3rem, 9999px, 5rem, 0);transform-origin:center}58%{clip:rect(0.1rem, 9999px, 1rem, 0);transform-origin:center}60%{clip:rect(0.4rem, 9999px, 5rem, 0);transform-origin:center}62%{clip:rect(3rem, 9999px, 1rem, 0);transform-origin:center}64%{clip:rect(0.8rem, 9999px, 2.5rem, 0);transform-origin:center}66%{clip:rect(3.9rem, 9999px, 4rem, 0);transform-origin:center}68%{clip:rect(3rem, 9999px, 3rem, 0);transform-origin:center}70%{clip:rect(1.8rem, 9999px, 0.5rem, 0);transform-origin:center}72%{clip:rect(2.4rem, 9999px, 0.5rem, 0);transform-origin:center}74%{clip:rect(3.9rem, 9999px, 5rem, 0);transform-origin:center}76%{clip:rect(0.2rem, 9999px, 5rem, 0);transform-origin:center}78%{clip:rect(2.4rem, 9999px, 4rem, 0);transform-origin:center}80%{clip:rect(1.5rem, 9999px, 4.5rem, 0);transform-origin:center}82%{clip:rect(0.2rem, 9999px, 4.5rem, 0);transform-origin:center}84%{clip:rect(1rem, 9999px, 4rem, 0);transform-origin:center}86%{clip:rect(0.3rem, 9999px, 4rem, 0);transform-origin:center}88%{clip:rect(3.5rem, 9999px, 3.5rem, 0);transform-origin:center}90%{clip:rect(3.8rem, 9999px, 1.5rem, 0);transform-origin:center}92%{clip:rect(0.2rem, 9999px, 2rem, 0);transform-origin:center}94%{clip:rect(0.3rem, 9999px, 2rem, 0);transform-origin:center}96%{clip:rect(0.1rem, 9999px, 4.5rem, 0);transform-origin:center}98%{clip:rect(3.7rem, 9999px, 3.5rem, 0);transform-origin:center}}@keyframes svelte-1r5zl3t-cooool{0%{color:red !important}2%{color:red !important}4%{color:red !important}6%{color:red !important}8%{color:red !important}10%{color:red !important}12%{color:red !important}14%{color:red !important}16%{color:red !important}18%{color:red !important}20%{color:red !important}22%{color:red !important}24%{color:red !important}26%{color:red !important}28%{color:red !important}30%{color:red !important}32%{color:red !important}34%{color:red !important}36%{color:red !important}38%{color:red !important}40%{color:red !important}42%{color:red !important}44%{color:red !important}46%{color:red !important}48%{color:red !important}50%{color:red !important}52%{color:red !important}54%{color:red !important}56%{color:red !important}58%{color:red !important}60%{color:red !important}62%{color:red !important}64%{color:red !important}66%{color:red !important}68%{color:red !important}70%{color:red !important}72%{color:red !important}74%{color:red !important}76%{color:red !important}78%{color:red !important}80%{color:red !important}82%{color:red !important}84%{color:red !important}86%{color:red !important}88%{color:red !important}90%{color:red !important}92%{color:red !important}94%{color:red !important}96%{color:red !important}98%{color:red !important}}#bar.svelte-1r5zl3t .logo.hovered.hover-effect-0.logo-behind-a.svelte-1r5zl3t{color:#ffc800 !important;animation:svelte-1r5zl3t-distort1 300ms linear infinite, svelte-1r5zl3t-glitch-anim3 5s infinite linear alternate-reverse, svelte-1r5zl3t-cooool 5s infinite linear alternate-reverse}#bar.svelte-1r5zl3t .logo.hovered.hover-effect-0.logo-behind-b.svelte-1r5zl3t{color:#aa10f2 !important;animation:svelte-1r5zl3t-distort2 300ms linear infinite, svelte-1r5zl3t-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-1r5zl3t .logo.hover-effect-1.svelte-1r5zl3t{animation:svelte-1r5zl3t-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-1r5zl3t-glitch-anim{0%{clip:rect(4rem, 9999px, 4.5rem, 0);transform:skew(5.5deg);z-index:2}2%{clip:rect(2.8rem, 9999px, 2.5rem, 0);transform:skew(3.4deg);z-index:2}4%{clip:rect(3.9rem, 9999px, 1.5rem, 0);transform:skew(5.4deg);z-index:1}6%{clip:rect(1.2rem, 9999px, 4rem, 0);transform:skew(0.9deg);z-index:3}8%{clip:rect(3.8rem, 9999px, 1rem, 0);transform:skew(6.4deg);z-index:2}10%{clip:rect(3.4rem, 9999px, 4.5rem, 0);transform:skew(0.7deg);z-index:4}12%{clip:rect(0.2rem, 9999px, 1rem, 0);transform:skew(4.3deg);z-index:1}14%{clip:rect(1.6rem, 9999px, 1rem, 0);transform:skew(3.5deg);z-index:3}16%{clip:rect(3.4rem, 9999px, 2rem, 0);transform:skew(0.7deg);z-index:2}18%{clip:rect(1.9rem, 9999px, 2rem, 0);transform:skew(0.6deg);z-index:4}20%{clip:rect(1.2rem, 9999px, 4rem, 0);transform:skew(7.9deg);z-index:2}22%{clip:rect(2.8rem, 9999px, 1.5rem, 0);transform:skew(1.4deg);z-index:1}24%{clip:rect(1.5rem, 9999px, 1.5rem, 0);transform:skew(8.8deg);z-index:2}26%{clip:rect(1.3rem, 9999px, 0.5rem, 0);transform:skew(3.4deg);z-index:2}28%{clip:rect(1.7rem, 9999px, 2.5rem, 0);transform:skew(2.1deg);z-index:4}30%{clip:rect(0.8rem, 9999px, 1rem, 0);transform:skew(7.3deg);z-index:2}32%{clip:rect(1.5rem, 9999px, 2.5rem, 0);transform:skew(8.6deg);z-index:3}34%{clip:rect(3.2rem, 9999px, 3rem, 0);transform:skew(1.6deg);z-index:2}36%{clip:rect(0.4rem, 9999px, 3rem, 0);transform:skew(3.5deg);z-index:3}38%{clip:rect(2.7rem, 9999px, 3rem, 0);transform:skew(5.1deg);z-index:1}40%{clip:rect(2.2rem, 9999px, 3rem, 0);transform:skew(3.1deg);z-index:2}42%{clip:rect(3.2rem, 9999px, 2.5rem, 0);transform:skew(3.7deg);z-index:4}44%{clip:rect(2.9rem, 9999px, 1rem, 0);transform:skew(0.1deg);z-index:4}46%{clip:rect(0.6rem, 9999px, 0.5rem, 0);transform:skew(9.8deg);z-index:3}48%{clip:rect(3rem, 9999px, 0.5rem, 0);transform:skew(3deg);z-index:4}50%{clip:rect(0.1rem, 9999px, 0.5rem, 0);transform:skew(4.6deg);z-index:4}52%{clip:rect(1.6rem, 9999px, 2rem, 0);transform:skew(8.6deg);z-index:1}54%{clip:rect(1.8rem, 9999px, 5rem, 0);transform:skew(2deg);z-index:3}56%{clip:rect(0.7rem, 9999px, 3rem, 0);transform:skew(0.6deg);z-index:1}58%{clip:rect(0.3rem, 9999px, 2rem, 0);transform:skew(0.9deg);z-index:2}60%{clip:rect(0.2rem, 9999px, 3rem, 0);transform:skew(5.6deg);z-index:2}62%{clip:rect(3.5rem, 9999px, 1rem, 0);transform:skew(4.3deg);z-index:3}64%{clip:rect(1.2rem, 9999px, 5rem, 0);transform:skew(8.2deg);z-index:1}66%{clip:rect(2.9rem, 9999px, 4rem, 0);transform:skew(6.5deg);z-index:2}68%{clip:rect(1.3rem, 9999px, 4rem, 0);transform:skew(3.9deg);z-index:3}70%{clip:rect(2.9rem, 9999px, 1rem, 0);transform:skew(2.7deg);z-index:2}72%{clip:rect(3.2rem, 9999px, 4.5rem, 0);transform:skew(2.8deg);z-index:2}74%{clip:rect(3.4rem, 9999px, 1.5rem, 0);transform:skew(2.8deg);z-index:4}76%{clip:rect(1.9rem, 9999px, 2.5rem, 0);transform:skew(8.3deg);z-index:1}78%{clip:rect(3.9rem, 9999px, 4rem, 0);transform:skew(4.2deg);z-index:3}80%{clip:rect(3.7rem, 9999px, 5rem, 0);transform:skew(4.2deg);z-index:4}82%{clip:rect(0.4rem, 9999px, 2.5rem, 0);transform:skew(3.1deg);z-index:4}84%{clip:rect(0.8rem, 9999px, 3.5rem, 0);transform:skew(5.6deg);z-index:3}86%{clip:rect(2.7rem, 9999px, 3rem, 0);transform:skew(2.9deg);z-index:4}88%{clip:rect(0.6rem, 9999px, 4rem, 0);transform:skew(7.6deg);z-index:1}90%{clip:rect(4rem, 9999px, 5rem, 0);transform:skew(3.3deg);z-index:2}92%{clip:rect(2.1rem, 9999px, 4rem, 0);transform:skew(9.2deg);z-index:4}94%{clip:rect(3.5rem, 9999px, 0.5rem, 0);transform:skew(5.6deg);z-index:1}96%{clip:rect(3.5rem, 9999px, 4.5rem, 0);transform:skew(2.6deg);z-index:2}98%{clip:rect(2.8rem, 9999px, 4.5rem, 0);transform:skew(8.2deg);z-index:2}}@keyframes svelte-1r5zl3t-glitch-anim2{0%{clip:rect(0.2rem, 99999px, 5.6rem, 0);transform:skew(7.9deg);transform:translateX(0.3888888889rem)}0.6666666667%{clip:rect(0.2rem, 99999px, 5.7rem, 0);transform:skew(8.4deg);transform:translateX(-0.1666666667rem)}1.3333333333%{clip:rect(0.14rem, 99999px, 2.2rem, 0);transform:skew(7.4deg);transform:translateX(0rem)}2%{clip:rect(0.1rem, 99999px, 9.1rem, 0);transform:skew(12deg);transform:translateX(0.4259259259rem)}2.6666666667%{clip:rect(0.08rem, 99999px, 3.4rem, 0);transform:skew(9.6deg);transform:translateX(0.4259259259rem)}3.3333333333%{clip:rect(0.2rem, 99999px, 0.3rem, 0);transform:skew(13deg);transform:translateX(0.2777777778rem)}4%{clip:rect(0.04rem, 99999px, 2.4rem, 0);transform:skew(6.4deg);transform:translateX(0.0555555556rem)}4.6666666667%{clip:rect(0.12rem, 99999px, 5.8rem, 0);transform:skew(1.4deg);transform:translateX(0.0555555556rem)}5.3333333333%{clip:rect(0.04rem, 99999px, 6.3rem, 0);transform:skew(9.3deg);transform:translateX(0.3333333333rem)}6%{clip:rect(0.14rem, 99999px, 3.6rem, 0);transform:skew(1deg);transform:translateX(0.4814814815rem)}6.6666666667%{clip:rect(0.1rem, 99999px, 1.7rem, 0);transform:skew(0.3deg);transform:translateX(0.2777777778rem)}7.3333333333%{clip:rect(0.16rem, 99999px, 5.1rem, 0);transform:skew(7.1deg);transform:translateX(0.3333333333rem)}8%{clip:rect(0.06rem, 99999px, 3.1rem, 0);transform:skew(7.2deg);transform:translateX(0.3333333333rem)}8.6666666667%{clip:rect(0.06rem, 99999px, 7.9rem, 0);transform:skew(1deg);transform:translateX(0.3518518519rem)}9.3333333333%{clip:rect(0.16rem, 99999px, 2rem, 0);transform:skew(7.4deg);transform:translateX(0.4444444444rem)}10%{clip:rect(0.12rem, 99999px, 9.3rem, 0);transform:skew(1.4deg);transform:translateX(0.2777777778rem)}10.6666666667%{clip:rect(0.02rem, 99999px, 3.5rem, 0);transform:skew(9.6deg);transform:translateX(0.1666666667rem)}11.3333333333%{clip:rect(0.12rem, 99999px, 0.3rem, 0);transform:skew(4.4deg);transform:translateX(0.2777777778rem)}12%{clip:rect(0.18rem, 99999px, 3.1rem, 0);transform:skew(7.7deg);transform:translateX(0.3888888889rem)}12.6666666667%{clip:rect(0.16rem, 99999px, 9rem, 0);transform:skew(9.6deg);transform:translateX(0.3333333333rem)}13.3333333333%{clip:rect(0.1rem, 99999px, 3.2rem, 0);transform:skew(9.4deg);transform:translateX(0.3333333333rem)}14%{clip:rect(0.18rem, 99999px, 9.2rem, 0);transform:skew(3.9deg);transform:translateX(0.4444444444rem)}14.6666666667%{clip:rect(0.02rem, 99999px, 7.8rem, 0);transform:skew(1.6deg);transform:translateX(0.1666666667rem)}15.3333333333%{clip:rect(0.2rem, 99999px, 5.1rem, 0);transform:skew(13.7deg);transform:translateX(0.4444444444rem)}16%{clip:rect(0.08rem, 99999px, 9.4rem, 0);transform:skew(4.5deg);transform:translateX(0.1666666667rem)}16.6666666667%{clip:rect(0.2rem, 99999px, 5.7rem, 0);transform:skew(10.2deg);transform:translateX(0.4259259259rem)}17.3333333333%{clip:rect(0.1rem, 99999px, 4.1rem, 0);transform:skew(6.6deg);transform:translateX(-0.1666666667rem)}18%{clip:rect(0.14rem, 99999px, 8.6rem, 0);transform:skew(9.3deg);transform:translateX(0.4444444444rem)}18.6666666667%{clip:rect(0.04rem, 99999px, 3.6rem, 0);transform:skew(12.4deg);transform:translateX(0.2777777778rem)}19.3333333333%{clip:rect(0.04rem, 99999px, 4.2rem, 0);transform:skew(13.8deg);transform:translateX(0.3333333333rem)}20%{clip:rect(0.12rem, 99999px, 4.7rem, 0);transform:skew(7.7deg);transform:translateX(-0.1666666667rem)}20.6666666667%{clip:rect(0.02rem, 99999px, 4.3rem, 0);transform:skew(0.1deg);transform:translateX(0.3518518519rem)}21.3333333333%{clip:rect(0.02rem, 99999px, 6.9rem, 0);transform:skew(7.1deg);transform:translateX(0.2777777778rem)}22%{clip:rect(0.18rem, 99999px, 6.2rem, 0);transform:skew(11.1deg);transform:translateX(0.3518518519rem)}22.6666666667%{clip:rect(0.06rem, 99999px, 2.9rem, 0);transform:skew(13.1deg);transform:translateX(0.1666666667rem)}23.3333333333%{clip:rect(0.04rem, 99999px, 3.4rem, 0);transform:skew(6.1deg);transform:translateX(0.4259259259rem)}24%{clip:rect(0.18rem, 99999px, 6.2rem, 0);transform:skew(5.8deg);transform:translateX(-0.1666666667rem)}24.6666666667%{clip:rect(0.08rem, 99999px, 4.5rem, 0);transform:skew(0.9deg);transform:translateX(0.2777777778rem)}25.3333333333%{clip:rect(0.12rem, 99999px, 0.2rem, 0);transform:skew(5.5deg);transform:translateX(0.1666666667rem)}26%{clip:rect(0.06rem, 99999px, 8.4rem, 0);transform:skew(0.1deg);transform:translateX(0.462962963rem)}26.6666666667%{clip:rect(0.18rem, 99999px, 0.9rem, 0);transform:skew(9.5deg);transform:translateX(0.2777777778rem)}27.3333333333%{clip:rect(0.2rem, 99999px, 3.9rem, 0);transform:skew(13.9deg);transform:translateX(0.2777777778rem)}28%{clip:rect(0.04rem, 99999px, 7.7rem, 0);transform:skew(10.8deg);transform:translateX(0.3333333333rem)}28.6666666667%{clip:rect(0.16rem, 99999px, 3.8rem, 0);transform:skew(2.7deg);transform:translateX(0.4259259259rem)}29.3333333333%{clip:rect(0.16rem, 99999px, 4.3rem, 0);transform:skew(11.5deg);transform:translateX(0.2777777778rem)}30%{clip:rect(0.04rem, 99999px, 9.6rem, 0);transform:skew(11.4deg);transform:translateX(0.0555555556rem)}30.6666666667%{clip:rect(0.02rem, 99999px, 8rem, 0);transform:skew(7.4deg);transform:translateX(0.2037037037rem)}31.3333333333%{clip:rect(0.02rem, 99999px, 0.5rem, 0);transform:skew(8.6deg);transform:translateX(0.1666666667rem)}32%{clip:rect(0.18rem, 99999px, 2.5rem, 0);transform:skew(9.3deg);transform:translateX(0.2777777778rem)}32.6666666667%{clip:rect(0.04rem, 99999px, 2.5rem, 0);transform:skew(0.7deg);transform:translateX(0.0555555556rem)}33.3333333333%{clip:rect(0.06rem, 99999px, 1.7rem, 0);transform:skew(0.2deg);transform:translateX(0.1666666667rem)}34%{clip:rect(0.04rem, 99999px, 1.7rem, 0);transform:skew(2deg);transform:translateX(0.1666666667rem)}34.6666666667%{clip:rect(0.1rem, 99999px, 3rem, 0);transform:skew(7.8deg);transform:translateX(0.1666666667rem)}35.3333333333%{clip:rect(0.2rem, 99999px, 7.7rem, 0);transform:skew(9.5deg);transform:translateX(0.4259259259rem)}36%{clip:rect(0.16rem, 99999px, 1.3rem, 0);transform:skew(1.6deg);transform:translateX(0.0555555556rem)}36.6666666667%{clip:rect(0.02rem, 99999px, 4.7rem, 0);transform:skew(12.9deg);transform:translateX(0.462962963rem)}37.3333333333%{clip:rect(0.04rem, 99999px, 10rem, 0);transform:skew(11.2deg);transform:translateX(0.3888888889rem)}38%{clip:rect(0.04rem, 99999px, 1.6rem, 0);transform:skew(12deg);transform:translateX(-0.5rem)}38.6666666667%{clip:rect(0.16rem, 99999px, 5.2rem, 0);transform:skew(4.3deg);transform:translateX(0.3518518519rem)}39.3333333333%{clip:rect(0.2rem, 99999px, 2.9rem, 0);transform:skew(10.1deg);transform:translateX(0.462962963rem)}40%{clip:rect(0.02rem, 99999px, 3.7rem, 0);transform:skew(1.9deg);transform:translateX(0.0555555556rem)}40.6666666667%{clip:rect(0.18rem, 99999px, 8.3rem, 0);transform:skew(7.5deg);transform:translateX(0.3888888889rem)}41.3333333333%{clip:rect(0.02rem, 99999px, 7.5rem, 0);transform:skew(3.3deg);transform:translateX(0.2777777778rem)}42%{clip:rect(0.1rem, 99999px, 8rem, 0);transform:skew(4.1deg);transform:translateX(0.2777777778rem)}42.6666666667%{clip:rect(0.1rem, 99999px, 7.5rem, 0);transform:skew(0.6deg);transform:translateX(-0.1666666667rem)}43.3333333333%{clip:rect(0.12rem, 99999px, 0.6rem, 0);transform:skew(12.4deg);transform:translateX(0.2777777778rem)}44%{clip:rect(0.18rem, 99999px, 8.7rem, 0);transform:skew(2deg);transform:translateX(-0.1666666667rem)}44.6666666667%{clip:rect(0.1rem, 99999px, 5.1rem, 0);transform:skew(2.2deg);transform:translateX(-0.1666666667rem)}45.3333333333%{clip:rect(0.16rem, 99999px, 4.7rem, 0);transform:skew(7.1deg);transform:translateX(0rem)}46%{clip:rect(0.1rem, 99999px, 1.3rem, 0);transform:skew(12.4deg);transform:translateX(0.1666666667rem)}46.6666666667%{clip:rect(0.08rem, 99999px, 7.7rem, 0);transform:skew(12.4deg);transform:translateX(0.2777777778rem)}47.3333333333%{clip:rect(0.04rem, 99999px, 8.6rem, 0);transform:skew(13.4deg);transform:translateX(0.4259259259rem)}48%{clip:rect(0.1rem, 99999px, 7.8rem, 0);transform:skew(6.5deg);transform:translateX(0.0555555556rem)}48.6666666667%{clip:rect(0.1rem, 99999px, 2.7rem, 0);transform:skew(11.9deg);transform:translateX(0.3888888889rem)}49.3333333333%{clip:rect(0.14rem, 99999px, 0.7rem, 0);transform:skew(8.7deg);transform:translateX(0.1666666667rem)}50%{clip:rect(0.04rem, 99999px, 9.3rem, 0);transform:skew(13.7deg);transform:translateX(0.2777777778rem)}50.6666666667%{clip:rect(0.08rem, 99999px, 8rem, 0);transform:skew(5.2deg);transform:translateX(0.3888888889rem)}51.3333333333%{clip:rect(0.18rem, 99999px, 5.4rem, 0);transform:skew(6.2deg);transform:translateX(0.1666666667rem)}52%{clip:rect(0.2rem, 99999px, 2.8rem, 0);transform:skew(5.6deg);transform:translateX(0.1666666667rem)}52.6666666667%{clip:rect(0.08rem, 99999px, 8rem, 0);transform:skew(3.9deg);transform:translateX(0.2777777778rem)}53.3333333333%{clip:rect(0.18rem, 99999px, 5.1rem, 0);transform:skew(11.4deg);transform:translateX(0.2777777778rem)}54%{clip:rect(0.16rem, 99999px, 2.7rem, 0);transform:skew(14.5deg);transform:translateX(0.462962963rem)}54.6666666667%{clip:rect(0.14rem, 99999px, 1.2rem, 0);transform:skew(4.9deg);transform:translateX(0.0555555556rem)}55.3333333333%{clip:rect(0.14rem, 99999px, 5.3rem, 0);transform:skew(1.3deg);transform:translateX(0.2777777778rem)}56%{clip:rect(0.04rem, 99999px, 6.2rem, 0);transform:skew(9.6deg);transform:translateX(0.462962963rem)}56.6666666667%{clip:rect(0.2rem, 99999px, 1.6rem, 0);transform:skew(10.8deg);transform:translateX(0.2777777778rem)}57.3333333333%{clip:rect(0.02rem, 99999px, 4.8rem, 0);transform:skew(6.7deg);transform:translateX(0.2777777778rem)}58%{clip:rect(0.02rem, 99999px, 0.5rem, 0);transform:skew(2.8deg);transform:translateX(0.0555555556rem)}58.6666666667%{clip:rect(0.08rem, 99999px, 7.8rem, 0);transform:skew(12.8deg);transform:translateX(0.3518518519rem)}59.3333333333%{clip:rect(0.14rem, 99999px, 2.8rem, 0);transform:skew(9.8deg);transform:translateX(0.4444444444rem)}60%{clip:rect(0.1rem, 99999px, 9.7rem, 0);transform:skew(6.6deg);transform:translateX(0.2777777778rem)}60.6666666667%{clip:rect(0.2rem, 99999px, 1.9rem, 0);transform:skew(3.2deg);transform:translateX(0.1666666667rem)}61.3333333333%{clip:rect(0.14rem, 99999px, 7.3rem, 0);transform:skew(12.2deg);transform:translateX(0.462962963rem)}62%{clip:rect(0.02rem, 99999px, 1.8rem, 0);transform:skew(0.2deg);transform:translateX(0.4259259259rem)}62.6666666667%{clip:rect(0.1rem, 99999px, 4.1rem, 0);transform:skew(13.5deg);transform:translateX(0.3333333333rem)}63.3333333333%{clip:rect(0.12rem, 99999px, 6.8rem, 0);transform:skew(10.1deg);transform:translateX(0.4444444444rem)}64%{clip:rect(0.1rem, 99999px, 0.8rem, 0);transform:skew(0.8deg);transform:translateX(-0.1666666667rem)}64.6666666667%{clip:rect(0.2rem, 99999px, 0.7rem, 0);transform:skew(9.2deg);transform:translateX(-0.1666666667rem)}65.3333333333%{clip:rect(0.06rem, 99999px, 5.1rem, 0);transform:skew(0.6deg);transform:translateX(0.462962963rem)}66%{clip:rect(0.18rem, 99999px, 5.1rem, 0);transform:skew(11.8deg);transform:translateX(0.2777777778rem)}66.6666666667%{clip:rect(0.2rem, 99999px, 8.4rem, 0);transform:skew(3.6deg);transform:translateX(0.4259259259rem)}67.3333333333%{clip:rect(0.02rem, 99999px, 0.8rem, 0);transform:skew(14deg);transform:translateX(0.3518518519rem)}68%{clip:rect(0.02rem, 99999px, 3.4rem, 0);transform:skew(3.3deg);transform:translateX(0.2777777778rem)}68.6666666667%{clip:rect(0.12rem, 99999px, 1.9rem, 0);transform:skew(14deg);transform:translateX(0.3333333333rem)}69.3333333333%{clip:rect(0.06rem, 99999px, 5.5rem, 0);transform:skew(14deg);transform:translateX(0.3888888889rem)}70%{clip:rect(0.02rem, 99999px, 1.2rem, 0);transform:skew(13.8deg);transform:translateX(0.4444444444rem)}70.6666666667%{clip:rect(0.02rem, 99999px, 7.8rem, 0);transform:skew(14.6deg);transform:translateX(0.2777777778rem)}71.3333333333%{clip:rect(0.14rem, 99999px, 2.3rem, 0);transform:skew(1.3deg);transform:translateX(0.3518518519rem)}72%{clip:rect(0.02rem, 99999px, 10rem, 0);transform:skew(11.7deg);transform:translateX(0.1666666667rem)}72.6666666667%{clip:rect(0.14rem, 99999px, 3.5rem, 0);transform:skew(14.3deg);transform:translateX(0.3518518519rem)}73.3333333333%{clip:rect(0.08rem, 99999px, 2.3rem, 0);transform:skew(4deg);transform:translateX(0.462962963rem)}74%{clip:rect(0.06rem, 99999px, 9.2rem, 0);transform:skew(2.1deg);transform:translateX(0.1666666667rem)}74.6666666667%{clip:rect(0.06rem, 99999px, 5.7rem, 0);transform:skew(8.4deg);transform:translateX(-0.5rem)}75.3333333333%{clip:rect(0.08rem, 99999px, 0.9rem, 0);transform:skew(10.2deg);transform:translateX(0.3888888889rem)}76%{clip:rect(0.04rem, 99999px, 6.8rem, 0);transform:skew(6.7deg);transform:translateX(0.1666666667rem)}76.6666666667%{clip:rect(0.12rem, 99999px, 3.3rem, 0);transform:skew(4.1deg);transform:translateX(0.0555555556rem)}77.3333333333%{clip:rect(0.04rem, 99999px, 5.1rem, 0);transform:skew(3.3deg);transform:translateX(0.3888888889rem)}78%{clip:rect(0.12rem, 99999px, 1.3rem, 0);transform:skew(6.8deg);transform:translateX(-0.1666666667rem)}78.6666666667%{clip:rect(0.16rem, 99999px, 1.9rem, 0);transform:skew(5.9deg);transform:translateX(0.4259259259rem)}79.3333333333%{clip:rect(0.18rem, 99999px, 7.2rem, 0);transform:skew(14.7deg);transform:translateX(0.462962963rem)}80%{clip:rect(0.14rem, 99999px, 2rem, 0);transform:skew(0.7deg);transform:translateX(0.4259259259rem)}80.6666666667%{clip:rect(0.18rem, 99999px, 2.7rem, 0);transform:skew(2.6deg);transform:translateX(0.4444444444rem)}81.3333333333%{clip:rect(0.08rem, 99999px, 4.4rem, 0);transform:skew(10.1deg);transform:translateX(0.2777777778rem)}82%{clip:rect(0.04rem, 99999px, 7.2rem, 0);transform:skew(10.6deg);transform:translateX(0.4444444444rem)}82.6666666667%{clip:rect(0.12rem, 99999px, 3.2rem, 0);transform:skew(3deg);transform:translateX(0.3888888889rem)}83.3333333333%{clip:rect(0.1rem, 99999px, 2rem, 0);transform:skew(4.8deg);transform:translateX(0.4814814815rem)}84%{clip:rect(0.08rem, 99999px, 6.9rem, 0);transform:skew(13.6deg);transform:translateX(0.1666666667rem)}84.6666666667%{clip:rect(0.14rem, 99999px, 6.7rem, 0);transform:skew(13.8deg);transform:translateX(0.3333333333rem)}85.3333333333%{clip:rect(0.18rem, 99999px, 1.3rem, 0);transform:skew(3.3deg);transform:translateX(0.3888888889rem)}86%{clip:rect(0.04rem, 99999px, 5.5rem, 0);transform:skew(11.8deg);transform:translateX(0.0555555556rem)}86.6666666667%{clip:rect(0.02rem, 99999px, 6.7rem, 0);transform:skew(11deg);transform:translateX(-0.1666666667rem)}87.3333333333%{clip:rect(0.12rem, 99999px, 7.5rem, 0);transform:skew(1.4deg);transform:translateX(0.3518518519rem)}88%{clip:rect(0.2rem, 99999px, 3.1rem, 0);transform:skew(8.3deg);transform:translateX(0.2777777778rem)}88.6666666667%{clip:rect(0.16rem, 99999px, 6rem, 0);transform:skew(4.9deg);transform:translateX(-0.1666666667rem)}89.3333333333%{clip:rect(0.02rem, 99999px, 2.7rem, 0);transform:skew(6.9deg);transform:translateX(0.1666666667rem)}90%{clip:rect(0.1rem, 99999px, 3.9rem, 0);transform:skew(6.6deg);transform:translateX(0.2777777778rem)}90.6666666667%{clip:rect(0.06rem, 99999px, 2.7rem, 0);transform:skew(4.8deg);transform:translateX(0.2777777778rem)}91.3333333333%{clip:rect(0.08rem, 99999px, 1.6rem, 0);transform:skew(1.6deg);transform:translateX(0.4259259259rem)}92%{clip:rect(0.14rem, 99999px, 9.5rem, 0);transform:skew(0.5deg);transform:translateX(0.3888888889rem)}92.6666666667%{clip:rect(0.2rem, 99999px, 1.8rem, 0);transform:skew(6.7deg);transform:translateX(0.462962963rem)}93.3333333333%{clip:rect(0.12rem, 99999px, 4.8rem, 0);transform:skew(5.9deg);transform:translateX(0.3518518519rem)}94%{clip:rect(0.06rem, 99999px, 6rem, 0);transform:skew(5.4deg);transform:translateX(-0.5rem)}94.6666666667%{clip:rect(0.06rem, 99999px, 7rem, 0);transform:skew(11deg);transform:translateX(0.4444444444rem)}95.3333333333%{clip:rect(0.08rem, 99999px, 9.4rem, 0);transform:skew(7.5deg);transform:translateX(0.2777777778rem)}96%{clip:rect(0.2rem, 99999px, 9.9rem, 0);transform:skew(3.1deg);transform:translateX(0.1666666667rem)}96.6666666667%{clip:rect(0.06rem, 99999px, 0.8rem, 0);transform:skew(2.7deg);transform:translateX(0.4259259259rem)}97.3333333333%{clip:rect(0.14rem, 99999px, 6.9rem, 0);transform:skew(11.7deg);transform:translateX(0.3888888889rem)}98%{clip:rect(0.1rem, 99999px, 9.2rem, 0);transform:skew(4.7deg);transform:translateX(0.3888888889rem)}98.6666666667%{clip:rect(0.1rem, 99999px, 3.9rem, 0);transform:skew(4deg);transform:translateX(0.4259259259rem)}99.3333333333%{clip:rect(0.12rem, 99999px, 5rem, 0);transform:skew(14.3deg);transform:translateX(0.3888888889rem)}}@keyframes svelte-1r5zl3t-glitch-skew{0%{transform:skew(3deg)}10%{transform:skew(2deg)}20%{transform:skew(2deg)}30%{transform:skew(-1deg)}40%{transform:skew(5deg)}50%{transform:skew(-4deg)}60%{transform:skew(1deg)}70%{transform:skew(-2deg)}80%{transform:skew(1deg)}90%{transform:skew(5deg)}}#bar.svelte-1r5zl3t .logo.hover-effect-1.logo-behind-a.svelte-1r5zl3t{color:var(--accent-light);transform:translateX(-0.5rem);color:#ffc800 !important;text-shadow:-2px 0 #ffc800, 2px 2px #ffc800;clip:rect(44px, 450px, 56px, 0);animation:svelte-1r5zl3t-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-1r5zl3t .logo.hover-effect-1.logo-behind-b.svelte-1r5zl3t{color:rgb(165, 49, 49) !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #aa10f2;clip:rect(44px, 450px, 56px, 0);animation:svelte-1r5zl3t-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-1r5zl3t .logo.logo-behind.svelte-1r5zl3t{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-1r5zl3t .logo.logo-behind.svelte-1r5zl3t:not(.hovered){display:none}#bar.svelte-1r5zl3t #bar-right.svelte-1r5zl3t{margin-left:auto;display:flex;margin-right:1rem;margin-top:1rem;position:relative}#bar.svelte-1r5zl3t #bar-right #menus.svelte-1r5zl3t{display:flex}#bar.svelte-1r5zl3t #bar-right #menus #menu.svelte-1r5zl3t{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-1r5zl3t #bar-right #menus #menu.svelte-1r5zl3t .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function NavBar_svelte_create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			style = dom_element("style");
			style.innerHTML = ``;
			add_location(style, NavBar_svelte_file, -1, 36956);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(style, NavBar_svelte_file, -1, 36839);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function NavBar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-1r5zl3t");
			add_location(mark, NavBar_svelte_file, -1, 37189);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-1r5zl3t");
			add_location(a0, NavBar_svelte_file, -1, 37117);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-1r5zl3t");
			add_location(a1, NavBar_svelte_file, -1, 37232);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-1r5zl3t");
			add_location(a2, NavBar_svelte_file, -1, 37324);
			attr_dev(div0, "id", "logo-container");
			add_location(div0, NavBar_svelte_file, -1, 37088);
			attr_dev(div1, "id", "bar-left");
			attr_dev(div1, "class", "svelte-1r5zl3t");
			add_location(div1, NavBar_svelte_file, -1, 37041);
			attr_dev(div2, "id", "menu");
			attr_dev(div2, "class", "svelte-1r5zl3t");
			add_location(div2, NavBar_svelte_file, -1, 37626);
			attr_dev(div3, "id", "menu");
			attr_dev(div3, "class", "svelte-1r5zl3t");
			add_location(div3, NavBar_svelte_file, -1, 37927);
			attr_dev(div4, "id", "menus");
			attr_dev(div4, "class", "svelte-1r5zl3t");
			add_location(div4, NavBar_svelte_file, -1, 37580);
			attr_dev(div5, "id", "bar-right");
			attr_dev(div5, "class", "svelte-1r5zl3t");
			add_location(div5, NavBar_svelte_file, -1, 37481);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-1r5zl3t");
			add_location(nav, NavBar_svelte_file, -1, 36998);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*hovered_class*/ 64 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-1r5zl3t")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-1r5zl3t")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-1r5zl3t")) {
...
// (125:2) {#each image_cats as image_cat, i}
function artPage_svelte_create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a, "class", "menu-item");
			add_location(a, artPage_svelte_file, -1, 3159);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, t0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(125:2) {#each image_cats as image_cat, i}",
		ctx
	});
...
// (135:1) {#each image_cats as image_cat, i}
function artPage_svelte_create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, artPage_svelte_file, -1, 3591);
			attr_dev(path, "d", "M480-360 280-559h400L480-360Z");
			add_location(path, artPage_svelte_file, -1, 3840);
			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
			attr_dev(svg, "height", "48");
			attr_dev(svg, "viewBox", "0 -960 960 960");
			attr_dev(svg, "width", "48");
			...
			add_location(svg, artPage_svelte_file, -1, 3673);
			attr_dev(div1, "class", "title-container svelte-1buuvps");
			add_location(div1, artPage_svelte_file, -1, 3496);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(135:1) {#each image_cats as image_cat, i}",
		ctx
	});
...
class ArtPage extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, artPage_svelte_instance, artPage_svelte_create_fragment, safe_not_equal, { url: 5 }, artPage_svelte_add_css);
...
function aboutPage_svelte_add_css(target) {
	append_styles(target, "svelte-1r0k0h8", ".description.svelte-1r0k0h8.svelte-1r0k0h8{margin-top:3rem;display:flex;flex-direction:column;font-weight:var(--text-font-weight)}.description.svelte-1r0k0h8 a.svelte-1r0k0h8{font-weight:var(--link-font-weight)}.description.svelte-1r0k0h8 .svelte-1r0k0h8{font-weight:var(--text-font-weight);font-size:1rem}main.svelte-1r0k0h8.svelte-1r0k0h8{width:100%;max-width:40rem;min-height:100%;height:fit-content;display:flex;flex-direction:column;max-width:var(--main-max-width)}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function aboutPage_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(brb0, "class", "svelte-1r0k0h8");
			add_location(brb0, aboutPage_svelte_file, -1, 1212);
			attr_dev(brb1, "class", "svelte-1r0k0h8");
			add_location(brb1, aboutPage_svelte_file, -1, 1223);
			attr_dev(brb2, "class", "svelte-1r0k0h8");
			add_location(brb2, aboutPage_svelte_file, -1, 1261);
			attr_dev(brb3, "class", "svelte-1r0k0h8");
			add_location(brb3, aboutPage_svelte_file, -1, 1272);
			attr_dev(a0, "href", "https://twitter.com/wrightwrighter");
			attr_dev(a0, "class", "svelte-1r0k0h8");
			add_location(a0, aboutPage_svelte_file, -1, 1283);
			attr_dev(brb4, "class", "svelte-1r0k0h8");
			add_location(brb4, aboutPage_svelte_file, -1, 1372);
			attr_dev(brb5, "class", "svelte-1r0k0h8");
			add_location(brb5, aboutPage_svelte_file, -1, 1383);
			attr_dev(a1, "href", "https://github.com/wrightwriter");
			attr_dev(a1, "class", "svelte-1r0k0h8");
			add_location(a1, aboutPage_svelte_file, -1, 1394);
			attr_dev(brb6, "class", "svelte-1r0k0h8");
			add_location(brb6, aboutPage_svelte_file, -1, 1477);
			attr_dev(brb7, "class", "svelte-1r0k0h8");
			add_location(brb7, aboutPage_svelte_file, -1, 1488);
			attr_dev(a2, "href", "https://www.shadertoy.com/user/jeyko/sort=newest");
			attr_dev(a2, "class", "svelte-1r0k0h8");
			add_location(a2, aboutPage_svelte_file, -1, 1499);
		...
		m: function mount(target, anchor) {
			...
			append_dev(div4, div3);
			append_dev(div3, t10);
			append_dev(div3, brb0);
			append_dev(div3, t11);
			append_dev(div3, brb1);
			append_dev(div3, t12);
			append_dev(div3, brb2);
			append_dev(div3, t13);
			append_dev(div3, brb3);
			append_dev(div3, t14);
			append_dev(div3, a0);
			append_dev(div3, t16);
			append_dev(div3, brb4);
			append_dev(div3, t17);
			append_dev(div3, brb5);
			append_dev(div3, t18);
			append_dev(div3, a1);
			append_dev(div3, t20);
			append_dev(div3, brb6);
			append_dev(div3, t21);
			append_dev(div3, brb7);
			append_dev(div3, t22);
			append_dev(div3, a2);
			append_dev(main, t24);
			mount_component(footer, main, null);
...
// (122:1) {#if path_name === "/favdemos" || path_name === "/favdemos.html" }
function App_svelte_create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(122:1) {#if path_name === \\\"/favdemos\\\" || path_name === \\\"/favdemos.html\\\" }",
		ctx
	});
