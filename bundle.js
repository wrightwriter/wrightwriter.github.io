...
<span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
    ...
    <span class="token keyword">else</span> <span class="token punctuation">&#123;</span>
		...
		<span class="token keyword">if</span><span class="token punctuation">(</span>particle_depth <span class="token operator">></span> <span class="token number">0.0</span><span class="token punctuation">)</span><span class="token punctuation">&#123;</span>
			...
			<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>part_uv <span class="token operator">+</span> anti_aliasing<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span>
			<span class="token keyword">if</span><span class="token punctuation">(</span>
				<span class="token comment">// Inside bounds</span>
				int_p<span class="token punctuation">.</span>x <span class="token operator">>=</span> <span class="token number">0</span> <span class="token operator">&amp;&amp;</span> int_p<span class="token punctuation">.</span>x <span class="token operator">&lt;</span> <span class="token keyword">int</span><span class="token punctuation">(</span>resolution<span class="token punctuation">.</span>x<span class="token punctuation">)</span> <span class="token operator">&amp;&amp;</span>
				int_p<span class="token punctuation">.</span>y <span class="token operator">>=</span> <span class="token number">0</span> <span class="token operator">&amp;&amp;</span> int_p<span class="token punctuation">.</span>y <span class="token operator">&lt;</span> <span class="token keyword">int</span><span class="token punctuation">(</span>resolution<span class="token punctuation">.</span>y<span class="token punctuation">)</span>
...
<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>uv <span class="token operator">+</span> anti_aliasing <span class="token operator">+</span> dof_sample<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(brb14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 177, 0, 18120);
			attr_dev(pre1, "class", "language-glsl");
			add_location(pre1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 178, 0, 18128);
			attr_dev(a16, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a16, "rel", "nofollow");
			add_location(a16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 179, 7, 18521);
			attr_dev(a17, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a17, "rel", "nofollow");
			add_location(a17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 182, 17, 18664);
			add_location(p8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 179, 0, 18512);
			add_location(brb15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 186, 0, 18760);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 187, 0, 18768);
			attr_dev(a18, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a18, "rel", "nofollow");
			add_location(a18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 189, 26, 19293);
			attr_dev(a19, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a19, "rel", "nofollow");
			add_location(a19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 194, 12, 19567);
			add_location(li10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 189, 0, 19253);
			add_location(li11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 199, 0, 19743);
			add_location(li12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 201, 0, 19961);
			add_location(ul3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 188, 0, 19248);
			attr_dev(a20, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a20, "rel", "nofollow");
			add_location(a20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 204, 19, 20094);
			add_location(p9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 204, 0, 20074);
			add_location(brb16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 208, 0, 20204);
			add_location(strong2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 209, 0, 20216);
			add_location(h22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 209, 0, 20212);
			add_location(brb17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 210, 0, 20254);
			attr_dev(pre3, "class", "language-glsl");
			add_location(pre3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 211, 0, 20262);
			add_location(brb18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 227, 0, 25947);
			add_location(p10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 228, 0, 25955);
			attr_dev(a21, "href", "https://en.wikipedia.org/wiki/Affine_transformation");
			attr_dev(a21, "rel", "nofollow");
			add_location(a21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 229, 25, 26057);
			add_location(p11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 229, 0, 25996);
			attr_dev(a22, "href", "https://en.wikipedia.org/wiki/Inversive_geometry");
			attr_dev(a22, "rel", "nofollow");
			add_location(a22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 233, 3, 26196);
			add_location(code, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 236, 1, 26299);
			attr_dev(a23, "href", "https://en.wikipedia.org/wiki/M%C3%B6bius_transformation");
			attr_dev(a23, "rel", "nofollow");
			add_location(a23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 236, 1, 26348);
			attr_dev(a24, "href", "https://en.wikipedia.org/wiki/Conformal_map");
			attr_dev(a24, "rel", "nofollow");
			add_location(a24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 240, 0, 26542);
			add_location(p12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 233, 0, 26193);
			add_location(brb19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 244, 0, 26676);
			add_location(brb20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 0, 26720);
			attr_dev(a25, "href", "https://github.com/bezo97/IFSRenderer");
			attr_dev(a25, "rel", "nofollow");
			add_location(a25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 247, 0, 26731);
			...
			add_location(a26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 247, 0, 26812);
			add_location(p13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 247, 0, 26728);
			add_location(brb21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 251, 0, 27011);
			add_location(strong3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 4, 27023);
			add_location(h23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 0, 27019);
			attr_dev(a27, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a27, "rel", "nofollow");
			add_location(a27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 253, 39, 27108);
			add_location(p14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 253, 0, 27067);
			add_location(p15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 257, 0, 27334);
			attr_dev(a28, "href", "https://64.github.io/tonemapping/");
			attr_dev(a28, "rel", "nofollow");
			add_location(a28, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 258, 7, 27501);
			add_location(p16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 258, 0, 27379);
			attr_dev(a29, "href", "https://www-old.cs.utah.edu/docs/techreports/2002/pdf/UUCS-02-001.pdf");
			attr_dev(a29, "rel", "nofollow");
			add_location(a29, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 262, 78, 27693);
			add_location(p17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 262, 0, 27593);
			add_location(brb22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 267, 0, 28035);
			attr_dev(pre4, "class", "language-glsl");
			add_location(pre4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 268, 0, 28043);
			add_location(strong4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 292, 1, 32130);
			add_location(h24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 292, 0, 32126);
			attr_dev(a30, "href", "https://www.pouet.net/prod.php?which=82417");
			attr_dev(a30, "rel", "nofollow");
			add_location(a30, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 293, 0, 32170);
			add_location(p18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 293, 0, 32167);
			add_location(brb23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 295, 0, 32424);
			attr_dev(pre5, "class", "language-glsl");
			add_location(pre5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 296, 0, 32432);
			add_location(brb24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 301, 0, 34806);
			add_location(strong5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 302, 4, 34818);
			add_location(h25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 302, 0, 34814);
			attr_dev(a31, "href", "https://www.pouet.net/prod.php?which=82417");
			attr_dev(a31, "rel", "nofollow");
			add_location(a31, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 303, 0, 34868);
			add_location(p19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 303, 0, 34852);
			add_location(brb25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 308, 0, 35186);
			add_location(strong6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 309, 0, 35198);
			add_location(h26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 309, 0, 35194);
			add_location(brb26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 310, 0, 35232);
			add_location(p20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 311, 0, 35240);
			add_location(brb27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 312, 0, 35303);
			add_location(p21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 313, 0, 35311);
			add_location(brb28, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 314, 0, 35352);
			add_location(brb29, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 316, 0, 35417);
			add_location(brb30, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 318, 0, 35482);
			add_location(brb31, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 320, 0, 35548);
			add_location(brb32, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 322, 0, 35614);
			add_location(brb33, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 324, 0, 35679);
			add_location(brb34, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 326, 0, 35784);
			add_location(brb35, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 328, 0, 35890);
			add_location(brb36, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 330, 0, 35995);
			add_location(brb37, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 332, 0, 36100);
			add_location(brb38, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 334, 0, 36205);
			add_location(brb39, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 337, 1, 36310);
...
function NavBar_svelte_add_css(target) {
	append_styles(target, "svelte-1n0yuof", "#bar.svelte-1n0yuof.svelte-1n0yuof{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-1n0yuof #bar-left.svelte-1n0yuof{display:flex;flex-direction:column}#bar.svelte-1n0yuof mark.svelte-1n0yuof{background:var(--accent-dark)}#bar.svelte-1n0yuof .logo.svelte-1n0yuof{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-1n0yuof .logo.logo-behind.svelte-1n0yuof{position:absolute}#bar.svelte-1n0yuof .logo.hovered.svelte-1n0yuof{color:var(--accent-dark) !important}#bar.svelte-1n0yuof .logo.hovered.hover-effect-0.svelte-1n0yuof{animation:svelte-1n0yuof-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-1n0yuof-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-1n0yuof-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-1n0yuof-glitch-anim3{0%{clip:rect(2.8rem, 9999px, 1.5rem, 0);transform-origin:center}2%{clip:rect(4rem, 9999px, 2.5rem, 0);transform-origin:center}4%{clip:rect(1.1rem, 9999px, 3.5rem, 0);transform-origin:center}6%{clip:rect(3.3rem, 9999px, 1rem, 0);transform-origin:center}8%{clip:rect(0.3rem, 9999px, 2rem, 0);transform-origin:center}10%{clip:rect(0.1rem, 9999px, 3rem, 0);transform-origin:center}12%{clip:rect(1rem, 9999px, 4.5rem, 0);transform-origin:center}14%{clip:rect(2.2rem, 9999px, 2rem, 0);transform-origin:center}16%{clip:rect(2.1rem, 9999px, 3.5rem, 0);transform-origin:center}18%{clip:rect(3rem, 9999px, 3rem, 0);transform-origin:center}20%{clip:rect(2.9rem, 9999px, 0.5rem, 0);transform-origin:center}22%{clip:rect(1.4rem, 9999px, 3rem, 0);transform-origin:center}24%{clip:rect(1.2rem, 9999px, 0.5rem, 0);transform-origin:center}26%{clip:rect(0.1rem, 9999px, 1rem, 0);transform-origin:center}28%{clip:rect(3.6rem, 9999px, 1.5rem, 0);transform-origin:center}30%{clip:rect(2.5rem, 9999px, 2rem, 0);transform-origin:center}32%{clip:rect(0.1rem, 9999px, 3rem, 0);transform-origin:center}34%{clip:rect(3.9rem, 9999px, 2.5rem, 0);transform-origin:center}36%{clip:rect(3.8rem, 9999px, 4.5rem, 0);transform-origin:center}38%{clip:rect(1.7rem, 9999px, 1.5rem, 0);transform-origin:center}40%{clip:rect(2.3rem, 9999px, 2rem, 0);transform-origin:center}42%{clip:rect(1.9rem, 9999px, 2rem, 0);transform-origin:center}44%{clip:rect(1.7rem, 9999px, 2rem, 0);transform-origin:center}46%{clip:rect(2.6rem, 9999px, 3.5rem, 0);transform-origin:center}48%{clip:rect(3.7rem, 9999px, 2.5rem, 0);transform-origin:center}50%{clip:rect(0.7rem, 9999px, 3.5rem, 0);transform-origin:center}52%{clip:rect(2.2rem, 9999px, 5rem, 0);transform-origin:center}54%{clip:rect(3.8rem, 9999px, 2rem, 0);transform-origin:center}56%{clip:rect(2rem, 9999px, 1rem, 0);transform-origin:center}58%{clip:rect(1.6rem, 9999px, 2rem, 0);transform-origin:center}60%{clip:rect(0.1rem, 9999px, 3rem, 0);transform-origin:center}62%{clip:rect(1.1rem, 9999px, 4rem, 0);transform-origin:center}64%{clip:rect(1rem, 9999px, 2rem, 0);transform-origin:center}66%{clip:rect(1.6rem, 9999px, 0.5rem, 0);transform-origin:center}68%{clip:rect(2.2rem, 9999px, 0.5rem, 0);transform-origin:center}70%{clip:rect(2.7rem, 9999px, 3rem, 0);transform-origin:center}72%{clip:rect(2.9rem, 9999px, 2.5rem, 0);transform-origin:center}74%{clip:rect(2.5rem, 9999px, 4rem, 0);transform-origin:center}76%{clip:rect(4rem, 9999px, 3rem, 0);transform-origin:center}78%{clip:rect(0.2rem, 9999px, 0.5rem, 0);transform-origin:center}80%{clip:rect(0.4rem, 9999px, 0.5rem, 0);transform-origin:center}82%{clip:rect(1.4rem, 9999px, 4rem, 0);transform-origin:center}84%{clip:rect(3.6rem, 9999px, 2.5rem, 0);transform-origin:center}86%{clip:rect(2.6rem, 9999px, 0.5rem, 0);transform-origin:center}88%{clip:rect(1rem, 9999px, 0.5rem, 0);transform-origin:center}90%{clip:rect(0.9rem, 9999px, 4rem, 0);transform-origin:center}92%{clip:rect(1.6rem, 9999px, 2.5rem, 0);transform-origin:center}94%{clip:rect(2.3rem, 9999px, 3rem, 0);transform-origin:center}96%{clip:rect(2rem, 9999px, 0.5rem, 0);transform-origin:center}98%{clip:rect(2.6rem, 9999px, 2.5rem, 0);transform-origin:center}}@keyframes svelte-1n0yuof-cooool{0%{color:pink !important}2%{color:pink !important}4%{color:pink !important}6%{color:pink !important}8%{color:pink !important}10%{color:pink !important}12%{color:pink !important}14%{color:pink !important}16%{color:pink !important}18%{color:pink !important}20%{color:pink !important}22%{color:pink !important}24%{color:pink !important}26%{color:pink !important}28%{color:pink !important}30%{color:pink !important}32%{color:pink !important}34%{color:pink !important}36%{color:pink !important}38%{color:pink !important}40%{color:pink !important}42%{color:pink !important}44%{color:pink !important}46%{color:pink !important}48%{color:pink !important}50%{color:pink !important}52%{color:pink !important}54%{color:pink !important}56%{color:pink !important}58%{color:pink !important}60%{color:pink !important}62%{color:pink !important}64%{color:pink !important}66%{color:pink !important}68%{color:pink !important}70%{color:pink !important}72%{color:pink !important}74%{color:pink !important}76%{color:pink !important}78%{color:pink !important}80%{color:pink !important}82%{color:pink !important}84%{color:pink !important}86%{color:pink !important}88%{color:pink !important}90%{color:pink !important}92%{color:pink !important}94%{color:pink !important}96%{color:pink !important}98%{color:pink !important}}#bar.svelte-1n0yuof .logo.hovered.hover-effect-0.logo-behind-a.svelte-1n0yuof{color:#ff5500 !important;animation:svelte-1n0yuof-distort1 300ms linear infinite, svelte-1n0yuof-glitch-anim3 5s infinite linear alternate-reverse, svelte-1n0yuof-cooool 5s infinite linear alternate-reverse}#bar.svelte-1n0yuof .logo.hovered.hover-effect-0.logo-behind-b.svelte-1n0yuof{color:#450f8b !important;animation:svelte-1n0yuof-distort2 300ms linear infinite, svelte-1n0yuof-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-1n0yuof .logo.hover-effect-1.svelte-1n0yuof{animation:svelte-1n0yuof-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-1n0yuof-glitch-anim{0%{clip:rect(2.4rem, 9999px, 4.5rem, 0);transform:skew(8.4deg);z-index:1}2%{clip:rect(2.8rem, 9999px, 1.5rem, 0);transform:skew(7.8deg);z-index:3}4%{clip:rect(1.5rem, 9999px, 2rem, 0);transform:skew(6.2deg);z-index:1}6%{clip:rect(3.1rem, 9999px, 4rem, 0);transform:skew(2.3deg);z-index:3}8%{clip:rect(2.5rem, 9999px, 3rem, 0);transform:skew(8.5deg);z-index:2}10%{clip:rect(0.2rem, 9999px, 0.5rem, 0);transform:skew(9.2deg);z-index:3}12%{clip:rect(2.5rem, 9999px, 2.5rem, 0);transform:skew(8deg);z-index:3}14%{clip:rect(3rem, 9999px, 3rem, 0);transform:skew(0.9deg);z-index:4}16%{clip:rect(2.7rem, 9999px, 2.5rem, 0);transform:skew(0.9deg);z-index:2}18%{clip:rect(1.6rem, 9999px, 2rem, 0);transform:skew(8.7deg);z-index:4}20%{clip:rect(1.5rem, 9999px, 2.5rem, 0);transform:skew(8.3deg);z-index:1}22%{clip:rect(2.6rem, 9999px, 2.5rem, 0);transform:skew(6.1deg);z-index:4}24%{clip:rect(3rem, 9999px, 2.5rem, 0);transform:skew(9.8deg);z-index:2}26%{clip:rect(2.5rem, 9999px, 3.5rem, 0);transform:skew(3.4deg);z-index:2}28%{clip:rect(0.5rem, 9999px, 4rem, 0);transform:skew(9.3deg);z-index:3}30%{clip:rect(2.3rem, 9999px, 4rem, 0);transform:skew(5.3deg);z-index:2}32%{clip:rect(3.2rem, 9999px, 2.5rem, 0);transform:skew(2.5deg);z-index:1}34%{clip:rect(2.8rem, 9999px, 3rem, 0);transform:skew(4.9deg);z-index:1}36%{clip:rect(2.7rem, 9999px, 1.5rem, 0);transform:skew(3.4deg);z-index:1}38%{clip:rect(1.1rem, 9999px, 2.5rem, 0);transform:skew(6.1deg);z-index:2}40%{clip:rect(0.5rem, 9999px, 3.5rem, 0);transform:skew(4.6deg);z-index:2}42%{clip:rect(3.9rem, 9999px, 2rem, 0);transform:skew(5.2deg);z-index:4}44%{clip:rect(1.9rem, 9999px, 2rem, 0);transform:skew(10deg);z-index:3}46%{clip:rect(3.2rem, 9999px, 3.5rem, 0);transform:skew(1deg);z-index:3}48%{clip:rect(2.2rem, 9999px, 4.5rem, 0);transform:skew(5.1deg);z-index:3}50%{clip:rect(0.1rem, 9999px, 1.5rem, 0);transform:skew(6.2deg);z-index:1}52%{clip:rect(3.2rem, 9999px, 1rem, 0);transform:skew(8.3deg);z-index:1}54%{clip:rect(2rem, 9999px, 1.5rem, 0);transform:skew(1.8deg);z-index:2}56%{clip:rect(3.2rem, 9999px, 1.5rem, 0);transform:skew(2.5deg);z-index:3}58%{clip:rect(3.4rem, 9999px, 2.5rem, 0);transform:skew(3deg);z-index:4}60%{clip:rect(3.7rem, 9999px, 0.5rem, 0);transform:skew(4.2deg);z-index:4}62%{clip:rect(2.6rem, 9999px, 3.5rem, 0);transform:skew(3.3deg);z-index:4}64%{clip:rect(2.6rem, 9999px, 3rem, 0);transform:skew(9.8deg);z-index:2}66%{clip:rect(0.9rem, 9999px, 0.5rem, 0);transform:skew(7.8deg);z-index:4}68%{clip:rect(0.1rem, 9999px, 1.5rem, 0);transform:skew(5deg);z-index:4}70%{clip:rect(2.5rem, 9999px, 2.5rem, 0);transform:skew(6deg);z-index:3}72%{clip:rect(3.9rem, 9999px, 3rem, 0);transform:skew(7.8deg);z-index:2}74%{clip:rect(1.3rem, 9999px, 0.5rem, 0);transform:skew(9deg);z-index:3}76%{clip:rect(2.1rem, 9999px, 3rem, 0);transform:skew(2deg);z-index:1}78%{clip:rect(3.1rem, 9999px, 3.5rem, 0);transform:skew(5.5deg);z-index:4}80%{clip:rect(0.9rem, 9999px, 2rem, 0);transform:skew(1.4deg);z-index:2}82%{clip:rect(2.3rem, 9999px, 4.5rem, 0);transform:skew(3.1deg);z-index:2}84%{clip:rect(0.3rem, 9999px, 5rem, 0);transform:skew(7.8deg);z-index:1}86%{clip:rect(0.1rem, 9999px, 1rem, 0);transform:skew(2.9deg);z-index:1}88%{clip:rect(3.7rem, 9999px, 1.5rem, 0);transform:skew(7.8deg);z-index:3}90%{clip:rect(3.5rem, 9999px, 1.5rem, 0);transform:skew(3.2deg);z-index:1}92%{clip:rect(2rem, 9999px, 4.5rem, 0);transform:skew(1deg);z-index:4}94%{clip:rect(3rem, 9999px, 1.5rem, 0);transform:skew(7.9deg);z-index:4}96%{clip:rect(2.5rem, 9999px, 3.5rem, 0);transform:skew(2.7deg);z-index:4}98%{clip:rect(3.9rem, 9999px, 4.5rem, 0);transform:skew(4.8deg);z-index:1}}@keyframes svelte-1n0yuof-glitch-anim2{0%{clip:rect(0.08rem, 99999px, 0.7rem, 0)}0.6666666667%{clip:rect(0.06rem, 99999px, 4.3rem, 0)}1.3333333333%{clip:rect(0.08rem, 99999px, 3.7rem, 0)}2%{clip:rect(0.12rem, 99999px, 8.5rem, 0)}2.6666666667%{clip:rect(0.02rem, 99999px, 3.3rem, 0)}3.3333333333%{clip:rect(0.02rem, 99999px, 8.9rem, 0)}4%{clip:rect(0.16rem, 99999px, 0.9rem, 0)}4.6666666667%{clip:rect(0.02rem, 99999px, 8.8rem, 0)}5.3333333333%{clip:rect(0.14rem, 99999px, 9.6rem, 0)}6%{clip:rect(0.18rem, 99999px, 3.1rem, 0)}6.6666666667%{clip:rect(0.1rem, 99999px, 1.3rem, 0)}7.3333333333%{clip:rect(0.12rem, 99999px, 3.9rem, 0)}8%{clip:rect(0.08rem, 99999px, 1.3rem, 0)}8.6666666667%{clip:rect(0.06rem, 99999px, 7.9rem, 0)}9.3333333333%{clip:rect(0.02rem, 99999px, 10rem, 0)}10%{clip:rect(0.06rem, 99999px, 3.7rem, 0)}10.6666666667%{clip:rect(0.18rem, 99999px, 5.6rem, 0)}11.3333333333%{clip:rect(0.2rem, 99999px, 1rem, 0)}12%{clip:rect(0.08rem, 99999px, 2rem, 0)}12.6666666667%{clip:rect(0.12rem, 99999px, 1.2rem, 0)}13.3333333333%{clip:rect(0.18rem, 99999px, 4.9rem, 0)}14%{clip:rect(0.06rem, 99999px, 3.6rem, 0)}14.6666666667%{clip:rect(0.18rem, 99999px, 9.8rem, 0)}15.3333333333%{clip:rect(0.08rem, 99999px, 9.1rem, 0)}16%{clip:rect(0.18rem, 99999px, 7.3rem, 0)}16.6666666667%{clip:rect(0.02rem, 99999px, 2.7rem, 0)}17.3333333333%{clip:rect(0.2rem, 99999px, 6.4rem, 0)}18%{clip:rect(0.06rem, 99999px, 7.2rem, 0)}18.6666666667%{clip:rect(0.02rem, 99999px, 3rem, 0)}19.3333333333%{clip:rect(0.08rem, 99999px, 3.3rem, 0)}20%{clip:rect(0.16rem, 99999px, 8.1rem, 0)}20.6666666667%{clip:rect(0.02rem, 99999px, 2.9rem, 0)}21.3333333333%{clip:rect(0.12rem, 99999px, 9.5rem, 0)}22%{clip:rect(0.16rem, 99999px, 9.7rem, 0)}22.6666666667%{clip:rect(0.14rem, 99999px, 1.2rem, 0)}23.3333333333%{clip:rect(0.06rem, 99999px, 6.5rem, 0)}24%{clip:rect(0.18rem, 99999px, 1rem, 0)}24.6666666667%{clip:rect(0.04rem, 99999px, 8.3rem, 0)}25.3333333333%{clip:rect(0.16rem, 99999px, 5.4rem, 0)}26%{clip:rect(0.16rem, 99999px, 1.4rem, 0)}26.6666666667%{clip:rect(0.18rem, 99999px, 6.8rem, 0)}27.3333333333%{clip:rect(0.16rem, 99999px, 8.7rem, 0)}28%{clip:rect(0.08rem, 99999px, 9.4rem, 0)}28.6666666667%{clip:rect(0.1rem, 99999px, 8.7rem, 0)}29.3333333333%{clip:rect(0.12rem, 99999px, 4.6rem, 0)}30%{clip:rect(0.04rem, 99999px, 5.9rem, 0)}30.6666666667%{clip:rect(0.06rem, 99999px, 6.1rem, 0)}31.3333333333%{clip:rect(0.02rem, 99999px, 6.4rem, 0)}32%{clip:rect(0.16rem, 99999px, 8.9rem, 0)}32.6666666667%{clip:rect(0.14rem, 99999px, 1.7rem, 0)}33.3333333333%{clip:rect(0.18rem, 99999px, 0.4rem, 0)}34%{clip:rect(0.04rem, 99999px, 1.8rem, 0)}34.6666666667%{clip:rect(0.18rem, 99999px, 3.2rem, 0)}35.3333333333%{clip:rect(0.2rem, 99999px, 0.1rem, 0)}36%{clip:rect(0.14rem, 99999px, 8rem, 0)}36.6666666667%{clip:rect(0.18rem, 99999px, 4.8rem, 0)}37.3333333333%{clip:rect(0.2rem, 99999px, 1.1rem, 0)}38%{clip:rect(0.1rem, 99999px, 7.6rem, 0)}38.6666666667%{clip:rect(0.02rem, 99999px, 4.6rem, 0)}39.3333333333%{clip:rect(0.06rem, 99999px, 2.8rem, 0)}40%{clip:rect(0.02rem, 99999px, 4.9rem, 0)}40.6666666667%{clip:rect(0.06rem, 99999px, 7.7rem, 0)}41.3333333333%{clip:rect(0.08rem, 99999px, 9.1rem, 0)}42%{clip:rect(0.2rem, 99999px, 8.7rem, 0)}42.6666666667%{clip:rect(0.18rem, 99999px, 5.6rem, 0)}43.3333333333%{clip:rect(0.18rem, 99999px, 0.4rem, 0)}44%{clip:rect(0.04rem, 99999px, 5.6rem, 0)}44.6666666667%{clip:rect(0.1rem, 99999px, 2.5rem, 0)}45.3333333333%{clip:rect(0.08rem, 99999px, 0.8rem, 0)}46%{clip:rect(0.06rem, 99999px, 6.9rem, 0)}46.6666666667%{clip:rect(0.1rem, 99999px, 7.7rem, 0)}47.3333333333%{clip:rect(0.14rem, 99999px, 2.4rem, 0)}48%{clip:rect(0.1rem, 99999px, 6rem, 0)}48.6666666667%{clip:rect(0.18rem, 99999px, 4.9rem, 0)}49.3333333333%{clip:rect(0.06rem, 99999px, 3.1rem, 0)}50%{clip:rect(0.02rem, 99999px, 9.5rem, 0)}50.6666666667%{clip:rect(0.1rem, 99999px, 1.3rem, 0)}51.3333333333%{clip:rect(0.06rem, 99999px, 8.5rem, 0)}52%{clip:rect(0.06rem, 99999px, 1.7rem, 0)}52.6666666667%{clip:rect(0.08rem, 99999px, 0.1rem, 0)}53.3333333333%{clip:rect(0.14rem, 99999px, 0.5rem, 0)}54%{clip:rect(0.02rem, 99999px, 4.2rem, 0)}54.6666666667%{clip:rect(0.06rem, 99999px, 2rem, 0)}55.3333333333%{clip:rect(0.04rem, 99999px, 5.8rem, 0)}56%{clip:rect(0.2rem, 99999px, 1.9rem, 0)}56.6666666667%{clip:rect(0.12rem, 99999px, 0.4rem, 0)}57.3333333333%{clip:rect(0.08rem, 99999px, 6.7rem, 0)}58%{clip:rect(0.06rem, 99999px, 7.5rem, 0)}58.6666666667%{clip:rect(0.1rem, 99999px, 6.7rem, 0)}59.3333333333%{clip:rect(0.2rem, 99999px, 8.5rem, 0)}60%{clip:rect(0.18rem, 99999px, 6.4rem, 0)}60.6666666667%{clip:rect(0.18rem, 99999px, 4.7rem, 0)}61.3333333333%{clip:rect(0.18rem, 99999px, 5.1rem, 0)}62%{clip:rect(0.06rem, 99999px, 0.7rem, 0)}62.6666666667%{clip:rect(0.2rem, 99999px, 2.6rem, 0)}63.3333333333%{clip:rect(0.08rem, 99999px, 7.4rem, 0)}64%{clip:rect(0.1rem, 99999px, 3.9rem, 0)}64.6666666667%{clip:rect(0.04rem, 99999px, 5rem, 0)}65.3333333333%{clip:rect(0.18rem, 99999px, 2.8rem, 0)}66%{clip:rect(0.02rem, 99999px, 6.6rem, 0)}66.6666666667%{clip:rect(0.14rem, 99999px, 3.3rem, 0)}67.3333333333%{clip:rect(0.14rem, 99999px, 2.6rem, 0)}68%{clip:rect(0.16rem, 99999px, 7.2rem, 0)}68.6666666667%{clip:rect(0.02rem, 99999px, 9.2rem, 0)}69.3333333333%{clip:rect(0.16rem, 99999px, 1.2rem, 0)}70%{clip:rect(0.06rem, 99999px, 9.3rem, 0)}70.6666666667%{clip:rect(0.06rem, 99999px, 8.1rem, 0)}71.3333333333%{clip:rect(0.1rem, 99999px, 0.7rem, 0)}72%{clip:rect(0.02rem, 99999px, 2rem, 0)}72.6666666667%{clip:rect(0.08rem, 99999px, 8.3rem, 0)}73.3333333333%{clip:rect(0.12rem, 99999px, 1.6rem, 0)}74%{clip:rect(0.04rem, 99999px, 8.5rem, 0)}74.6666666667%{clip:rect(0.16rem, 99999px, 7.4rem, 0)}75.3333333333%{clip:rect(0.1rem, 99999px, 2.7rem, 0)}76%{clip:rect(0.14rem, 99999px, 0.9rem, 0)}76.6666666667%{clip:rect(0.18rem, 99999px, 3.5rem, 0)}77.3333333333%{clip:rect(0.1rem, 99999px, 4.8rem, 0)}78%{clip:rect(0.2rem, 99999px, 2.4rem, 0)}78.6666666667%{clip:rect(0.04rem, 99999px, 6.3rem, 0)}79.3333333333%{clip:rect(0.1rem, 99999px, 5.8rem, 0)}80%{clip:rect(0.12rem, 99999px, 8rem, 0)}80.6666666667%{clip:rect(0.08rem, 99999px, 3.3rem, 0)}81.3333333333%{clip:rect(0.16rem, 99999px, 7.8rem, 0)}82%{clip:rect(0.14rem, 99999px, 5.1rem, 0)}82.6666666667%{clip:rect(0.14rem, 99999px, 5rem, 0)}83.3333333333%{clip:rect(0.04rem, 99999px, 9.7rem, 0)}84%{clip:rect(0.2rem, 99999px, 3.2rem, 0)}84.6666666667%{clip:rect(0.06rem, 99999px, 5.5rem, 0)}85.3333333333%{clip:rect(0.2rem, 99999px, 9.8rem, 0)}86%{clip:rect(0.18rem, 99999px, 8.4rem, 0)}86.6666666667%{clip:rect(0.08rem, 99999px, 3.6rem, 0)}87.3333333333%{clip:rect(0.2rem, 99999px, 0.5rem, 0)}88%{clip:rect(0.16rem, 99999px, 0.8rem, 0)}88.6666666667%{clip:rect(0.08rem, 99999px, 5.6rem, 0)}89.3333333333%{clip:rect(0.16rem, 99999px, 5.6rem, 0)}90%{clip:rect(0.06rem, 99999px, 9rem, 0)}90.6666666667%{clip:rect(0.12rem, 99999px, 8rem, 0)}91.3333333333%{clip:rect(0.08rem, 99999px, 1.4rem, 0)}92%{clip:rect(0.04rem, 99999px, 5.3rem, 0)}92.6666666667%{clip:rect(0.2rem, 99999px, 7.5rem, 0)}93.3333333333%{clip:rect(0.02rem, 99999px, 0.9rem, 0)}94%{clip:rect(0.04rem, 99999px, 7.5rem, 0)}94.6666666667%{clip:rect(0.16rem, 99999px, 5.8rem, 0)}95.3333333333%{clip:rect(0.1rem, 99999px, 8.1rem, 0)}96%{clip:rect(0.06rem, 99999px, 9.6rem, 0)}96.6666666667%{clip:rect(0.18rem, 99999px, 0.7rem, 0)}97.3333333333%{clip:rect(0.1rem, 99999px, 1.3rem, 0)}98%{clip:rect(0.14rem, 99999px, 1.7rem, 0)}98.6666666667%{clip:rect(0.02rem, 99999px, 1.1rem, 0)}99.3333333333%{clip:rect(0.2rem, 99999px, 7.4rem, 0)}}@keyframes svelte-1n0yuof-glitch-skew{0%{transform:skew(3deg)}10%{transform:skew(0deg)}20%{transform:skew(0deg)}30%{transform:skew(-1deg)}40%{transform:skew(-4deg)}50%{transform:skew(5deg)}60%{transform:skew(1deg)}70%{transform:skew(3deg)}80%{transform:skew(4deg)}90%{transform:skew(0deg)}}#bar.svelte-1n0yuof .logo.hover-effect-1.logo-behind-a.svelte-1n0yuof{color:var(--accent-light);transform:translateX(-0.5rem);color:#ff5500 !important;text-shadow:-2px 0 #ff5500, 2px 2px #ff5500;clip:rect(44px, 450px, 56px, 0);animation:svelte-1n0yuof-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-1n0yuof .logo.hover-effect-1.logo-behind-b.svelte-1n0yuof{color:#bfcc2e !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #450f8b;clip:rect(44px, 450px, 56px, 0);animation:svelte-1n0yuof-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-1n0yuof .logo.logo-behind.svelte-1n0yuof{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-1n0yuof .logo.logo-behind.svelte-1n0yuof:not(.hovered){display:none}#bar.svelte-1n0yuof #bar-right.svelte-1n0yuof{margin-left:auto;display:flex;margin-right:1rem;margin-top:1rem;position:relative}#bar.svelte-1n0yuof #bar-right #menus.svelte-1n0yuof{display:flex}#bar.svelte-1n0yuof #bar-right #menus #menu.svelte-1n0yuof{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-1n0yuof #bar-right #menus #menu.svelte-1n0yuof .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function NavBar_svelte_create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			style = dom_element("style");
			style.innerHTML = ``;
			add_location(style, NavBar_svelte_file, -1, 25987);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(style, NavBar_svelte_file, -1, 25870);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function NavBar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-1n0yuof");
			add_location(mark, NavBar_svelte_file, -1, 26220);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-1n0yuof");
			add_location(a0, NavBar_svelte_file, -1, 26148);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-1n0yuof");
			add_location(a1, NavBar_svelte_file, -1, 26263);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-1n0yuof");
			add_location(a2, NavBar_svelte_file, -1, 26355);
			attr_dev(div0, "id", "logo-container");
			add_location(div0, NavBar_svelte_file, -1, 26119);
			attr_dev(div1, "id", "bar-left");
			attr_dev(div1, "class", "svelte-1n0yuof");
			add_location(div1, NavBar_svelte_file, -1, 26072);
			attr_dev(div2, "id", "menu");
			attr_dev(div2, "class", "svelte-1n0yuof");
			add_location(div2, NavBar_svelte_file, -1, 26657);
			attr_dev(div3, "id", "menu");
			attr_dev(div3, "class", "svelte-1n0yuof");
			add_location(div3, NavBar_svelte_file, -1, 26958);
			attr_dev(div4, "id", "menus");
			attr_dev(div4, "class", "svelte-1n0yuof");
			add_location(div4, NavBar_svelte_file, -1, 26611);
			attr_dev(div5, "id", "bar-right");
			attr_dev(div5, "class", "svelte-1n0yuof");
			add_location(div5, NavBar_svelte_file, -1, 26512);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-1n0yuof");
			add_location(nav, NavBar_svelte_file, -1, 26029);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*hovered_class*/ 64 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-1n0yuof")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-1n0yuof")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-1n0yuof")) {
...
// (162:2) {#each list[year] as demo, i}
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, favdemosPage_svelte_file, 194, 1, 7930);
			attr_dev(a, "href", a_href_value = /*demo*/ ctx[12].link);
			attr_dev(a, "target", "”_blank”");
			attr_dev(a, "class", "demo svelte-1njzqxq");
			add_location(a, favdemosPage_svelte_file, 193, 0, 7804);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a, anchor);
			append_dev(a, div);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(162:2) {#each list[year] as demo, i}",
		ctx
	});
...
// (158:1) {#each Object.keys(list).reverse() as year, i}
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, favdemosPage_svelte_file, -1, 7731);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			insert_dev(target, t1, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(158:1) {#each Object.keys(list).reverse() as year, i}",
		ctx
	});
...
function favdemosPage_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, favdemosPage_svelte_file, -1, 7667);
		...
		`);
			...
			add_location(img, favdemosPage_svelte_file, -1, 8215);
			attr_dev(main, "class", "svelte-1njzqxq");
			add_location(main, favdemosPage_svelte_file, 180, 1, 7650);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
