...
function Bar_svelte_add_css(target) {
	append_styles(target, "svelte-15phqsh", "#bar.svelte-15phqsh.svelte-15phqsh{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-15phqsh mark.svelte-15phqsh{background:black}#bar.svelte-15phqsh .logo.svelte-15phqsh{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-15phqsh .logo.logo-behind.svelte-15phqsh{position:absolute}#bar.svelte-15phqsh .logo.hovered.svelte-15phqsh{color:black !important}#bar.svelte-15phqsh .logo.hovered.hover-effect-0.svelte-15phqsh{animation:svelte-15phqsh-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-15phqsh-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-15phqsh-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-15phqsh-glitch-anim3{0%{clip:rect(3.5rem, 9999px, 3.5rem, 0);transform-origin:center}2%{clip:rect(3.1rem, 9999px, 3rem, 0);transform-origin:center}4%{clip:rect(3.4rem, 9999px, 4.5rem, 0);transform-origin:center}6%{clip:rect(1rem, 9999px, 2.5rem, 0);transform-origin:center}8%{clip:rect(3rem, 9999px, 3.5rem, 0);transform-origin:center}10%{clip:rect(2.1rem, 9999px, 3rem, 0);transform-origin:center}12%{clip:rect(3rem, 9999px, 3rem, 0);transform-origin:center}14%{clip:rect(2.4rem, 9999px, 0.5rem, 0);transform-origin:center}16%{clip:rect(2.5rem, 9999px, 4rem, 0);transform-origin:center}18%{clip:rect(3.8rem, 9999px, 1rem, 0);transform-origin:center}20%{clip:rect(0.7rem, 9999px, 4rem, 0);transform-origin:center}22%{clip:rect(0.2rem, 9999px, 2.5rem, 0);transform-origin:center}24%{clip:rect(1.7rem, 9999px, 4.5rem, 0);transform-origin:center}26%{clip:rect(3.1rem, 9999px, 4.5rem, 0);transform-origin:center}28%{clip:rect(0.3rem, 9999px, 5rem, 0);transform-origin:center}30%{clip:rect(2.4rem, 9999px, 4.5rem, 0);transform-origin:center}32%{clip:rect(2.3rem, 9999px, 3rem, 0);transform-origin:center}34%{clip:rect(2rem, 9999px, 3.5rem, 0);transform-origin:center}36%{clip:rect(4rem, 9999px, 3rem, 0);transform-origin:center}38%{clip:rect(0.4rem, 9999px, 2.5rem, 0);transform-origin:center}40%{clip:rect(3.7rem, 9999px, 2.5rem, 0);transform-origin:center}42%{clip:rect(0.1rem, 9999px, 0.5rem, 0);transform-origin:center}44%{clip:rect(2.7rem, 9999px, 5rem, 0);transform-origin:center}46%{clip:rect(4rem, 9999px, 5rem, 0);transform-origin:center}48%{clip:rect(3.8rem, 9999px, 3rem, 0);transform-origin:center}50%{clip:rect(0.6rem, 9999px, 2rem, 0);transform-origin:center}52%{clip:rect(0.4rem, 9999px, 2rem, 0);transform-origin:center}54%{clip:rect(1.4rem, 9999px, 4rem, 0);transform-origin:center}56%{clip:rect(1rem, 9999px, 2.5rem, 0);transform-origin:center}58%{clip:rect(1.3rem, 9999px, 5rem, 0);transform-origin:center}60%{clip:rect(1.2rem, 9999px, 2rem, 0);transform-origin:center}62%{clip:rect(1.9rem, 9999px, 3.5rem, 0);transform-origin:center}64%{clip:rect(4rem, 9999px, 2rem, 0);transform-origin:center}66%{clip:rect(3.8rem, 9999px, 3.5rem, 0);transform-origin:center}68%{clip:rect(3.7rem, 9999px, 3.5rem, 0);transform-origin:center}70%{clip:rect(3.2rem, 9999px, 0.5rem, 0);transform-origin:center}72%{clip:rect(0.5rem, 9999px, 2rem, 0);transform-origin:center}74%{clip:rect(2rem, 9999px, 3.5rem, 0);transform-origin:center}76%{clip:rect(2.2rem, 9999px, 4.5rem, 0);transform-origin:center}78%{clip:rect(1.5rem, 9999px, 4.5rem, 0);transform-origin:center}80%{clip:rect(3.8rem, 9999px, 3.5rem, 0);transform-origin:center}82%{clip:rect(2.3rem, 9999px, 2.5rem, 0);transform-origin:center}84%{clip:rect(0.1rem, 9999px, 5rem, 0);transform-origin:center}86%{clip:rect(1.8rem, 9999px, 0.5rem, 0);transform-origin:center}88%{clip:rect(1.2rem, 9999px, 5rem, 0);transform-origin:center}90%{clip:rect(1.5rem, 9999px, 4rem, 0);transform-origin:center}92%{clip:rect(1.3rem, 9999px, 4.5rem, 0);transform-origin:center}94%{clip:rect(1.8rem, 9999px, 3.5rem, 0);transform-origin:center}96%{clip:rect(1.8rem, 9999px, 4.5rem, 0);transform-origin:center}98%{clip:rect(0.3rem, 9999px, 2.5rem, 0);transform-origin:center}}@keyframes svelte-15phqsh-cooool{0%{color:red !important}2%{color:red !important}4%{color:red !important}6%{color:red !important}8%{color:red !important}10%{color:red !important}12%{color:red !important}14%{color:red !important}16%{color:red !important}18%{color:red !important}20%{color:red !important}22%{color:red !important}24%{color:red !important}26%{color:red !important}28%{color:red !important}30%{color:red !important}32%{color:red !important}34%{color:red !important}36%{color:red !important}38%{color:red !important}40%{color:red !important}42%{color:red !important}44%{color:red !important}46%{color:red !important}48%{color:red !important}50%{color:red !important}52%{color:red !important}54%{color:red !important}56%{color:red !important}58%{color:red !important}60%{color:red !important}62%{color:red !important}64%{color:red !important}66%{color:red !important}68%{color:red !important}70%{color:red !important}72%{color:red !important}74%{color:red !important}76%{color:red !important}78%{color:red !important}80%{color:red !important}82%{color:red !important}84%{color:red !important}86%{color:red !important}88%{color:red !important}90%{color:red !important}92%{color:red !important}94%{color:red !important}96%{color:red !important}98%{color:red !important}}#bar.svelte-15phqsh .logo.hovered.hover-effect-0.logo-behind-a.svelte-15phqsh{color:#ffc800 !important;animation:svelte-15phqsh-distort1 300ms linear infinite, svelte-15phqsh-glitch-anim3 5s infinite linear alternate-reverse, svelte-15phqsh-cooool 5s infinite linear alternate-reverse}#bar.svelte-15phqsh .logo.hovered.hover-effect-0.logo-behind-b.svelte-15phqsh{color:#aa10f2 !important;animation:svelte-15phqsh-distort2 300ms linear infinite, svelte-15phqsh-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-15phqsh .logo.hover-effect-1.svelte-15phqsh{animation:svelte-15phqsh-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-15phqsh-glitch-anim{0%{clip:rect(1.2rem, 9999px, 4rem, 0);transform:skew(6.5deg);z-index:1}2%{clip:rect(2.9rem, 9999px, 1.5rem, 0);transform:skew(2.5deg);z-index:2}4%{clip:rect(0.1rem, 9999px, 5rem, 0);transform:skew(1.1deg);z-index:4}6%{clip:rect(1.5rem, 9999px, 1rem, 0);transform:skew(0.4deg);z-index:3}8%{clip:rect(2.1rem, 9999px, 2.5rem, 0);transform:skew(4.7deg);z-index:3}10%{clip:rect(3.9rem, 9999px, 0.5rem, 0);transform:skew(5.7deg);z-index:1}12%{clip:rect(0.4rem, 9999px, 3rem, 0);transform:skew(1.8deg);z-index:3}14%{clip:rect(3.3rem, 9999px, 3rem, 0);transform:skew(8.6deg);z-index:1}16%{clip:rect(3.4rem, 9999px, 5rem, 0);transform:skew(1.9deg);z-index:2}18%{clip:rect(1.2rem, 9999px, 0.5rem, 0);transform:skew(4.8deg);z-index:3}20%{clip:rect(2.3rem, 9999px, 1rem, 0);transform:skew(7.3deg);z-index:1}22%{clip:rect(1.8rem, 9999px, 1.5rem, 0);transform:skew(2.4deg);z-index:1}24%{clip:rect(0.3rem, 9999px, 4.5rem, 0);transform:skew(2.1deg);z-index:4}26%{clip:rect(2.6rem, 9999px, 2.5rem, 0);transform:skew(8.5deg);z-index:4}28%{clip:rect(0.9rem, 9999px, 4.5rem, 0);transform:skew(2.4deg);z-index:3}30%{clip:rect(0.6rem, 9999px, 3rem, 0);transform:skew(4.1deg);z-index:2}32%{clip:rect(2.5rem, 9999px, 4.5rem, 0);transform:skew(5.8deg);z-index:2}34%{clip:rect(4rem, 9999px, 4rem, 0);transform:skew(5.5deg);z-index:4}36%{clip:rect(2.3rem, 9999px, 3.5rem, 0);transform:skew(5.6deg);z-index:1}38%{clip:rect(0.3rem, 9999px, 3.5rem, 0);transform:skew(9.8deg);z-index:2}40%{clip:rect(2.7rem, 9999px, 5rem, 0);transform:skew(5.7deg);z-index:4}42%{clip:rect(2.6rem, 9999px, 5rem, 0);transform:skew(2.1deg);z-index:4}44%{clip:rect(3.5rem, 9999px, 2rem, 0);transform:skew(9.5deg);z-index:4}46%{clip:rect(0.2rem, 9999px, 2rem, 0);transform:skew(5.2deg);z-index:2}48%{clip:rect(2.9rem, 9999px, 2.5rem, 0);transform:skew(9.4deg);z-index:2}50%{clip:rect(1.4rem, 9999px, 4rem, 0);transform:skew(7.3deg);z-index:2}52%{clip:rect(0.3rem, 9999px, 2.5rem, 0);transform:skew(3.7deg);z-index:2}54%{clip:rect(2.5rem, 9999px, 3.5rem, 0);transform:skew(0.5deg);z-index:2}56%{clip:rect(3.1rem, 9999px, 0.5rem, 0);transform:skew(0.4deg);z-index:2}58%{clip:rect(0.4rem, 9999px, 1.5rem, 0);transform:skew(6deg);z-index:4}60%{clip:rect(1.1rem, 9999px, 1rem, 0);transform:skew(6.9deg);z-index:3}62%{clip:rect(3.4rem, 9999px, 4rem, 0);transform:skew(6.3deg);z-index:2}64%{clip:rect(1.5rem, 9999px, 3.5rem, 0);transform:skew(4.8deg);z-index:1}66%{clip:rect(0.9rem, 9999px, 1.5rem, 0);transform:skew(6.4deg);z-index:2}68%{clip:rect(3.1rem, 9999px, 4rem, 0);transform:skew(7.4deg);z-index:1}70%{clip:rect(2.6rem, 9999px, 4.5rem, 0);transform:skew(3.3deg);z-index:4}72%{clip:rect(3.7rem, 9999px, 5rem, 0);transform:skew(6.5deg);z-index:3}74%{clip:rect(2.6rem, 9999px, 0.5rem, 0);transform:skew(7.7deg);z-index:1}76%{clip:rect(3.7rem, 9999px, 0.5rem, 0);transform:skew(4.1deg);z-index:2}78%{clip:rect(2.5rem, 9999px, 3.5rem, 0);transform:skew(9.9deg);z-index:2}80%{clip:rect(3.4rem, 9999px, 2rem, 0);transform:skew(1.4deg);z-index:3}82%{clip:rect(0.5rem, 9999px, 4rem, 0);transform:skew(3.5deg);z-index:2}84%{clip:rect(2.9rem, 9999px, 2rem, 0);transform:skew(9.1deg);z-index:1}86%{clip:rect(1.6rem, 9999px, 3.5rem, 0);transform:skew(4.4deg);z-index:3}88%{clip:rect(2.4rem, 9999px, 1rem, 0);transform:skew(8.8deg);z-index:1}90%{clip:rect(0.4rem, 9999px, 2.5rem, 0);transform:skew(6.7deg);z-index:1}92%{clip:rect(2.5rem, 9999px, 0.5rem, 0);transform:skew(1.6deg);z-index:2}94%{clip:rect(2.5rem, 9999px, 1.5rem, 0);transform:skew(9.1deg);z-index:3}96%{clip:rect(2.6rem, 9999px, 0.5rem, 0);transform:skew(6.8deg);z-index:1}98%{clip:rect(0.7rem, 9999px, 1.5rem, 0);transform:skew(6.8deg);z-index:2}}@keyframes svelte-15phqsh-glitch-anim2{0%{clip:rect(0.16rem, 99999px, 1.4rem, 0);transform:skew(9.1deg);transform:translateX(0.4259259259rem)}0.6666666667%{clip:rect(0.18rem, 99999px, 4.1rem, 0);transform:skew(10.9deg);transform:translateX(0.3518518519rem)}1.3333333333%{clip:rect(0.14rem, 99999px, 7.8rem, 0);transform:skew(3.3deg);transform:translateX(0.462962963rem)}2%{clip:rect(0.2rem, 99999px, 3.2rem, 0);transform:skew(13.3deg);transform:translateX(0.2777777778rem)}2.6666666667%{clip:rect(0.12rem, 99999px, 8.7rem, 0);transform:skew(4.9deg);transform:translateX(0.462962963rem)}3.3333333333%{clip:rect(0.12rem, 99999px, 5.8rem, 0);transform:skew(3.6deg);transform:translateX(0.4444444444rem)}4%{clip:rect(0.04rem, 99999px, 3.4rem, 0);transform:skew(5.3deg);transform:translateX(0.4444444444rem)}4.6666666667%{clip:rect(0.04rem, 99999px, 5.5rem, 0);transform:skew(1.9deg);transform:translateX(0.3333333333rem)}5.3333333333%{clip:rect(0.02rem, 99999px, 4.7rem, 0);transform:skew(13.1deg);transform:translateX(0.3333333333rem)}6%{clip:rect(0.16rem, 99999px, 5.6rem, 0);transform:skew(13.5deg);transform:translateX(0.4444444444rem)}6.6666666667%{clip:rect(0.18rem, 99999px, 7.5rem, 0);transform:skew(5.2deg);transform:translateX(-0.1666666667rem)}7.3333333333%{clip:rect(0.1rem, 99999px, 7.8rem, 0);transform:skew(2.4deg);transform:translateX(0.3888888889rem)}8%{clip:rect(0.02rem, 99999px, 1.9rem, 0);transform:skew(13.1deg);transform:translateX(0.4259259259rem)}8.6666666667%{clip:rect(0.14rem, 99999px, 4.2rem, 0);transform:skew(6.8deg);transform:translateX(0.1666666667rem)}9.3333333333%{clip:rect(0.18rem, 99999px, 6.7rem, 0);transform:skew(1.7deg);transform:translateX(0.3333333333rem)}10%{clip:rect(0.2rem, 99999px, 2.9rem, 0);transform:skew(6.8deg);transform:translateX(0.3518518519rem)}10.6666666667%{clip:rect(0.18rem, 99999px, 5.3rem, 0);transform:skew(0.5deg);transform:translateX(0.3888888889rem)}11.3333333333%{clip:rect(0.08rem, 99999px, 9.7rem, 0);transform:skew(11.1deg);transform:translateX(0.4259259259rem)}12%{clip:rect(0.14rem, 99999px, 9.6rem, 0);transform:skew(12.2deg);transform:translateX(0.3888888889rem)}12.6666666667%{clip:rect(0.1rem, 99999px, 10rem, 0);transform:skew(12.6deg);transform:translateX(-0.1666666667rem)}13.3333333333%{clip:rect(0.18rem, 99999px, 3.2rem, 0);transform:skew(9.6deg);transform:translateX(0.2777777778rem)}14%{clip:rect(0.12rem, 99999px, 4.7rem, 0);transform:skew(5.7deg);transform:translateX(0.4444444444rem)}14.6666666667%{clip:rect(0.06rem, 99999px, 3.2rem, 0);transform:skew(0.4deg);transform:translateX(0.3888888889rem)}15.3333333333%{clip:rect(0.08rem, 99999px, 7.7rem, 0);transform:skew(8.2deg);transform:translateX(0.1666666667rem)}16%{clip:rect(0.02rem, 99999px, 7.5rem, 0);transform:skew(1.7deg);transform:translateX(0.2777777778rem)}16.6666666667%{clip:rect(0.1rem, 99999px, 9.1rem, 0);transform:skew(5.8deg);transform:translateX(0.2037037037rem)}17.3333333333%{clip:rect(0.1rem, 99999px, 8.8rem, 0);transform:skew(5deg);transform:translateX(0.462962963rem)}18%{clip:rect(0.04rem, 99999px, 5.3rem, 0);transform:skew(4.2deg);transform:translateX(0.1666666667rem)}18.6666666667%{clip:rect(0.18rem, 99999px, 2.3rem, 0);transform:skew(14.6deg);transform:translateX(0.4259259259rem)}19.3333333333%{clip:rect(0.06rem, 99999px, 8.6rem, 0);transform:skew(7.7deg);transform:translateX(0.4259259259rem)}20%{clip:rect(0.02rem, 99999px, 3.4rem, 0);transform:skew(9.6deg);transform:translateX(0.1666666667rem)}20.6666666667%{clip:rect(0.12rem, 99999px, 1rem, 0);transform:skew(12.1deg);transform:translateX(0.4444444444rem)}21.3333333333%{clip:rect(0.18rem, 99999px, 4.8rem, 0);transform:skew(13.2deg);transform:translateX(0.3888888889rem)}22%{clip:rect(0.16rem, 99999px, 7.8rem, 0);transform:skew(2.6deg);transform:translateX(0.4259259259rem)}22.6666666667%{clip:rect(0.14rem, 99999px, 4.7rem, 0);transform:skew(14.1deg);transform:translateX(0.3888888889rem)}23.3333333333%{clip:rect(0.08rem, 99999px, 6.8rem, 0);transform:skew(6.2deg);transform:translateX(-0.1666666667rem)}24%{clip:rect(0.14rem, 99999px, 1.6rem, 0);transform:skew(9.3deg);transform:translateX(0.1666666667rem)}24.6666666667%{clip:rect(0.12rem, 99999px, 0.9rem, 0);transform:skew(5.6deg);transform:translateX(0.0555555556rem)}25.3333333333%{clip:rect(0.02rem, 99999px, 0.2rem, 0);transform:skew(7deg);transform:translateX(0.4259259259rem)}26%{clip:rect(0.08rem, 99999px, 6.9rem, 0);transform:skew(10.5deg);transform:translateX(0.3888888889rem)}26.6666666667%{clip:rect(0.18rem, 99999px, 9.9rem, 0);transform:skew(14.6deg);transform:translateX(0.2777777778rem)}27.3333333333%{clip:rect(0.16rem, 99999px, 8.9rem, 0);transform:skew(2.9deg);transform:translateX(0.3888888889rem)}28%{clip:rect(0.1rem, 99999px, 1.1rem, 0);transform:skew(5.9deg);transform:translateX(0.3518518519rem)}28.6666666667%{clip:rect(0.16rem, 99999px, 4.8rem, 0);transform:skew(7.1deg);transform:translateX(0.2777777778rem)}29.3333333333%{clip:rect(0.04rem, 99999px, 2rem, 0);transform:skew(13.2deg);transform:translateX(0.462962963rem)}30%{clip:rect(0.18rem, 99999px, 8rem, 0);transform:skew(7.3deg);transform:translateX(0.462962963rem)}30.6666666667%{clip:rect(0.18rem, 99999px, 5.2rem, 0);transform:skew(10.9deg);transform:translateX(0.3888888889rem)}31.3333333333%{clip:rect(0.14rem, 99999px, 1.3rem, 0);transform:skew(8.7deg);transform:translateX(0.4259259259rem)}32%{clip:rect(0.2rem, 99999px, 5rem, 0);transform:skew(6.2deg);transform:translateX(0.1666666667rem)}32.6666666667%{clip:rect(0.16rem, 99999px, 5.7rem, 0);transform:skew(9.2deg);transform:translateX(0.2777777778rem)}33.3333333333%{clip:rect(0.1rem, 99999px, 7.9rem, 0);transform:skew(11.3deg);transform:translateX(-0.1666666667rem)}34%{clip:rect(0.16rem, 99999px, 7.1rem, 0);transform:skew(4.7deg);transform:translateX(0.2777777778rem)}34.6666666667%{clip:rect(0.18rem, 99999px, 4.6rem, 0);transform:skew(2deg);transform:translateX(0.2777777778rem)}35.3333333333%{clip:rect(0.12rem, 99999px, 5.1rem, 0);transform:skew(1.9deg);transform:translateX(0.3333333333rem)}36%{clip:rect(0.14rem, 99999px, 8.4rem, 0);transform:skew(0.5deg);transform:translateX(0.1666666667rem)}36.6666666667%{clip:rect(0.18rem, 99999px, 0.7rem, 0);transform:skew(13.9deg);transform:translateX(0.462962963rem)}37.3333333333%{clip:rect(0.14rem, 99999px, 5.3rem, 0);transform:skew(1.2deg);transform:translateX(0.3333333333rem)}38%{clip:rect(0.1rem, 99999px, 1.1rem, 0);transform:skew(4deg);transform:translateX(0.2777777778rem)}38.6666666667%{clip:rect(0.18rem, 99999px, 1.7rem, 0);transform:skew(12deg);transform:translateX(0.2777777778rem)}39.3333333333%{clip:rect(0.04rem, 99999px, 9.7rem, 0);transform:skew(14.6deg);transform:translateX(0.0555555556rem)}40%{clip:rect(0.02rem, 99999px, 1.9rem, 0);transform:skew(9.9deg);transform:translateX(0.4259259259rem)}40.6666666667%{clip:rect(0.12rem, 99999px, 4.9rem, 0);transform:skew(8.1deg);transform:translateX(0.462962963rem)}41.3333333333%{clip:rect(0.12rem, 99999px, 5rem, 0);transform:skew(13.7deg);transform:translateX(0.2777777778rem)}42%{clip:rect(0.2rem, 99999px, 4.3rem, 0);transform:skew(7.2deg);transform:translateX(0.1666666667rem)}42.6666666667%{clip:rect(0.2rem, 99999px, 8.4rem, 0);transform:skew(12.7deg);transform:translateX(0.4444444444rem)}43.3333333333%{clip:rect(0.04rem, 99999px, 5.8rem, 0);transform:skew(14.7deg);transform:translateX(0.3518518519rem)}44%{clip:rect(0.02rem, 99999px, 6.5rem, 0);transform:skew(1.2deg);transform:translateX(0.3888888889rem)}44.6666666667%{clip:rect(0.02rem, 99999px, 7.5rem, 0);transform:skew(5.1deg);transform:translateX(0.2777777778rem)}45.3333333333%{clip:rect(0.12rem, 99999px, 1.3rem, 0);transform:skew(2.8deg);transform:translateX(0.462962963rem)}46%{clip:rect(0.18rem, 99999px, 7.7rem, 0);transform:skew(3.9deg);transform:translateX(0.3888888889rem)}46.6666666667%{clip:rect(0.1rem, 99999px, 5.2rem, 0);transform:skew(8.9deg);transform:translateX(0rem)}47.3333333333%{clip:rect(0.18rem, 99999px, 0.9rem, 0);transform:skew(11deg);transform:translateX(0.0555555556rem)}48%{clip:rect(0.04rem, 99999px, 3.5rem, 0);transform:skew(12.1deg);transform:translateX(0.462962963rem)}48.6666666667%{clip:rect(0.12rem, 99999px, 7.5rem, 0);transform:skew(11.5deg);transform:translateX(0rem)}49.3333333333%{clip:rect(0.18rem, 99999px, 3.5rem, 0);transform:skew(10.4deg);transform:translateX(0.3888888889rem)}50%{clip:rect(0.08rem, 99999px, 6.5rem, 0);transform:skew(7.5deg);transform:translateX(0.4259259259rem)}50.6666666667%{clip:rect(0.14rem, 99999px, 6.9rem, 0);transform:skew(4.3deg);transform:translateX(0.1666666667rem)}51.3333333333%{clip:rect(0.18rem, 99999px, 6.6rem, 0);transform:skew(12.1deg);transform:translateX(0.1666666667rem)}52%{clip:rect(0.18rem, 99999px, 6.8rem, 0);transform:skew(7.4deg);transform:translateX(0.2777777778rem)}52.6666666667%{clip:rect(0.18rem, 99999px, 7.5rem, 0);transform:skew(5.3deg);transform:translateX(0.1666666667rem)}53.3333333333%{clip:rect(0.1rem, 99999px, 3.3rem, 0);transform:skew(0.4deg);transform:translateX(0.3333333333rem)}54%{clip:rect(0.14rem, 99999px, 2.6rem, 0);transform:skew(13.3deg);transform:translateX(0.2777777778rem)}54.6666666667%{clip:rect(0.2rem, 99999px, 4.3rem, 0);transform:skew(2.9deg);transform:translateX(0.2777777778rem)}55.3333333333%{clip:rect(0.08rem, 99999px, 0.4rem, 0);transform:skew(10.7deg);transform:translateX(0.1666666667rem)}56%{clip:rect(0.2rem, 99999px, 2.5rem, 0);transform:skew(7deg);transform:translateX(0.3888888889rem)}56.6666666667%{clip:rect(0.02rem, 99999px, 5.2rem, 0);transform:skew(6.8deg);transform:translateX(0.1666666667rem)}57.3333333333%{clip:rect(0.02rem, 99999px, 8.1rem, 0);transform:skew(14.7deg);transform:translateX(0.4259259259rem)}58%{clip:rect(0.18rem, 99999px, 8.4rem, 0);transform:skew(9.5deg);transform:translateX(0.3888888889rem)}58.6666666667%{clip:rect(0.2rem, 99999px, 7.3rem, 0);transform:skew(10.3deg);transform:translateX(-0.1666666667rem)}59.3333333333%{clip:rect(0.18rem, 99999px, 3.4rem, 0);transform:skew(13.6deg);transform:translateX(0.2777777778rem)}60%{clip:rect(0.14rem, 99999px, 7.3rem, 0);transform:skew(12deg);transform:translateX(0rem)}60.6666666667%{clip:rect(0.2rem, 99999px, 9.9rem, 0);transform:skew(4.6deg);transform:translateX(0.3888888889rem)}61.3333333333%{clip:rect(0.06rem, 99999px, 8.7rem, 0);transform:skew(7.8deg);transform:translateX(0.0555555556rem)}62%{clip:rect(0.2rem, 99999px, 8rem, 0);transform:skew(6.6deg);transform:translateX(0.462962963rem)}62.6666666667%{clip:rect(0.1rem, 99999px, 6.6rem, 0);transform:skew(9.3deg);transform:translateX(0.1666666667rem)}63.3333333333%{clip:rect(0.1rem, 99999px, 4.2rem, 0);transform:skew(7.8deg);transform:translateX(0.4444444444rem)}64%{clip:rect(0.16rem, 99999px, 0.6rem, 0);transform:skew(10deg);transform:translateX(0.3888888889rem)}64.6666666667%{clip:rect(0.2rem, 99999px, 10rem, 0);transform:skew(10.7deg);transform:translateX(0.2777777778rem)}65.3333333333%{clip:rect(0.1rem, 99999px, 5.2rem, 0);transform:skew(6.9deg);transform:translateX(0.1666666667rem)}66%{clip:rect(0.14rem, 99999px, 1.1rem, 0);transform:skew(5.9deg);transform:translateX(0.462962963rem)}66.6666666667%{clip:rect(0.04rem, 99999px, 7.7rem, 0);transform:skew(13.8deg);transform:translateX(0.3888888889rem)}67.3333333333%{clip:rect(0.12rem, 99999px, 0.2rem, 0);transform:skew(4.6deg);transform:translateX(0.462962963rem)}68%{clip:rect(0.18rem, 99999px, 5.3rem, 0);transform:skew(11.4deg);transform:translateX(0.3518518519rem)}68.6666666667%{clip:rect(0.08rem, 99999px, 3.7rem, 0);transform:skew(6.8deg);transform:translateX(0.3518518519rem)}69.3333333333%{clip:rect(0.08rem, 99999px, 9.4rem, 0);transform:skew(15deg);transform:translateX(0.3518518519rem)}70%{clip:rect(0.18rem, 99999px, 10rem, 0);transform:skew(6.4deg);transform:translateX(0.1666666667rem)}70.6666666667%{clip:rect(0.04rem, 99999px, 4.7rem, 0);transform:skew(12.9deg);transform:translateX(0.1666666667rem)}71.3333333333%{clip:rect(0.02rem, 99999px, 9.6rem, 0);transform:skew(5.4deg);transform:translateX(0.4814814815rem)}72%{clip:rect(0.08rem, 99999px, 0.7rem, 0);transform:skew(4.9deg);transform:translateX(0.1666666667rem)}72.6666666667%{clip:rect(0.12rem, 99999px, 1.4rem, 0);transform:skew(5.8deg);transform:translateX(0.462962963rem)}73.3333333333%{clip:rect(0.12rem, 99999px, 2.3rem, 0);transform:skew(3.4deg);transform:translateX(0.1666666667rem)}74%{clip:rect(0.14rem, 99999px, 9rem, 0);transform:skew(7.3deg);transform:translateX(0.2037037037rem)}74.6666666667%{clip:rect(0.08rem, 99999px, 9.8rem, 0);transform:skew(12.6deg);transform:translateX(0.3888888889rem)}75.3333333333%{clip:rect(0.16rem, 99999px, 4rem, 0);transform:skew(1.6deg);transform:translateX(0.1666666667rem)}76%{clip:rect(0.02rem, 99999px, 5.9rem, 0);transform:skew(4.2deg);transform:translateX(0.0555555556rem)}76.6666666667%{clip:rect(0.02rem, 99999px, 5.3rem, 0);transform:skew(14.9deg);transform:translateX(0.3518518519rem)}77.3333333333%{clip:rect(0.2rem, 99999px, 3.9rem, 0);transform:skew(0.5deg);transform:translateX(-0.1666666667rem)}78%{clip:rect(0.18rem, 99999px, 6.6rem, 0);transform:skew(6.5deg);transform:translateX(0.3888888889rem)}78.6666666667%{clip:rect(0.1rem, 99999px, 0.4rem, 0);transform:skew(12.3deg);transform:translateX(0.4259259259rem)}79.3333333333%{clip:rect(0.12rem, 99999px, 4.7rem, 0);transform:skew(4.2deg);transform:translateX(0.0555555556rem)}80%{clip:rect(0.14rem, 99999px, 8.4rem, 0);transform:skew(10.4deg);transform:translateX(0.3518518519rem)}80.6666666667%{clip:rect(0.18rem, 99999px, 2.3rem, 0);transform:skew(12.6deg);transform:translateX(0.3518518519rem)}81.3333333333%{clip:rect(0.18rem, 99999px, 3.2rem, 0);transform:skew(8.5deg);transform:translateX(0.3888888889rem)}82%{clip:rect(0.06rem, 99999px, 9.8rem, 0);transform:skew(13.5deg);transform:translateX(0.4259259259rem)}82.6666666667%{clip:rect(0.1rem, 99999px, 0.9rem, 0);transform:skew(3.2deg);transform:translateX(0.3888888889rem)}83.3333333333%{clip:rect(0.04rem, 99999px, 4.2rem, 0);transform:skew(9.4deg);transform:translateX(0.3518518519rem)}84%{clip:rect(0.08rem, 99999px, 9.1rem, 0);transform:skew(4.1deg);transform:translateX(0.462962963rem)}84.6666666667%{clip:rect(0.1rem, 99999px, 1.6rem, 0);transform:skew(9.7deg);transform:translateX(0.2777777778rem)}85.3333333333%{clip:rect(0.02rem, 99999px, 4.2rem, 0);transform:skew(7.9deg);transform:translateX(0.4444444444rem)}86%{clip:rect(0.18rem, 99999px, 0.7rem, 0);transform:skew(9.8deg);transform:translateX(0.2777777778rem)}86.6666666667%{clip:rect(0.12rem, 99999px, 7.3rem, 0);transform:skew(4deg);transform:translateX(0.3518518519rem)}87.3333333333%{clip:rect(0.08rem, 99999px, 7.9rem, 0);transform:skew(6.5deg);transform:translateX(0.4259259259rem)}88%{clip:rect(0.12rem, 99999px, 8.9rem, 0);transform:skew(12.3deg);transform:translateX(0.4444444444rem)}88.6666666667%{clip:rect(0.18rem, 99999px, 7.2rem, 0);transform:skew(5.7deg);transform:translateX(0.3518518519rem)}89.3333333333%{clip:rect(0.18rem, 99999px, 1.8rem, 0);transform:skew(11.6deg);transform:translateX(0.4444444444rem)}90%{clip:rect(0.08rem, 99999px, 6rem, 0);transform:skew(5.1deg);transform:translateX(0.4259259259rem)}90.6666666667%{clip:rect(0.04rem, 99999px, 0.3rem, 0);transform:skew(14.9deg);transform:translateX(0.0555555556rem)}91.3333333333%{clip:rect(0.02rem, 99999px, 3.4rem, 0);transform:skew(11.9deg);transform:translateX(0.2037037037rem)}92%{clip:rect(0.04rem, 99999px, 3.8rem, 0);transform:skew(7.2deg);transform:translateX(0.3518518519rem)}92.6666666667%{clip:rect(0.2rem, 99999px, 7.7rem, 0);transform:skew(10.4deg);transform:translateX(0.1666666667rem)}93.3333333333%{clip:rect(0.06rem, 99999px, 0.2rem, 0);transform:skew(5.7deg);transform:translateX(0.3333333333rem)}94%{clip:rect(0.06rem, 99999px, 4.3rem, 0);transform:skew(15deg);transform:translateX(0.4444444444rem)}94.6666666667%{clip:rect(0.1rem, 99999px, 3.2rem, 0);transform:skew(14.9deg);transform:translateX(0.3518518519rem)}95.3333333333%{clip:rect(0.16rem, 99999px, 9.5rem, 0);transform:skew(13.5deg);transform:translateX(0.3888888889rem)}96%{clip:rect(0.14rem, 99999px, 9.9rem, 0);transform:skew(5.5deg);transform:translateX(0.4259259259rem)}96.6666666667%{clip:rect(0.2rem, 99999px, 3.2rem, 0);transform:skew(2.9deg);transform:translateX(0.3888888889rem)}97.3333333333%{clip:rect(0.06rem, 99999px, 5.6rem, 0);transform:skew(6.5deg);transform:translateX(0.3888888889rem)}98%{clip:rect(0.06rem, 99999px, 0.8rem, 0);transform:skew(6deg);transform:translateX(0.2777777778rem)}98.6666666667%{clip:rect(0.18rem, 99999px, 5.8rem, 0);transform:skew(0.5deg);transform:translateX(0.3888888889rem)}99.3333333333%{clip:rect(0.04rem, 99999px, 7.5rem, 0);transform:skew(14deg);transform:translateX(0.1666666667rem)}}@keyframes svelte-15phqsh-glitch-skew{0%{transform:skew(1deg)}10%{transform:skew(2deg)}20%{transform:skew(5deg)}30%{transform:skew(2deg)}40%{transform:skew(0deg)}50%{transform:skew(-1deg)}60%{transform:skew(0deg)}70%{transform:skew(-3deg)}80%{transform:skew(-3deg)}90%{transform:skew(-2deg)}}#bar.svelte-15phqsh .logo.hover-effect-1.logo-behind-a.svelte-15phqsh{color:white;transform:translateX(-0.5rem);color:#ffc800 !important;text-shadow:-2px 0 #ffc800, 2px 2px #ffc800;clip:rect(44px, 450px, 56px, 0);animation:svelte-15phqsh-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-15phqsh .logo.hover-effect-1.logo-behind-b.svelte-15phqsh{color:rgb(165, 49, 49) !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #aa10f2;clip:rect(44px, 450px, 56px, 0);animation:svelte-15phqsh-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-15phqsh .logo.logo-behind.svelte-15phqsh{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-15phqsh .logo.logo-behind.svelte-15phqsh:not(.hovered){display:none}#bar.svelte-15phqsh #menus.svelte-15phqsh{margin-left:auto;display:flex}#bar.svelte-15phqsh #menus #menu.svelte-15phqsh{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-15phqsh #menus #menu.svelte-15phqsh .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function Bar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-15phqsh");
			add_location(mark, Bar_svelte_file, -1, 36060);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[1] + " svelte-15phqsh");
			add_location(a0, Bar_svelte_file, -1, 35990);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[1] + " svelte-15phqsh");
			add_location(a1, Bar_svelte_file, -1, 36095);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[1] + " svelte-15phqsh");
			add_location(a2, Bar_svelte_file, -1, 36181);
			attr_dev(div0, "id", "menu");
			attr_dev(div0, "class", "svelte-15phqsh");
			add_location(div0, Bar_svelte_file, -1, 36285);
			attr_dev(div1, "id", "menu");
			attr_dev(div1, "class", "svelte-15phqsh");
			add_location(div1, Bar_svelte_file, -1, 36577);
			attr_dev(div2, "id", "menus");
			attr_dev(div2, "class", "svelte-15phqsh");
			add_location(div2, Bar_svelte_file, -1, 36266);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-15phqsh");
			add_location(nav, Bar_svelte_file, -1, 35974);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (!current || dirty & /*hovered_class*/ 2 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[1] + " svelte-15phqsh")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 2 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[1] + " svelte-15phqsh")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 2 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[1] + " svelte-15phqsh")) {
