...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 53, 7, 1881);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 67, 26, 2439);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, a, anchor);
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			t24 = space();
			p2 = dom_element("p");
			t25 = dom_text("There are 2 directional conic light sources, refracting through a fractal ");
			a2 = dom_element("a");
			...
			t33 = space();
			p3 = dom_element("p");
			t34 = dom_text("What’s being rendered is fluence¹. This is what 2d pathtracing displays.");
			br = dom_element("br");
			t35 = dom_text("\nPossibly the first ");
			a3 = dom_element("a");
			a3.textContent = "article";
			t37 = dom_text(" and renders were done by the graphics engineer ");
			a4 = dom_element("a");
			...
			strong3.textContent = "Clarifications";
			t78 = space();
			...
			ul = dom_element("ul");
			li4 = dom_element("li");
			t81 = dom_text("“coherent” is needed when different ");
			a7 = dom_element("a");
			...
			t85 = dom_text(". It can look cool if you don’t enable it :)");
			t86 = space();
			li5 = dom_element("li");
			...
			t111 = dom_text(". Looks rather cool if you directly add to the buffer without atomics though :)");
			t112 = space();
			p11 = dom_element("p");
			t113 = dom_text("If you feel like accumulating to a float buffer/image, you can do that with an ");
			a13 = dom_element("a");
			a13.textContent = "nvidia extension";
			t115 = dom_text(",\nor the ");
			a14 = dom_element("a");
			a14.textContent = "compare-and-swap";
			t117 = dom_text(" algorithm.");
			t118 = space();
			...
			add_location(strong0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 15, 7, 719);
			add_location(h1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 15, 7, 715);
			add_location(header, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 15, 0, 707);
			attr_dev(div0, "class", "date");
			add_location(div0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 16, 0, 758);
			add_location(brb0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 24, 0, 871);
			add_location(brb1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 25, 0, 881);
			add_location(strong1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 26, 4, 893);
			add_location(h20, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 26, 0, 889);
			attr_dev(a0, "href", "https://en.wikipedia.org/wiki/Lightmap");
			attr_dev(a0, "rel", "nofollow");
			add_location(a0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 27, 44, 981);
			...
			add_location(a1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 31, 2, 1071);
			add_location(p0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 27, 0, 928);
			add_location(p1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 36, 0, 1384);
			add_location(brb2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 37, 0, 1460);
			add_location(brb3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 38, 0, 1468);
			add_location(brb4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 55, 0, 1986);
			attr_dev(a2, "href", "https://en.wikipedia.org/wiki/Implicit_surface");
			attr_dev(a2, "rel", "nofollow");
			add_location(a2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 56, 38, 2071);
			add_location(p2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 56, 0, 1994);
			add_location(brb5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 63, 0, 2347);
			add_location(brb6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 64, 0, 2355);
			add_location(brb7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 69, 0, 2503);
			add_location(br, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 70, 7, 2586);
			attr_dev(a3, "href", "https://web.archive.org/web/20040131013212/http://lycium.cfxweb.net/");
			attr_dev(a3, "rel", "nofollow");
			add_location(a3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 71, 0, 2610);
			attr_dev(a4, "href", "https://www.deviantart.com/lyc");
			add_location(a4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 74, 8, 2768);
			add_location(p3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 70, 0, 2511);
			add_location(p4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 75, 0, 2825);
			add_location(wbr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 76, 0, 2941);
			add_location(hr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 78, 2, 2975);
			attr_dev(a5, "href", "https://cs.dartmouth.edu/wjarosz/publications/jarosz12theory.html");
			add_location(a5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 80, 6, 2998);
			add_location(brb8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 80, 6, 3192);
			attr_dev(a6, "href", "https://en.wikipedia.org/wiki/Irradiance");
			add_location(a6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 81, 0, 3209);
			add_location(ol0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 79, 2, 2984);
			add_location(hr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 83, 0, 3443);
			attr_dev(div1, "class", "footnotes");
			add_location(div1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 77, 0, 2949);
			add_location(wbr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 85, 0, 3457);
			add_location(strong2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 86, 4, 3469);
			add_location(h21, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 86, 0, 3465);
			add_location(p5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 87, 0, 3500);
			add_location(brb9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 88, 0, 3653);
			add_location(brb10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 94, 0, 3909);
			add_location(p6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 95, 0, 3917);
			add_location(li0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 97, 0, 3959);
			add_location(li1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 98, 0, 4040);
			add_location(li2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 99, 0, 4134);
			add_location(li3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 100, 0, 4222);
			add_location(ol1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 96, 0, 3954);
			add_location(p7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 102, 0, 4349);
			add_location(wbr2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 103, 0, 4385);
			attr_dev(pre0, "class", "language-glsl");
			add_location(pre0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 104, 0, 4393);
			add_location(brb11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 148, 0, 10782);
			add_location(strong3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 149, 2, 10794);
			add_location(h22, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 149, 0, 10790);
			add_location(wbr3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 150, 0, 10831);
			attr_dev(pre1, "class", "language-undefined");
			add_location(pre1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 151, 0, 10839);
			attr_dev(a7, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 153, 2, 11034);
			attr_dev(a8, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 158, 0, 11308);
			add_location(li4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 153, 0, 10994);
			add_location(li5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 163, 0, 11484);
			add_location(li6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 165, 0, 12101);
			add_location(ul, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 152, 0, 10989);
			attr_dev(a9, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a9, "rel", "nofollow");
			add_location(a9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 168, 16, 12234);
			add_location(p8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 168, 0, 12214);
			add_location(wbr4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 172, 0, 12344);
			add_location(strong4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 173, 4, 12356);
			add_location(h23, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 173, 0, 12352);
			add_location(brb12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 177, 0, 12535);
			attr_dev(a10, "href", "https://www.shadertoy.com/view/4dX3zl");
			add_location(a10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 179, 18, 12568);
			add_location(p9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 174, 0, 12392);
			add_location(brb13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 183, 0, 12797);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 184, 0, 12807);
			add_location(brb14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 209, 0, 20080);
			attr_dev(pre3, "class", "language-glsl");
			add_location(pre3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 210, 0, 20087);
			attr_dev(a11, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 211, 9, 20417);
			attr_dev(a12, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 214, 50, 20560);
			add_location(p10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 211, 0, 20408);
			attr_dev(a13, "href", "https://registry.khronos.org/OpenGL/extensions/NV/NV_shader_atomic_float.txt");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 218, 36, 20816);
			attr_dev(a14, "href", "https://en.wikipedia.org/wiki/Compare-and-swap");
			attr_dev(a14, "rel", "nofollow");
			add_location(a14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 222, 2, 20952);
			add_location(p11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 218, 0, 20734);
			add_location(brb15, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 226, 0, 21065);
			add_location(strong5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 227, 0, 21076);
			add_location(h24, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 227, 0, 21072);
			add_location(p12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 228, 0, 21110);
			add_location(article, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 23, 0, 861);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			append_dev(p9, a10);
			append_dev(p9, t101);
			append_dev(article, t102);
			append_dev(article, brb13);
			append_dev(article, t103);
			append_dev(article, pre2);
			pre2.innerHTML = raw2_value;
			append_dev(article, t104);
			...
			append_dev(article, t119);
			append_dev(article, h24);
			append_dev(h24, strong5);
			append_dev(article, t121);
...
<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>uv <span class="token operator">+</span> anti_aliasing <span class="token operator">+</span> dof_sample<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	const block = {
		...
		d: function destroy(detaching) {
			...
			destroy_component(video0, detaching);
			destroy_component(video1, detaching);
			destroy_component(video2, detaching);
			destroy_component(video3, detaching);
			destroy_component(video4, detaching);
...
function musicPage_svelte_create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(wave_audio_path_player, musicPage_svelte_file, -1, 3719);
			attr_dev(div0, "class", "track-name svelte-l9r4ji");
			add_location(div0, musicPage_svelte_file, -1, 4062);
			attr_dev(div1, "class", "track-date svelte-l9r4ji");
			add_location(div1, musicPage_svelte_file, -1, 4133);
			attr_dev(div2, "class", "track-bottom-bar svelte-l9r4ji");
			add_location(div2, musicPage_svelte_file, -1, 4024);
			attr_dev(div3, "class", "track svelte-l9r4ji");
			add_location(div3, musicPage_svelte_file, -1, 3693);
		},
		m: function mount(target, anchor) {
...
// (160:1) {#each Object.keys(audio_folders).reverse() as audio_folder_key, k}
function musicPage_svelte_create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, musicPage_svelte_file, -1, 3146);
			attr_dev(path, "d", "M480-360 280-559h400L480-360Z");
			add_location(path, musicPage_svelte_file, -1, 3395);
			...
			add_location(svg, musicPage_svelte_file, -1, 3224);
			attr_dev(div1, "class", "title-container svelte-l9r4ji");
			add_location(div1, musicPage_svelte_file, -1, 3043);
			...
			add_location(div2, musicPage_svelte_file, -1, 3459);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(160:1) {#each Object.keys(audio_folders).reverse() as audio_folder_key, k}",
		ctx
	});
...
function musicPage_svelte_create_fragment(ctx) {
	...
	let each_value = ensure_array_like_dev(Object.keys(/*audio_folders*/ ctx[1]).reverse());
	let each_blocks = [];
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*audio_folders_toggled, audio_folders, Object, window*/ 3) {
				each_value = ensure_array_like_dev(Object.keys(/*audio_folders*/ ctx[1]).reverse());
				let i;
