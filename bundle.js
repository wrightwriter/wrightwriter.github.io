...
function add_css(target) {
	append_styles(target, "svelte-1j874il", ".menu-item.svelte-1j874il{font-weight:600;font-style:italic;width:fit-content}.selected.svelte-1j874il{background:black;color:white}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiTGluay5zdmVsdGUiLCJtYXBwaW5ncyI6IkFBOEJrQiIsIm5hbWVzIjpbXSwic291cmNlcyI6WyJMaW5rLnN2ZWx0ZSJdfQ== */");
}
...
class Link extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { text: 1, link: 0 }, add_css);
...
function Bar_svelte_add_css(target) {
	append_styles(target, "svelte-ebv4xl", "#bar.svelte-ebv4xl.svelte-ebv4xl{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-ebv4xl .logo.svelte-ebv4xl{position:absolute;font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-ebv4xl .logo.hovered.svelte-ebv4xl{color:black !important;background:none}#bar.svelte-ebv4xl .logo.hovered.hover-effect-0.svelte-ebv4xl{animation:svelte-ebv4xl-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-ebv4xl-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-ebv4xl-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-ebv4xl-glitch-anim3{0%{clip:rect(3.6rem, 9999px, 3rem, 0);transform-origin:center}2%{clip:rect(0.7rem, 9999px, 5rem, 0);transform-origin:center}4%{clip:rect(1.3rem, 9999px, 3.5rem, 0);transform-origin:center}6%{clip:rect(2.2rem, 9999px, 5rem, 0);transform-origin:center}8%{clip:rect(2.8rem, 9999px, 4.5rem, 0);transform-origin:center}10%{clip:rect(3rem, 9999px, 2rem, 0);transform-origin:center}12%{clip:rect(1.6rem, 9999px, 3.5rem, 0);transform-origin:center}14%{clip:rect(1.4rem, 9999px, 3rem, 0);transform-origin:center}16%{clip:rect(0.3rem, 9999px, 1rem, 0);transform-origin:center}18%{clip:rect(1.7rem, 9999px, 0.5rem, 0);transform-origin:center}20%{clip:rect(0.6rem, 9999px, 2.5rem, 0);transform-origin:center}22%{clip:rect(1.8rem, 9999px, 2.5rem, 0);transform-origin:center}24%{clip:rect(3rem, 9999px, 4rem, 0);transform-origin:center}26%{clip:rect(2.1rem, 9999px, 0.5rem, 0);transform-origin:center}28%{clip:rect(3.6rem, 9999px, 3.5rem, 0);transform-origin:center}30%{clip:rect(3.1rem, 9999px, 4.5rem, 0);transform-origin:center}32%{clip:rect(0.3rem, 9999px, 3.5rem, 0);transform-origin:center}34%{clip:rect(3.4rem, 9999px, 3.5rem, 0);transform-origin:center}36%{clip:rect(0.7rem, 9999px, 1rem, 0);transform-origin:center}38%{clip:rect(2.7rem, 9999px, 0.5rem, 0);transform-origin:center}40%{clip:rect(0.2rem, 9999px, 1.5rem, 0);transform-origin:center}42%{clip:rect(3.7rem, 9999px, 2.5rem, 0);transform-origin:center}44%{clip:rect(2.2rem, 9999px, 1.5rem, 0);transform-origin:center}46%{clip:rect(1.2rem, 9999px, 0.5rem, 0);transform-origin:center}48%{clip:rect(4rem, 9999px, 0.5rem, 0);transform-origin:center}50%{clip:rect(1.3rem, 9999px, 3.5rem, 0);transform-origin:center}52%{clip:rect(1.8rem, 9999px, 3rem, 0);transform-origin:center}54%{clip:rect(2.8rem, 9999px, 4rem, 0);transform-origin:center}56%{clip:rect(3rem, 9999px, 4rem, 0);transform-origin:center}58%{clip:rect(0.1rem, 9999px, 2.5rem, 0);transform-origin:center}60%{clip:rect(0.8rem, 9999px, 1rem, 0);transform-origin:center}62%{clip:rect(2.4rem, 9999px, 3rem, 0);transform-origin:center}64%{clip:rect(2.8rem, 9999px, 4rem, 0);transform-origin:center}66%{clip:rect(2.3rem, 9999px, 3.5rem, 0);transform-origin:center}68%{clip:rect(0.8rem, 9999px, 2rem, 0);transform-origin:center}70%{clip:rect(2rem, 9999px, 1.5rem, 0);transform-origin:center}72%{clip:rect(2.2rem, 9999px, 2.5rem, 0);transform-origin:center}74%{clip:rect(0.4rem, 9999px, 2rem, 0);transform-origin:center}76%{clip:rect(3.8rem, 9999px, 5rem, 0);transform-origin:center}78%{clip:rect(2.3rem, 9999px, 5rem, 0);transform-origin:center}80%{clip:rect(3rem, 9999px, 2rem, 0);transform-origin:center}82%{clip:rect(1.9rem, 9999px, 4.5rem, 0);transform-origin:center}84%{clip:rect(1.1rem, 9999px, 2rem, 0);transform-origin:center}86%{clip:rect(1.4rem, 9999px, 1.5rem, 0);transform-origin:center}88%{clip:rect(1.4rem, 9999px, 5rem, 0);transform-origin:center}90%{clip:rect(1.3rem, 9999px, 4.5rem, 0);transform-origin:center}92%{clip:rect(1.4rem, 9999px, 3rem, 0);transform-origin:center}94%{clip:rect(0.7rem, 9999px, 3rem, 0);transform-origin:center}96%{clip:rect(1.1rem, 9999px, 0.5rem, 0);transform-origin:center}98%{clip:rect(2.6rem, 9999px, 2rem, 0);transform-origin:center}}@keyframes svelte-ebv4xl-cooool{0%{color:red !important}2%{color:red !important}4%{color:red !important}6%{color:red !important}8%{color:red !important}10%{color:red !important}12%{color:red !important}14%{color:red !important}16%{color:red !important}18%{color:red !important}20%{color:red !important}22%{color:red !important}24%{color:red !important}26%{color:red !important}28%{color:red !important}30%{color:red !important}32%{color:red !important}34%{color:red !important}36%{color:red !important}38%{color:red !important}40%{color:red !important}42%{color:red !important}44%{color:red !important}46%{color:red !important}48%{color:red !important}50%{color:red !important}52%{color:red !important}54%{color:red !important}56%{color:red !important}58%{color:red !important}60%{color:red !important}62%{color:red !important}64%{color:red !important}66%{color:red !important}68%{color:red !important}70%{color:red !important}72%{color:red !important}74%{color:red !important}76%{color:red !important}78%{color:red !important}80%{color:red !important}82%{color:red !important}84%{color:red !important}86%{color:red !important}88%{color:red !important}90%{color:red !important}92%{color:red !important}94%{color:red !important}96%{color:red !important}98%{color:red !important}}#bar.svelte-ebv4xl .logo.hovered.hover-effect-0.logo-behind-a.svelte-ebv4xl{color:#ffc800 !important;animation:svelte-ebv4xl-distort1 300ms linear infinite, svelte-ebv4xl-glitch-anim3 5s infinite linear alternate-reverse, svelte-ebv4xl-cooool 5s infinite linear alternate-reverse}#bar.svelte-ebv4xl .logo.hovered.hover-effect-0.logo-behind-b.svelte-ebv4xl{color:#aa10f2 !important;animation:svelte-ebv4xl-distort2 300ms linear infinite, svelte-ebv4xl-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-ebv4xl .logo.hover-effect-1.svelte-ebv4xl{animation:svelte-ebv4xl-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-ebv4xl-glitch-anim{0%{clip:rect(3.2rem, 9999px, 4.5rem, 0);transform:skew(4.9deg);z-index:2}2%{clip:rect(3.8rem, 9999px, 4.5rem, 0);transform:skew(0.3deg);z-index:3}4%{clip:rect(1.8rem, 9999px, 2rem, 0);transform:skew(3deg);z-index:1}6%{clip:rect(3.7rem, 9999px, 2.5rem, 0);transform:skew(0.3deg);z-index:4}8%{clip:rect(0.2rem, 9999px, 3.5rem, 0);transform:skew(9.9deg);z-index:1}10%{clip:rect(0.2rem, 9999px, 3.5rem, 0);transform:skew(1.3deg);z-index:4}12%{clip:rect(0.7rem, 9999px, 4.5rem, 0);transform:skew(7.6deg);z-index:4}14%{clip:rect(3.5rem, 9999px, 4.5rem, 0);transform:skew(3.7deg);z-index:4}16%{clip:rect(2.2rem, 9999px, 1.5rem, 0);transform:skew(8.5deg);z-index:1}18%{clip:rect(1.5rem, 9999px, 1.5rem, 0);transform:skew(1.8deg);z-index:3}20%{clip:rect(0.6rem, 9999px, 2.5rem, 0);transform:skew(8deg);z-index:3}22%{clip:rect(1.1rem, 9999px, 2rem, 0);transform:skew(4.3deg);z-index:3}24%{clip:rect(3.4rem, 9999px, 0.5rem, 0);transform:skew(6.3deg);z-index:4}26%{clip:rect(3.8rem, 9999px, 2.5rem, 0);transform:skew(6.9deg);z-index:1}28%{clip:rect(0.4rem, 9999px, 5rem, 0);transform:skew(2.6deg);z-index:4}30%{clip:rect(0.4rem, 9999px, 2rem, 0);transform:skew(8.5deg);z-index:4}32%{clip:rect(2.7rem, 9999px, 1rem, 0);transform:skew(6.8deg);z-index:4}34%{clip:rect(1.6rem, 9999px, 0.5rem, 0);transform:skew(5.3deg);z-index:1}36%{clip:rect(1.2rem, 9999px, 4rem, 0);transform:skew(9.4deg);z-index:1}38%{clip:rect(1.4rem, 9999px, 2rem, 0);transform:skew(7.5deg);z-index:2}40%{clip:rect(2.2rem, 9999px, 0.5rem, 0);transform:skew(4deg);z-index:4}42%{clip:rect(2.6rem, 9999px, 1rem, 0);transform:skew(9.9deg);z-index:1}44%{clip:rect(1.2rem, 9999px, 2.5rem, 0);transform:skew(7.2deg);z-index:2}46%{clip:rect(3.8rem, 9999px, 3.5rem, 0);transform:skew(8deg);z-index:3}48%{clip:rect(1.7rem, 9999px, 4rem, 0);transform:skew(7.3deg);z-index:3}50%{clip:rect(1.4rem, 9999px, 4.5rem, 0);transform:skew(5.8deg);z-index:4}52%{clip:rect(3.7rem, 9999px, 1rem, 0);transform:skew(2.3deg);z-index:1}54%{clip:rect(3.3rem, 9999px, 0.5rem, 0);transform:skew(0.7deg);z-index:1}56%{clip:rect(3.4rem, 9999px, 1.5rem, 0);transform:skew(2.9deg);z-index:4}58%{clip:rect(1.3rem, 9999px, 3.5rem, 0);transform:skew(5.9deg);z-index:4}60%{clip:rect(1.1rem, 9999px, 2.5rem, 0);transform:skew(8.2deg);z-index:2}62%{clip:rect(1.9rem, 9999px, 4.5rem, 0);transform:skew(1.8deg);z-index:2}64%{clip:rect(3.5rem, 9999px, 1.5rem, 0);transform:skew(0.2deg);z-index:3}66%{clip:rect(2.1rem, 9999px, 4rem, 0);transform:skew(4.1deg);z-index:4}68%{clip:rect(0.1rem, 9999px, 1rem, 0);transform:skew(6deg);z-index:2}70%{clip:rect(3rem, 9999px, 2rem, 0);transform:skew(2.9deg);z-index:3}72%{clip:rect(0.7rem, 9999px, 2rem, 0);transform:skew(1.3deg);z-index:4}74%{clip:rect(2rem, 9999px, 4rem, 0);transform:skew(1deg);z-index:1}76%{clip:rect(1.6rem, 9999px, 1.5rem, 0);transform:skew(7.3deg);z-index:2}78%{clip:rect(0.2rem, 9999px, 0.5rem, 0);transform:skew(7.6deg);z-index:4}80%{clip:rect(4rem, 9999px, 4rem, 0);transform:skew(7.3deg);z-index:1}82%{clip:rect(1.6rem, 9999px, 0.5rem, 0);transform:skew(7.8deg);z-index:4}84%{clip:rect(2.3rem, 9999px, 2.5rem, 0);transform:skew(8.2deg);z-index:4}86%{clip:rect(2.2rem, 9999px, 2rem, 0);transform:skew(4deg);z-index:3}88%{clip:rect(3rem, 9999px, 3.5rem, 0);transform:skew(5.9deg);z-index:3}90%{clip:rect(2.3rem, 9999px, 2rem, 0);transform:skew(9deg);z-index:2}92%{clip:rect(1.5rem, 9999px, 3rem, 0);transform:skew(5.6deg);z-index:4}94%{clip:rect(0.6rem, 9999px, 1.5rem, 0);transform:skew(3.3deg);z-index:1}96%{clip:rect(1.8rem, 9999px, 0.5rem, 0);transform:skew(8.3deg);z-index:4}98%{clip:rect(0.5rem, 9999px, 2rem, 0);transform:skew(8.7deg);z-index:3}}@keyframes svelte-ebv4xl-glitch-anim2{0%{clip:rect(0.18rem, 99999px, 7.1rem, 0);transform:skew(0.3deg);transform:translateX(0.0555555556rem)}0.6666666667%{clip:rect(0.04rem, 99999px, 3.3rem, 0);transform:skew(6.8deg);transform:translateX(0.4814814815rem)}1.3333333333%{clip:rect(0.2rem, 99999px, 8.3rem, 0);transform:skew(14.3deg);transform:translateX(0.3518518519rem)}2%{clip:rect(0.06rem, 99999px, 1.7rem, 0);transform:skew(6.6deg);transform:translateX(0.1666666667rem)}2.6666666667%{clip:rect(0.06rem, 99999px, 8.2rem, 0);transform:skew(13.6deg);transform:translateX(0.3888888889rem)}3.3333333333%{clip:rect(0.14rem, 99999px, 0.9rem, 0);transform:skew(14.6deg);transform:translateX(0.3888888889rem)}4%{clip:rect(0.16rem, 99999px, 8.3rem, 0);transform:skew(13.1deg);transform:translateX(0.2777777778rem)}4.6666666667%{clip:rect(0.06rem, 99999px, 7.7rem, 0);transform:skew(7deg);transform:translateX(0.4259259259rem)}5.3333333333%{clip:rect(0.06rem, 99999px, 1.8rem, 0);transform:skew(0.6deg);transform:translateX(0.4814814815rem)}6%{clip:rect(0.04rem, 99999px, 6.2rem, 0);transform:skew(9.6deg);transform:translateX(0.0555555556rem)}6.6666666667%{clip:rect(0.06rem, 99999px, 1.9rem, 0);transform:skew(0.5deg);transform:translateX(0.3518518519rem)}7.3333333333%{clip:rect(0.12rem, 99999px, 5.5rem, 0);transform:skew(13.7deg);transform:translateX(0.3888888889rem)}8%{clip:rect(0.18rem, 99999px, 6rem, 0);transform:skew(6deg);transform:translateX(-0.1666666667rem)}8.6666666667%{clip:rect(0.16rem, 99999px, 6.5rem, 0);transform:skew(11.5deg);transform:translateX(0.3888888889rem)}9.3333333333%{clip:rect(0.1rem, 99999px, 2.6rem, 0);transform:skew(2.6deg);transform:translateX(0.2777777778rem)}10%{clip:rect(0.16rem, 99999px, 4.4rem, 0);transform:skew(2.6deg);transform:translateX(0.462962963rem)}10.6666666667%{clip:rect(0.04rem, 99999px, 1.9rem, 0);transform:skew(7.8deg);transform:translateX(0.1666666667rem)}11.3333333333%{clip:rect(0.2rem, 99999px, 6.8rem, 0);transform:skew(7.8deg);transform:translateX(0.4444444444rem)}12%{clip:rect(0.04rem, 99999px, 2.3rem, 0);transform:skew(10.3deg);transform:translateX(0.3888888889rem)}12.6666666667%{clip:rect(0.04rem, 99999px, 1rem, 0);transform:skew(15deg);transform:translateX(0.2777777778rem)}13.3333333333%{clip:rect(0.14rem, 99999px, 1.2rem, 0);transform:skew(8.5deg);transform:translateX(0.0555555556rem)}14%{clip:rect(0.18rem, 99999px, 9.8rem, 0);transform:skew(3.8deg);transform:translateX(0.3333333333rem)}14.6666666667%{clip:rect(0.02rem, 99999px, 8.7rem, 0);transform:skew(14.1deg);transform:translateX(0.2777777778rem)}15.3333333333%{clip:rect(0.14rem, 99999px, 7.7rem, 0);transform:skew(1.6deg);transform:translateX(0.4259259259rem)}16%{clip:rect(0.18rem, 99999px, 2.7rem, 0);transform:skew(11.1deg);transform:translateX(0.462962963rem)}16.6666666667%{clip:rect(0.14rem, 99999px, 5.5rem, 0);transform:skew(3.2deg);transform:translateX(0.462962963rem)}17.3333333333%{clip:rect(0.2rem, 99999px, 3.8rem, 0);transform:skew(8.1deg);transform:translateX(0.1666666667rem)}18%{clip:rect(0.12rem, 99999px, 1.3rem, 0);transform:skew(6deg);transform:translateX(0.2777777778rem)}18.6666666667%{clip:rect(0.08rem, 99999px, 6.6rem, 0);transform:skew(13.9deg);transform:translateX(0.2777777778rem)}19.3333333333%{clip:rect(0.14rem, 99999px, 9rem, 0);transform:skew(10.6deg);transform:translateX(0.3333333333rem)}20%{clip:rect(0.18rem, 99999px, 3.9rem, 0);transform:skew(12.8deg);transform:translateX(0.4259259259rem)}20.6666666667%{clip:rect(0.06rem, 99999px, 9.1rem, 0);transform:skew(0.4deg);transform:translateX(0.1666666667rem)}21.3333333333%{clip:rect(0.14rem, 99999px, 2.7rem, 0);transform:skew(2.6deg);transform:translateX(0.4814814815rem)}22%{clip:rect(0.12rem, 99999px, 2.6rem, 0);transform:skew(11deg);transform:translateX(0.2777777778rem)}22.6666666667%{clip:rect(0.2rem, 99999px, 4.7rem, 0);transform:skew(1.9deg);transform:translateX(0.4444444444rem)}23.3333333333%{clip:rect(0.2rem, 99999px, 9.3rem, 0);transform:skew(13.7deg);transform:translateX(0.1666666667rem)}24%{clip:rect(0.18rem, 99999px, 4.5rem, 0);transform:skew(14.3deg);transform:translateX(0.3518518519rem)}24.6666666667%{clip:rect(0.12rem, 99999px, 5.5rem, 0);transform:skew(1.2deg);transform:translateX(0.3333333333rem)}25.3333333333%{clip:rect(0.06rem, 99999px, 1.9rem, 0);transform:skew(7deg);transform:translateX(0.3888888889rem)}26%{clip:rect(0.02rem, 99999px, 2.6rem, 0);transform:skew(1.3deg);transform:translateX(0.2777777778rem)}26.6666666667%{clip:rect(0.06rem, 99999px, 10rem, 0);transform:skew(7.6deg);transform:translateX(-0.5rem)}27.3333333333%{clip:rect(0.04rem, 99999px, 4.4rem, 0);transform:skew(12.5deg);transform:translateX(0.3333333333rem)}28%{clip:rect(0.12rem, 99999px, 9.2rem, 0);transform:skew(0.3deg);transform:translateX(0.4444444444rem)}28.6666666667%{clip:rect(0.16rem, 99999px, 1.3rem, 0);transform:skew(5.2deg);transform:translateX(-0.5rem)}29.3333333333%{clip:rect(0.1rem, 99999px, 4.8rem, 0);transform:skew(7.7deg);transform:translateX(0.1666666667rem)}30%{clip:rect(0.1rem, 99999px, 9.7rem, 0);transform:skew(4.1deg);transform:translateX(0.462962963rem)}30.6666666667%{clip:rect(0.04rem, 99999px, 1.8rem, 0);transform:skew(2.1deg);transform:translateX(0.462962963rem)}31.3333333333%{clip:rect(0.16rem, 99999px, 9.5rem, 0);transform:skew(4.6deg);transform:translateX(0.4259259259rem)}32%{clip:rect(0.2rem, 99999px, 0.7rem, 0);transform:skew(10.7deg);transform:translateX(0.3518518519rem)}32.6666666667%{clip:rect(0.12rem, 99999px, 2.8rem, 0);transform:skew(9.7deg);transform:translateX(0.4259259259rem)}33.3333333333%{clip:rect(0.06rem, 99999px, 9.8rem, 0);transform:skew(7.7deg);transform:translateX(0.4259259259rem)}34%{clip:rect(0.14rem, 99999px, 7rem, 0);transform:skew(4.7deg);transform:translateX(0.2777777778rem)}34.6666666667%{clip:rect(0.06rem, 99999px, 9.6rem, 0);transform:skew(2.8deg);transform:translateX(0.0555555556rem)}35.3333333333%{clip:rect(0.2rem, 99999px, 4.6rem, 0);transform:skew(4.3deg);transform:translateX(-0.5rem)}36%{clip:rect(0.18rem, 99999px, 2rem, 0);transform:skew(4.9deg);transform:translateX(0.1666666667rem)}36.6666666667%{clip:rect(0.16rem, 99999px, 2.8rem, 0);transform:skew(3.5deg);transform:translateX(0.3518518519rem)}37.3333333333%{clip:rect(0.02rem, 99999px, 5.5rem, 0);transform:skew(4.4deg);transform:translateX(0.0555555556rem)}38%{clip:rect(0.1rem, 99999px, 8.6rem, 0);transform:skew(5.5deg);transform:translateX(-0.1666666667rem)}38.6666666667%{clip:rect(0.12rem, 99999px, 9.1rem, 0);transform:skew(11.6deg);transform:translateX(0.3333333333rem)}39.3333333333%{clip:rect(0.08rem, 99999px, 0.1rem, 0);transform:skew(2.7deg);transform:translateX(0.0555555556rem)}40%{clip:rect(0.06rem, 99999px, 0.3rem, 0);transform:skew(14.7deg);transform:translateX(0.3888888889rem)}40.6666666667%{clip:rect(0.2rem, 99999px, 7.4rem, 0);transform:skew(1.9deg);transform:translateX(0.3518518519rem)}41.3333333333%{clip:rect(0.04rem, 99999px, 9.2rem, 0);transform:skew(12deg);transform:translateX(-0.1666666667rem)}42%{clip:rect(0.12rem, 99999px, 9.9rem, 0);transform:skew(3.6deg);transform:translateX(0.4444444444rem)}42.6666666667%{clip:rect(0.2rem, 99999px, 4.9rem, 0);transform:skew(13.7deg);transform:translateX(0.4444444444rem)}43.3333333333%{clip:rect(0.12rem, 99999px, 6.7rem, 0);transform:skew(6.3deg);transform:translateX(0.3333333333rem)}44%{clip:rect(0.08rem, 99999px, 5.1rem, 0);transform:skew(11.6deg);transform:translateX(0.2777777778rem)}44.6666666667%{clip:rect(0.18rem, 99999px, 2.3rem, 0);transform:skew(9.5deg);transform:translateX(-0.1666666667rem)}45.3333333333%{clip:rect(0.08rem, 99999px, 2.6rem, 0);transform:skew(5.3deg);transform:translateX(0.0555555556rem)}46%{clip:rect(0.18rem, 99999px, 1.3rem, 0);transform:skew(8.3deg);transform:translateX(0.3888888889rem)}46.6666666667%{clip:rect(0.12rem, 99999px, 6.5rem, 0);transform:skew(8.6deg);transform:translateX(0.3518518519rem)}47.3333333333%{clip:rect(0.02rem, 99999px, 1rem, 0);transform:skew(9deg);transform:translateX(0.1666666667rem)}48%{clip:rect(0.1rem, 99999px, 8.6rem, 0);transform:skew(6.6deg);transform:translateX(0.462962963rem)}48.6666666667%{clip:rect(0.02rem, 99999px, 4.9rem, 0);transform:skew(15deg);transform:translateX(0.3888888889rem)}49.3333333333%{clip:rect(0.06rem, 99999px, 3.6rem, 0);transform:skew(12.7deg);transform:translateX(0.2777777778rem)}50%{clip:rect(0.02rem, 99999px, 3.9rem, 0);transform:skew(6.6deg);transform:translateX(-0.1666666667rem)}50.6666666667%{clip:rect(0.08rem, 99999px, 3.8rem, 0);transform:skew(5.9deg);transform:translateX(0.1666666667rem)}51.3333333333%{clip:rect(0.2rem, 99999px, 8.5rem, 0);transform:skew(5.7deg);transform:translateX(0.0555555556rem)}52%{clip:rect(0.16rem, 99999px, 5rem, 0);transform:skew(11.9deg);transform:translateX(-0.1666666667rem)}52.6666666667%{clip:rect(0.12rem, 99999px, 5.8rem, 0);transform:skew(10.1deg);transform:translateX(0.2777777778rem)}53.3333333333%{clip:rect(0.2rem, 99999px, 2.2rem, 0);transform:skew(6.8deg);transform:translateX(0.2777777778rem)}54%{clip:rect(0.2rem, 99999px, 0.2rem, 0);transform:skew(1.4deg);transform:translateX(0.4444444444rem)}54.6666666667%{clip:rect(0.2rem, 99999px, 8.6rem, 0);transform:skew(3.1deg);transform:translateX(0.0555555556rem)}55.3333333333%{clip:rect(0.14rem, 99999px, 8.6rem, 0);transform:skew(2.6deg);transform:translateX(-0.1666666667rem)}56%{clip:rect(0.04rem, 99999px, 6.2rem, 0);transform:skew(10.9deg);transform:translateX(-0.5rem)}56.6666666667%{clip:rect(0.14rem, 99999px, 2.5rem, 0);transform:skew(13.9deg);transform:translateX(0.3888888889rem)}57.3333333333%{clip:rect(0.06rem, 99999px, 8.7rem, 0);transform:skew(10.8deg);transform:translateX(0.3518518519rem)}58%{clip:rect(0.14rem, 99999px, 1.1rem, 0);transform:skew(10.5deg);transform:translateX(0.1666666667rem)}58.6666666667%{clip:rect(0.04rem, 99999px, 3rem, 0);transform:skew(7.4deg);transform:translateX(-0.1666666667rem)}59.3333333333%{clip:rect(0.12rem, 99999px, 2.3rem, 0);transform:skew(1.2deg);transform:translateX(0.4814814815rem)}60%{clip:rect(0.04rem, 99999px, 4.3rem, 0);transform:skew(4.6deg);transform:translateX(0.2777777778rem)}60.6666666667%{clip:rect(0.14rem, 99999px, 7.7rem, 0);transform:skew(2deg);transform:translateX(0.4444444444rem)}61.3333333333%{clip:rect(0.04rem, 99999px, 8.4rem, 0);transform:skew(9deg);transform:translateX(0.4259259259rem)}62%{clip:rect(0.16rem, 99999px, 3.5rem, 0);transform:skew(5deg);transform:translateX(0.3888888889rem)}62.6666666667%{clip:rect(0.12rem, 99999px, 7.3rem, 0);transform:skew(8.3deg);transform:translateX(0.2777777778rem)}63.3333333333%{clip:rect(0.14rem, 99999px, 1.5rem, 0);transform:skew(7deg);transform:translateX(0.4259259259rem)}64%{clip:rect(0.2rem, 99999px, 1.3rem, 0);transform:skew(8.6deg);transform:translateX(0.3888888889rem)}64.6666666667%{clip:rect(0.2rem, 99999px, 3.2rem, 0);transform:skew(0.7deg);transform:translateX(0.2777777778rem)}65.3333333333%{clip:rect(0.04rem, 99999px, 1.9rem, 0);transform:skew(9deg);transform:translateX(-0.1666666667rem)}66%{clip:rect(0.02rem, 99999px, 6.5rem, 0);transform:skew(3.4deg);transform:translateX(0.2777777778rem)}66.6666666667%{clip:rect(0.2rem, 99999px, 7rem, 0);transform:skew(2.2deg);transform:translateX(0.1666666667rem)}67.3333333333%{clip:rect(0.16rem, 99999px, 9.1rem, 0);transform:skew(13.9deg);transform:translateX(0.4444444444rem)}68%{clip:rect(0.14rem, 99999px, 7.7rem, 0);transform:skew(1.8deg);transform:translateX(0.1666666667rem)}68.6666666667%{clip:rect(0.04rem, 99999px, 10rem, 0);transform:skew(10.1deg);transform:translateX(0.3888888889rem)}69.3333333333%{clip:rect(0.1rem, 99999px, 1.9rem, 0);transform:skew(0.6deg);transform:translateX(0.4444444444rem)}70%{clip:rect(0.1rem, 99999px, 6.7rem, 0);transform:skew(0.2deg);transform:translateX(0.2777777778rem)}70.6666666667%{clip:rect(0.2rem, 99999px, 1rem, 0);transform:skew(9.3deg);transform:translateX(0.1666666667rem)}71.3333333333%{clip:rect(0.02rem, 99999px, 3.2rem, 0);transform:skew(12.6deg);transform:translateX(0.2777777778rem)}72%{clip:rect(0.06rem, 99999px, 0.4rem, 0);transform:skew(7.5deg);transform:translateX(0.4444444444rem)}72.6666666667%{clip:rect(0.12rem, 99999px, 0.9rem, 0);transform:skew(2.9deg);transform:translateX(0.2777777778rem)}73.3333333333%{clip:rect(0.18rem, 99999px, 5.7rem, 0);transform:skew(8.3deg);transform:translateX(0.1666666667rem)}74%{clip:rect(0.08rem, 99999px, 5.6rem, 0);transform:skew(13.5deg);transform:translateX(-0.5rem)}74.6666666667%{clip:rect(0.06rem, 99999px, 8.6rem, 0);transform:skew(2.4deg);transform:translateX(0.3888888889rem)}75.3333333333%{clip:rect(0.12rem, 99999px, 9.1rem, 0);transform:skew(1.1deg);transform:translateX(0.4814814815rem)}76%{clip:rect(0.2rem, 99999px, 3.4rem, 0);transform:skew(15deg);transform:translateX(0.462962963rem)}76.6666666667%{clip:rect(0.02rem, 99999px, 8.4rem, 0);transform:skew(5.2deg);transform:translateX(0.3888888889rem)}77.3333333333%{clip:rect(0.04rem, 99999px, 5.4rem, 0);transform:skew(13.2deg);transform:translateX(0.1666666667rem)}78%{clip:rect(0.18rem, 99999px, 1.3rem, 0);transform:skew(7.5deg);transform:translateX(0.3518518519rem)}78.6666666667%{clip:rect(0.14rem, 99999px, 3.6rem, 0);transform:skew(2.7deg);transform:translateX(0.3888888889rem)}79.3333333333%{clip:rect(0.12rem, 99999px, 1.8rem, 0);transform:skew(3.8deg);transform:translateX(0.1666666667rem)}80%{clip:rect(0.2rem, 99999px, 2.3rem, 0);transform:skew(5.7deg);transform:translateX(0.3333333333rem)}80.6666666667%{clip:rect(0.2rem, 99999px, 2.4rem, 0);transform:skew(8.8deg);transform:translateX(0.3518518519rem)}81.3333333333%{clip:rect(0.14rem, 99999px, 1.1rem, 0);transform:skew(13.5deg);transform:translateX(0.3518518519rem)}82%{clip:rect(0.16rem, 99999px, 1.7rem, 0);transform:skew(9.5deg);transform:translateX(0.2777777778rem)}82.6666666667%{clip:rect(0.2rem, 99999px, 2.4rem, 0);transform:skew(5.9deg);transform:translateX(-0.1666666667rem)}83.3333333333%{clip:rect(0.12rem, 99999px, 6.5rem, 0);transform:skew(11.4deg);transform:translateX(0.2777777778rem)}84%{clip:rect(0.2rem, 99999px, 6.2rem, 0);transform:skew(8deg);transform:translateX(0.3518518519rem)}84.6666666667%{clip:rect(0.1rem, 99999px, 4.6rem, 0);transform:skew(4.8deg);transform:translateX(0.4444444444rem)}85.3333333333%{clip:rect(0.1rem, 99999px, 7.3rem, 0);transform:skew(7.5deg);transform:translateX(0.2777777778rem)}86%{clip:rect(0.08rem, 99999px, 10rem, 0);transform:skew(1.7deg);transform:translateX(0.462962963rem)}86.6666666667%{clip:rect(0.18rem, 99999px, 6.5rem, 0);transform:skew(14.8deg);transform:translateX(0rem)}87.3333333333%{clip:rect(0.2rem, 99999px, 3.5rem, 0);transform:skew(14.7deg);transform:translateX(-0.1666666667rem)}88%{clip:rect(0.08rem, 99999px, 1.6rem, 0);transform:skew(0.7deg);transform:translateX(0.3888888889rem)}88.6666666667%{clip:rect(0.14rem, 99999px, 4.5rem, 0);transform:skew(8.3deg);transform:translateX(0.462962963rem)}89.3333333333%{clip:rect(0.16rem, 99999px, 8.7rem, 0);transform:skew(3.4deg);transform:translateX(0.4444444444rem)}90%{clip:rect(0.06rem, 99999px, 4.8rem, 0);transform:skew(9.7deg);transform:translateX(0.2777777778rem)}90.6666666667%{clip:rect(0.16rem, 99999px, 8.5rem, 0);transform:skew(12.1deg);transform:translateX(0.462962963rem)}91.3333333333%{clip:rect(0.16rem, 99999px, 9.6rem, 0);transform:skew(9.2deg);transform:translateX(0.462962963rem)}92%{clip:rect(0.08rem, 99999px, 8.6rem, 0);transform:skew(7.7deg);transform:translateX(0.3888888889rem)}92.6666666667%{clip:rect(0.12rem, 99999px, 5.6rem, 0);transform:skew(2deg);transform:translateX(0.3518518519rem)}93.3333333333%{clip:rect(0.1rem, 99999px, 2.3rem, 0);transform:skew(6.1deg);transform:translateX(0.1666666667rem)}94%{clip:rect(0.06rem, 99999px, 2.7rem, 0);transform:skew(14.1deg);transform:translateX(0.462962963rem)}94.6666666667%{clip:rect(0.18rem, 99999px, 1rem, 0);transform:skew(8.4deg);transform:translateX(0.3888888889rem)}95.3333333333%{clip:rect(0.2rem, 99999px, 5rem, 0);transform:skew(9.8deg);transform:translateX(0.4259259259rem)}96%{clip:rect(0.04rem, 99999px, 0.7rem, 0);transform:skew(3.4deg);transform:translateX(-0.1666666667rem)}96.6666666667%{clip:rect(0.2rem, 99999px, 0.2rem, 0);transform:skew(8.9deg);transform:translateX(0.1666666667rem)}97.3333333333%{clip:rect(0.02rem, 99999px, 5.2rem, 0);transform:skew(14deg);transform:translateX(0.1666666667rem)}98%{clip:rect(0.14rem, 99999px, 1.7rem, 0);transform:skew(11.7deg);transform:translateX(0.4444444444rem)}98.6666666667%{clip:rect(0.1rem, 99999px, 4.2rem, 0);transform:skew(9.7deg);transform:translateX(0.2777777778rem)}99.3333333333%{clip:rect(0.04rem, 99999px, 1.1rem, 0);transform:skew(4.4deg);transform:translateX(0.3888888889rem)}}@keyframes svelte-ebv4xl-glitch-skew{0%{transform:skew(-4deg)}10%{transform:skew(0deg)}20%{transform:skew(0deg)}30%{transform:skew(5deg)}40%{transform:skew(-4deg)}50%{transform:skew(2deg)}60%{transform:skew(0deg)}70%{transform:skew(3deg)}80%{transform:skew(0deg)}90%{transform:skew(5deg)}}#bar.svelte-ebv4xl .logo.hover-effect-1.logo-behind-a.svelte-ebv4xl{color:white;transform:translateX(-0.5rem);color:#ffc800 !important;text-shadow:-2px 0 #ffc800, 2px 2px #ffc800;clip:rect(44px, 450px, 56px, 0);animation:svelte-ebv4xl-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-ebv4xl .logo.hover-effect-1.logo-behind-b.svelte-ebv4xl{color:rgb(165, 49, 49) !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #aa10f2;clip:rect(44px, 450px, 56px, 0);animation:svelte-ebv4xl-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-ebv4xl .logo.logo-behind.svelte-ebv4xl{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-ebv4xl .logo.logo-behind.svelte-ebv4xl:not(.hovered){display:none}#bar.svelte-ebv4xl #menus.svelte-ebv4xl{margin-left:auto;display:flex}#bar.svelte-ebv4xl #menus #menu.svelte-ebv4xl{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-ebv4xl #menus #menu.svelte-ebv4xl .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQmFyLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUE2RWtCIiwibmFtZXMiOltdLCJzb3VyY2VzIjpbIkJhci5zdmVsdGUiXX0= */");
}
...
function Bar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a0, "href", "./");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[1] + " svelte-ebv4xl");
			add_location(a0, Bar_svelte_file, 1, 1, 17);
			attr_dev(a1, "href", "./");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[1] + " svelte-ebv4xl");
			add_location(a1, Bar_svelte_file, 4, 1, 107);
			attr_dev(a2, "href", "./");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[1] + " svelte-ebv4xl");
			add_location(a2, Bar_svelte_file, 7, 1, 197);
			attr_dev(div0, "id", "menu");
			attr_dev(div0, "class", "svelte-ebv4xl");
			add_location(div0, Bar_svelte_file, 11, 2, 306);
			attr_dev(div1, "id", "menu");
			attr_dev(div1, "class", "svelte-ebv4xl");
			add_location(div1, Bar_svelte_file, 19, 2, 606);
			attr_dev(div2, "id", "menus");
			attr_dev(div2, "class", "svelte-ebv4xl");
			add_location(div2, Bar_svelte_file, 10, 1, 286);
			attr_dev(div3, "id", "bar");
			attr_dev(div3, "class", "svelte-ebv4xl");
		...
		p: function update(ctx, [dirty]) {
			if (!current || dirty & /*hovered_class*/ 2 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[1] + " svelte-ebv4xl")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 2 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[1] + " svelte-ebv4xl")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 2 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[1] + " svelte-ebv4xl")) {
...
class FavDemos extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, FavDemos_svelte_instance, FavDemos_svelte_create_fragment, safe_not_equal, { url: 4 }, FavDemos_svelte_add_css);
...
/* harmony default export */ const FavDemos_svelte = (FavDemos);
...
class Music extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, music_svelte_instance, music_svelte_create_fragment, safe_not_equal, { url: 1 }, music_svelte_add_css);
...
/* harmony default export */ const music_svelte = (Music);
...
function fallback_block(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*scaledImages*/ 16) switch_instance_changes["data-src"] = /*image*/ ctx[20].src;
...
function Gallery_svelte_create_fragment(ctx) {
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*imgStyle, scaledImages, open_image_callback, imageComponent, $$scope*/ 565) {
...
function index_svelte_add_css(target) {
	append_styles(target, "svelte-bmpzgc", ".container.svelte-bmpzgc{width:100%;height:100%;position:fixed;display:flex;flex-direction:column;align-items:center;width:100vw;height:100vh;left:0;top:0;z-index:100;background:black}.c-svelteZoom.svelte-bmpzgc{width:100%;height:100%;position:absolute;transform-origin:0 0;backface-visibility:hidden;-webkit-backface-visibility:hidden;-moz-backface-visibility:hidden;-o-backface-visibility:hidden;-ms-backface-visibility:hidden;-webkit-user-drag:none;-moz-user-drag:none;-o-user-drag:none;user-drag:none;touch-action:none}.c-svelteZoom--contain.svelte-bmpzgc{object-fit:contain}.c-svelteZoom--no-contain.svelte-bmpzgc{object-fit:contain}.c-svelteZoom--transition.svelte-bmpzgc{transition:transform 0.2s}.c-svelteZoom--visible.svelte-bmpzgc{visibility:visible}.c-svelteZoom--hidden.svelte-bmpzgc{visibility:hidden}.c-svelteZoom--willChange.svelte-bmpzgc{will-change:transform}.close-button.svelte-bmpzgc{z-index:1;background:black;position:absolute;right:1rem;cursor:pointer}.close-button.svelte-bmpzgc:hover{filter:invert(1)}.close-button.svelte-bmpzgc svg{fill:white;stroke:white;aspect-ratio:1/1;width:6rem}.hidden.svelte-bmpzgc{display:none}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiaW5kZXguc3ZlbHRlIiwibWFwcGluZ3MiOiJBQWtXa0IiLCJuYW1lcyI6W10sInNvdXJjZXMiOlsiaW5kZXguc3ZlbHRlIl19 */");
}
...
class Art extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, art_svelte_instance, art_svelte_create_fragment, safe_not_equal, { url: 5 }, art_svelte_add_css);
...
function Projects_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (!src_url_equal(img0.src, img0_src_value = "./images/paintings/adsg.png")) attr_dev(img0, "src", img0_src_value);
			attr_dev(img0, "height", "355.5rem");
			add_location(img0, Projects_file, 24, 3, 965);
			if (!src_url_equal(img1.src, img1_src_value = "./images/paintings/1689957895824_2 (1).png")) attr_dev(img1, "src", img1_src_value);
			attr_dev(img1, "height", "355.5rem");
			add_location(img1, Projects_file, 25, 3, 1028);
			if (!src_url_equal(img2.src, img2_src_value = "./images/paintings/1690037672960_1 (1).png")) attr_dev(img2, "src", img2_src_value);
			attr_dev(img2, "height", "300.5rem");
			add_location(img2, Projects_file, 26, 3, 1107);
			if (!src_url_equal(img3.src, img3_src_value = "./images/paintings/1690102042507_1[1].png")) attr_dev(img3, "src", img3_src_value);
			attr_dev(img3, "height", "300.5rem");
			add_location(img3, Projects_file, 27, 3, 1187);
...
class Projects extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, Projects_instance, Projects_create_fragment, safe_not_equal, {}, Projects_add_css);
...
class About extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, About_svelte_instance, About_svelte_create_fragment, safe_not_equal, {}, About_svelte_add_css);
...
function Splash_svelte_instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		...
		const noise_tex = await Texture.from_image_path((__webpack_require__(304)/* ["default"] */ .Z));
...
function App_svelte_add_css(target) {
	append_styles(target, "svelte-wc2ns3", "*{font-family:\"Petrona\";font-weight:400;color:black}*::selection{background:black;color:white}a{text-decoration:underline;text-decoration-style:dashed;text-underline-offset:0.2rem}a:hover{color:white !important;background:black;text-decoration:none}a:hover *{color:white !important;text-decoration:none}.menu-item{text-decoration:none;font-weight:900}#logo{text-decoration:none}::-webkit-scrollbar{background:black}::-webkit-scrollbar-track{background:white}::-webkit-scrollbar-thumb{background:black}main{width:100%;max-width:40rem;height:100%;display:flex;flex-direction:column;max-width:var(--main-max-width);margin-right:auto;margin-left:auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiQXBwLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUFrRGtCIiwibmFtZXMiOltdLCJzb3VyY2VzIjpbIkFwcC5zdmVsdGUiXX0= */");
}
...
function create_if_block_4(ctx) {
	let about;
	let current;
	about = new About_svelte({ $$inline: true });
...
function create_if_block_3(ctx) {
	let projects;
	let current;
	projects = new components_Projects({ $$inline: true });
...
function create_if_block_2(ctx) {
	let art;
	let current;
	art = new art_svelte({ $$inline: true });
...
function App_svelte_create_if_block_1(ctx) {
	let music;
	let current;
	music = new music_svelte({ $$inline: true });
...
function App_svelte_create_if_block(ctx) {
	let favdemos;
	let current;
	favdemos = new FavDemos_svelte({ $$inline: true });
...
function App_svelte_instance($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({
		...
		Link: src_Link_svelte,
		Route: Route_svelte,
		FavDemos: FavDemos_svelte,
		Music: music_svelte,
		Art: art_svelte,
		Projects: components_Projects,
		About: About_svelte,
