...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 47, 0, 1794);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 61, 0, 2352);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, a, anchor);
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(p1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 30, 0, 1320);
			add_location(brb2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 31, 0, 1396);
			add_location(brb3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 32, 0, 1404);
			add_location(brb4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 49, 0, 1899);
			attr_dev(a2, "href", "https://en.wikipedia.org/wiki/Implicit_surface");
			attr_dev(a2, "rel", "nofollow");
			add_location(a2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 50, 0, 1984);
			add_location(p2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 50, 0, 1907);
			add_location(brb5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 57, 0, 2260);
			add_location(brb6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 58, 0, 2268);
			add_location(brb7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 63, 0, 2416);
			add_location(br, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 64, 0, 2499);
			attr_dev(a3, "href", "https://web.archive.org/web/20040131013212/http://lycium.cfxweb.net/");
			attr_dev(a3, "rel", "nofollow");
			add_location(a3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 65, 0, 2523);
			attr_dev(a4, "href", "https://www.deviantart.com/lyc");
			add_location(a4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 68, 6, 2681);
			add_location(p3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 64, 0, 2424);
			add_location(p4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 69, 0, 2738);
			add_location(wbr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 70, 0, 2854);
			add_location(hr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 72, 2, 2888);
			attr_dev(a5, "href", "https://cs.dartmouth.edu/wjarosz/publications/jarosz12theory.html");
			add_location(a5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 74, 0, 2911);
			add_location(brb8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 74, 0, 3105);
			attr_dev(a6, "href", "https://en.wikipedia.org/wiki/Irradiance");
			add_location(a6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 75, 7, 3122);
			add_location(ol0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 73, 2, 2897);
			add_location(hr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 77, 2, 3356);
			attr_dev(div, "class", "footnotes");
			add_location(div, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 71, 0, 2862);
			add_location(wbr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 79, 0, 3370);
			add_location(strong1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 80, 0, 3382);
			add_location(h21, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 80, 0, 3378);
			add_location(p5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 81, 0, 3413);
			add_location(brb9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 82, 0, 3566);
			add_location(brb10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 88, 0, 3799);
			add_location(p6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 89, 0, 3807);
			add_location(li0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 91, 0, 3849);
			add_location(li1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 92, 0, 3930);
			add_location(li2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 93, 0, 4024);
			add_location(li3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 94, 0, 4112);
			add_location(ol1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 90, 0, 3844);
			add_location(p7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 96, 0, 4239);
			add_location(wbr2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 97, 0, 4275);
			attr_dev(pre0, "class", "language-glsl");
			add_location(pre0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 98, 0, 4283);
			add_location(brb11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 142, 0, 10672);
			add_location(strong2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 143, 0, 10684);
			add_location(h22, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 143, 0, 10680);
			add_location(wbr3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 144, 0, 10721);
			attr_dev(pre1, "class", "language-undefined");
			add_location(pre1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 145, 0, 10729);
			attr_dev(a7, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 147, 1, 10924);
			attr_dev(a8, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 152, 5, 11198);
			add_location(li4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 147, 0, 10884);
			add_location(li5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 157, 0, 11374);
			add_location(li6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 159, 0, 11991);
			add_location(ul, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 146, 0, 10879);
			attr_dev(a9, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a9, "rel", "nofollow");
			add_location(a9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 162, 19, 12124);
			add_location(p8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 162, 0, 12104);
			add_location(wbr4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 166, 0, 12234);
			add_location(strong3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 167, 4, 12246);
			add_location(h23, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 167, 0, 12242);
			add_location(brb12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 171, 0, 12425);
			attr_dev(a10, "href", "https://www.shadertoy.com/view/4dX3zl");
			add_location(a10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 173, 0, 12458);
			add_location(p9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 168, 0, 12282);
			add_location(brb13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 177, 0, 12687);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 178, 0, 12697);
			add_location(brb14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 203, 0, 19970);
			attr_dev(pre3, "class", "language-glsl");
			add_location(pre3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 204, 0, 19977);
			attr_dev(a11, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 205, 6, 20307);
			attr_dev(a12, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 208, 47, 20450);
			add_location(p10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 205, 0, 20298);
			attr_dev(a13, "href", "https://registry.khronos.org/OpenGL/extensions/NV/NV_shader_atomic_float.txt");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 212, 58, 20706);
			attr_dev(a14, "href", "https://en.wikipedia.org/wiki/Compare-and-swap");
			attr_dev(a14, "rel", "nofollow");
			add_location(a14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 216, 1, 20842);
			add_location(p11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 212, 0, 20624);
			add_location(brb15, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 220, 0, 20955);
			add_location(strong4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 221, 0, 20966);
			add_location(h24, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 221, 0, 20962);
			add_location(p12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 222, 0, 21000);
...
function NavBar_svelte_add_css(target) {
	append_styles(target, "svelte-1my4ea4", "#bar.svelte-1my4ea4.svelte-1my4ea4{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-1my4ea4 #bar-left.svelte-1my4ea4{display:flex;flex-direction:column}#bar.svelte-1my4ea4 mark.svelte-1my4ea4{background:var(--accent-dark)}#bar.svelte-1my4ea4 .logo.svelte-1my4ea4{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-1my4ea4 .logo.logo-behind.svelte-1my4ea4{position:absolute}#bar.svelte-1my4ea4 .logo.hovered.svelte-1my4ea4{color:var(--accent-dark) !important}#bar.svelte-1my4ea4 .logo.hovered.hover-effect-0.svelte-1my4ea4{animation:svelte-1my4ea4-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-1my4ea4-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-1my4ea4-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-1my4ea4-glitch-anim3{0%{clip:rect(2rem, 9999px, 3.5rem, 0);transform-origin:center}2%{clip:rect(4rem, 9999px, 1rem, 0);transform-origin:center}4%{clip:rect(3.4rem, 9999px, 4rem, 0);transform-origin:center}6%{clip:rect(0.9rem, 9999px, 3.5rem, 0);transform-origin:center}8%{clip:rect(3.7rem, 9999px, 3rem, 0);transform-origin:center}10%{clip:rect(2rem, 9999px, 4.5rem, 0);transform-origin:center}12%{clip:rect(3.9rem, 9999px, 2.5rem, 0);transform-origin:center}14%{clip:rect(2rem, 9999px, 4rem, 0);transform-origin:center}16%{clip:rect(0.3rem, 9999px, 0.5rem, 0);transform-origin:center}18%{clip:rect(1.5rem, 9999px, 5rem, 0);transform-origin:center}20%{clip:rect(0.1rem, 9999px, 3.5rem, 0);transform-origin:center}22%{clip:rect(3.8rem, 9999px, 1.5rem, 0);transform-origin:center}24%{clip:rect(3.9rem, 9999px, 4.5rem, 0);transform-origin:center}26%{clip:rect(2.7rem, 9999px, 0.5rem, 0);transform-origin:center}28%{clip:rect(2.6rem, 9999px, 1rem, 0);transform-origin:center}30%{clip:rect(1.8rem, 9999px, 5rem, 0);transform-origin:center}32%{clip:rect(1.6rem, 9999px, 4rem, 0);transform-origin:center}34%{clip:rect(1.4rem, 9999px, 4rem, 0);transform-origin:center}36%{clip:rect(3.6rem, 9999px, 3.5rem, 0);transform-origin:center}38%{clip:rect(2.9rem, 9999px, 1.5rem, 0);transform-origin:center}40%{clip:rect(3rem, 9999px, 4rem, 0);transform-origin:center}42%{clip:rect(3.3rem, 9999px, 3.5rem, 0);transform-origin:center}44%{clip:rect(2.3rem, 9999px, 3.5rem, 0);transform-origin:center}46%{clip:rect(0.7rem, 9999px, 4.5rem, 0);transform-origin:center}48%{clip:rect(3.2rem, 9999px, 4rem, 0);transform-origin:center}50%{clip:rect(2.4rem, 9999px, 3rem, 0);transform-origin:center}52%{clip:rect(3.4rem, 9999px, 3.5rem, 0);transform-origin:center}54%{clip:rect(4rem, 9999px, 2.5rem, 0);transform-origin:center}56%{clip:rect(2.8rem, 9999px, 5rem, 0);transform-origin:center}58%{clip:rect(2.9rem, 9999px, 4.5rem, 0);transform-origin:center}60%{clip:rect(3.6rem, 9999px, 3rem, 0);transform-origin:center}62%{clip:rect(1rem, 9999px, 3.5rem, 0);transform-origin:center}64%{clip:rect(4rem, 9999px, 5rem, 0);transform-origin:center}66%{clip:rect(1.5rem, 9999px, 0.5rem, 0);transform-origin:center}68%{clip:rect(2.2rem, 9999px, 1.5rem, 0);transform-origin:center}70%{clip:rect(3.6rem, 9999px, 3.5rem, 0);transform-origin:center}72%{clip:rect(0.1rem, 9999px, 2rem, 0);transform-origin:center}74%{clip:rect(0.8rem, 9999px, 2.5rem, 0);transform-origin:center}76%{clip:rect(2.6rem, 9999px, 5rem, 0);transform-origin:center}78%{clip:rect(1.1rem, 9999px, 5rem, 0);transform-origin:center}80%{clip:rect(0.2rem, 9999px, 4rem, 0);transform-origin:center}82%{clip:rect(3.8rem, 9999px, 2rem, 0);transform-origin:center}84%{clip:rect(1.5rem, 9999px, 4.5rem, 0);transform-origin:center}86%{clip:rect(0.2rem, 9999px, 0.5rem, 0);transform-origin:center}88%{clip:rect(0.8rem, 9999px, 2rem, 0);transform-origin:center}90%{clip:rect(3.5rem, 9999px, 4rem, 0);transform-origin:center}92%{clip:rect(0.3rem, 9999px, 5rem, 0);transform-origin:center}94%{clip:rect(1.4rem, 9999px, 3rem, 0);transform-origin:center}96%{clip:rect(2rem, 9999px, 0.5rem, 0);transform-origin:center}98%{clip:rect(3rem, 9999px, 1.5rem, 0);transform-origin:center}}@keyframes svelte-1my4ea4-cooool{0%{color:pink !important}2%{color:pink !important}4%{color:pink !important}6%{color:pink !important}8%{color:pink !important}10%{color:pink !important}12%{color:pink !important}14%{color:pink !important}16%{color:pink !important}18%{color:pink !important}20%{color:pink !important}22%{color:pink !important}24%{color:pink !important}26%{color:pink !important}28%{color:pink !important}30%{color:pink !important}32%{color:pink !important}34%{color:pink !important}36%{color:pink !important}38%{color:pink !important}40%{color:pink !important}42%{color:pink !important}44%{color:pink !important}46%{color:pink !important}48%{color:pink !important}50%{color:pink !important}52%{color:pink !important}54%{color:pink !important}56%{color:pink !important}58%{color:pink !important}60%{color:pink !important}62%{color:pink !important}64%{color:pink !important}66%{color:pink !important}68%{color:pink !important}70%{color:pink !important}72%{color:pink !important}74%{color:pink !important}76%{color:pink !important}78%{color:pink !important}80%{color:pink !important}82%{color:pink !important}84%{color:pink !important}86%{color:pink !important}88%{color:pink !important}90%{color:pink !important}92%{color:pink !important}94%{color:pink !important}96%{color:pink !important}98%{color:pink !important}}#bar.svelte-1my4ea4 .logo.hovered.hover-effect-0.logo-behind-a.svelte-1my4ea4{color:#ff5500 !important;animation:svelte-1my4ea4-distort1 300ms linear infinite, svelte-1my4ea4-glitch-anim3 5s infinite linear alternate-reverse, svelte-1my4ea4-cooool 5s infinite linear alternate-reverse}#bar.svelte-1my4ea4 .logo.hovered.hover-effect-0.logo-behind-b.svelte-1my4ea4{color:#450f8b !important;animation:svelte-1my4ea4-distort2 300ms linear infinite, svelte-1my4ea4-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-1my4ea4 .logo.hover-effect-1.svelte-1my4ea4{animation:svelte-1my4ea4-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-1my4ea4-glitch-anim{0%{clip:rect(3.6rem, 9999px, 4.5rem, 0);transform:skew(0.4deg);z-index:3}2%{clip:rect(3.8rem, 9999px, 3.5rem, 0);transform:skew(1.4deg);z-index:1}4%{clip:rect(3.9rem, 9999px, 1rem, 0);transform:skew(7.2deg);z-index:1}6%{clip:rect(1rem, 9999px, 2rem, 0);transform:skew(7.7deg);z-index:2}8%{clip:rect(0.8rem, 9999px, 2rem, 0);transform:skew(4.3deg);z-index:1}10%{clip:rect(3rem, 9999px, 1rem, 0);transform:skew(3.7deg);z-index:3}12%{clip:rect(1.7rem, 9999px, 5rem, 0);transform:skew(7.7deg);z-index:1}14%{clip:rect(1rem, 9999px, 1rem, 0);transform:skew(3.4deg);z-index:1}16%{clip:rect(1.7rem, 9999px, 3rem, 0);transform:skew(9.1deg);z-index:2}18%{clip:rect(0.9rem, 9999px, 4.5rem, 0);transform:skew(2.6deg);z-index:3}20%{clip:rect(3.2rem, 9999px, 1.5rem, 0);transform:skew(8deg);z-index:4}22%{clip:rect(0.3rem, 9999px, 4.5rem, 0);transform:skew(2.4deg);z-index:4}24%{clip:rect(1.1rem, 9999px, 5rem, 0);transform:skew(6.5deg);z-index:1}26%{clip:rect(2.5rem, 9999px, 2rem, 0);transform:skew(3.5deg);z-index:4}28%{clip:rect(2.8rem, 9999px, 2rem, 0);transform:skew(1.2deg);z-index:4}30%{clip:rect(1.7rem, 9999px, 3.5rem, 0);transform:skew(6deg);z-index:2}32%{clip:rect(1.2rem, 9999px, 1.5rem, 0);transform:skew(5.5deg);z-index:4}34%{clip:rect(2.3rem, 9999px, 2.5rem, 0);transform:skew(0.6deg);z-index:3}36%{clip:rect(1.8rem, 9999px, 0.5rem, 0);transform:skew(7.4deg);z-index:4}38%{clip:rect(2.5rem, 9999px, 2rem, 0);transform:skew(7.6deg);z-index:1}40%{clip:rect(1.5rem, 9999px, 1rem, 0);transform:skew(2deg);z-index:1}42%{clip:rect(2.4rem, 9999px, 0.5rem, 0);transform:skew(6.4deg);z-index:3}44%{clip:rect(3rem, 9999px, 4.5rem, 0);transform:skew(3.6deg);z-index:4}46%{clip:rect(4rem, 9999px, 3rem, 0);transform:skew(1.2deg);z-index:1}48%{clip:rect(1.7rem, 9999px, 5rem, 0);transform:skew(1.1deg);z-index:4}50%{clip:rect(2.6rem, 9999px, 0.5rem, 0);transform:skew(8.5deg);z-index:1}52%{clip:rect(3rem, 9999px, 0.5rem, 0);transform:skew(2.7deg);z-index:2}54%{clip:rect(2.3rem, 9999px, 2.5rem, 0);transform:skew(4deg);z-index:4}56%{clip:rect(1.2rem, 9999px, 4rem, 0);transform:skew(6.7deg);z-index:1}58%{clip:rect(0.3rem, 9999px, 2rem, 0);transform:skew(2.9deg);z-index:4}60%{clip:rect(4rem, 9999px, 4.5rem, 0);transform:skew(9.6deg);z-index:1}62%{clip:rect(3.4rem, 9999px, 2.5rem, 0);transform:skew(6.1deg);z-index:2}64%{clip:rect(3.2rem, 9999px, 2.5rem, 0);transform:skew(1.4deg);z-index:3}66%{clip:rect(3.6rem, 9999px, 4rem, 0);transform:skew(5.2deg);z-index:1}68%{clip:rect(1.1rem, 9999px, 1rem, 0);transform:skew(8.3deg);z-index:2}70%{clip:rect(4rem, 9999px, 2.5rem, 0);transform:skew(1.1deg);z-index:2}72%{clip:rect(2.6rem, 9999px, 4rem, 0);transform:skew(7.7deg);z-index:4}74%{clip:rect(3.6rem, 9999px, 0.5rem, 0);transform:skew(6.2deg);z-index:2}76%{clip:rect(0.5rem, 9999px, 2rem, 0);transform:skew(8.9deg);z-index:3}78%{clip:rect(0.8rem, 9999px, 5rem, 0);transform:skew(8.5deg);z-index:1}80%{clip:rect(0.9rem, 9999px, 5rem, 0);transform:skew(2.1deg);z-index:1}82%{clip:rect(3.3rem, 9999px, 3.5rem, 0);transform:skew(7.3deg);z-index:4}84%{clip:rect(3.9rem, 9999px, 4rem, 0);transform:skew(8.3deg);z-index:4}86%{clip:rect(1.2rem, 9999px, 2rem, 0);transform:skew(9.2deg);z-index:1}88%{clip:rect(0.4rem, 9999px, 1.5rem, 0);transform:skew(7.4deg);z-index:3}90%{clip:rect(3.8rem, 9999px, 2rem, 0);transform:skew(2.4deg);z-index:1}92%{clip:rect(3.6rem, 9999px, 2rem, 0);transform:skew(5.8deg);z-index:1}94%{clip:rect(4rem, 9999px, 3rem, 0);transform:skew(2deg);z-index:2}96%{clip:rect(1.3rem, 9999px, 2rem, 0);transform:skew(3.6deg);z-index:2}98%{clip:rect(0.8rem, 9999px, 5rem, 0);transform:skew(8.7deg);z-index:3}}@keyframes svelte-1my4ea4-glitch-anim2{0%{clip:rect(0.16rem, 99999px, 3.4rem, 0)}0.6666666667%{clip:rect(0.16rem, 99999px, 8.8rem, 0)}1.3333333333%{clip:rect(0.1rem, 99999px, 6.5rem, 0)}2%{clip:rect(0.02rem, 99999px, 5.2rem, 0)}2.6666666667%{clip:rect(0.14rem, 99999px, 4.2rem, 0)}3.3333333333%{clip:rect(0.2rem, 99999px, 4.6rem, 0)}4%{clip:rect(0.12rem, 99999px, 5.3rem, 0)}4.6666666667%{clip:rect(0.18rem, 99999px, 9.7rem, 0)}5.3333333333%{clip:rect(0.1rem, 99999px, 2.6rem, 0)}6%{clip:rect(0.2rem, 99999px, 1.7rem, 0)}6.6666666667%{clip:rect(0.16rem, 99999px, 4.8rem, 0)}7.3333333333%{clip:rect(0.16rem, 99999px, 5.9rem, 0)}8%{clip:rect(0.12rem, 99999px, 4rem, 0)}8.6666666667%{clip:rect(0.12rem, 99999px, 3.2rem, 0)}9.3333333333%{clip:rect(0.04rem, 99999px, 8.9rem, 0)}10%{clip:rect(0.16rem, 99999px, 1.8rem, 0)}10.6666666667%{clip:rect(0.12rem, 99999px, 0.8rem, 0)}11.3333333333%{clip:rect(0.04rem, 99999px, 3.1rem, 0)}12%{clip:rect(0.04rem, 99999px, 2.8rem, 0)}12.6666666667%{clip:rect(0.2rem, 99999px, 3.6rem, 0)}13.3333333333%{clip:rect(0.2rem, 99999px, 9.6rem, 0)}14%{clip:rect(0.16rem, 99999px, 6.3rem, 0)}14.6666666667%{clip:rect(0.14rem, 99999px, 9.8rem, 0)}15.3333333333%{clip:rect(0.16rem, 99999px, 8.7rem, 0)}16%{clip:rect(0.18rem, 99999px, 1.8rem, 0)}16.6666666667%{clip:rect(0.04rem, 99999px, 9.4rem, 0)}17.3333333333%{clip:rect(0.14rem, 99999px, 5.9rem, 0)}18%{clip:rect(0.04rem, 99999px, 5.5rem, 0)}18.6666666667%{clip:rect(0.18rem, 99999px, 8rem, 0)}19.3333333333%{clip:rect(0.04rem, 99999px, 2.7rem, 0)}20%{clip:rect(0.1rem, 99999px, 3.4rem, 0)}20.6666666667%{clip:rect(0.12rem, 99999px, 8.9rem, 0)}21.3333333333%{clip:rect(0.12rem, 99999px, 8.8rem, 0)}22%{clip:rect(0.08rem, 99999px, 0.1rem, 0)}22.6666666667%{clip:rect(0.06rem, 99999px, 0.2rem, 0)}23.3333333333%{clip:rect(0.04rem, 99999px, 5.2rem, 0)}24%{clip:rect(0.1rem, 99999px, 5.2rem, 0)}24.6666666667%{clip:rect(0.18rem, 99999px, 4.9rem, 0)}25.3333333333%{clip:rect(0.02rem, 99999px, 5.4rem, 0)}26%{clip:rect(0.12rem, 99999px, 4.2rem, 0)}26.6666666667%{clip:rect(0.08rem, 99999px, 1.1rem, 0)}27.3333333333%{clip:rect(0.1rem, 99999px, 7.7rem, 0)}28%{clip:rect(0.02rem, 99999px, 3.8rem, 0)}28.6666666667%{clip:rect(0.14rem, 99999px, 7.9rem, 0)}29.3333333333%{clip:rect(0.12rem, 99999px, 4.7rem, 0)}30%{clip:rect(0.08rem, 99999px, 1.1rem, 0)}30.6666666667%{clip:rect(0.12rem, 99999px, 5rem, 0)}31.3333333333%{clip:rect(0.04rem, 99999px, 8.1rem, 0)}32%{clip:rect(0.2rem, 99999px, 8.8rem, 0)}32.6666666667%{clip:rect(0.08rem, 99999px, 5.5rem, 0)}33.3333333333%{clip:rect(0.18rem, 99999px, 0.3rem, 0)}34%{clip:rect(0.08rem, 99999px, 8rem, 0)}34.6666666667%{clip:rect(0.02rem, 99999px, 3.8rem, 0)}35.3333333333%{clip:rect(0.02rem, 99999px, 3.6rem, 0)}36%{clip:rect(0.1rem, 99999px, 4.9rem, 0)}36.6666666667%{clip:rect(0.2rem, 99999px, 2.7rem, 0)}37.3333333333%{clip:rect(0.2rem, 99999px, 1.8rem, 0)}38%{clip:rect(0.2rem, 99999px, 8.3rem, 0)}38.6666666667%{clip:rect(0.04rem, 99999px, 1.6rem, 0)}39.3333333333%{clip:rect(0.04rem, 99999px, 0.3rem, 0)}40%{clip:rect(0.06rem, 99999px, 0.5rem, 0)}40.6666666667%{clip:rect(0.02rem, 99999px, 3rem, 0)}41.3333333333%{clip:rect(0.04rem, 99999px, 7.9rem, 0)}42%{clip:rect(0.2rem, 99999px, 7.7rem, 0)}42.6666666667%{clip:rect(0.18rem, 99999px, 1.5rem, 0)}43.3333333333%{clip:rect(0.12rem, 99999px, 8.9rem, 0)}44%{clip:rect(0.14rem, 99999px, 3rem, 0)}44.6666666667%{clip:rect(0.08rem, 99999px, 6.5rem, 0)}45.3333333333%{clip:rect(0.06rem, 99999px, 0.5rem, 0)}46%{clip:rect(0.08rem, 99999px, 9.8rem, 0)}46.6666666667%{clip:rect(0.08rem, 99999px, 6.4rem, 0)}47.3333333333%{clip:rect(0.16rem, 99999px, 5.6rem, 0)}48%{clip:rect(0.06rem, 99999px, 0.9rem, 0)}48.6666666667%{clip:rect(0.1rem, 99999px, 6.8rem, 0)}49.3333333333%{clip:rect(0.18rem, 99999px, 2.3rem, 0)}50%{clip:rect(0.12rem, 99999px, 7.1rem, 0)}50.6666666667%{clip:rect(0.06rem, 99999px, 1.5rem, 0)}51.3333333333%{clip:rect(0.1rem, 99999px, 5.5rem, 0)}52%{clip:rect(0.14rem, 99999px, 9rem, 0)}52.6666666667%{clip:rect(0.04rem, 99999px, 6.5rem, 0)}53.3333333333%{clip:rect(0.2rem, 99999px, 6.9rem, 0)}54%{clip:rect(0.16rem, 99999px, 2.3rem, 0)}54.6666666667%{clip:rect(0.1rem, 99999px, 1.1rem, 0)}55.3333333333%{clip:rect(0.16rem, 99999px, 2.4rem, 0)}56%{clip:rect(0.04rem, 99999px, 4.2rem, 0)}56.6666666667%{clip:rect(0.06rem, 99999px, 2.2rem, 0)}57.3333333333%{clip:rect(0.14rem, 99999px, 8.7rem, 0)}58%{clip:rect(0.06rem, 99999px, 6.3rem, 0)}58.6666666667%{clip:rect(0.2rem, 99999px, 2.5rem, 0)}59.3333333333%{clip:rect(0.14rem, 99999px, 3.2rem, 0)}60%{clip:rect(0.08rem, 99999px, 3rem, 0)}60.6666666667%{clip:rect(0.12rem, 99999px, 7.6rem, 0)}61.3333333333%{clip:rect(0.04rem, 99999px, 0.6rem, 0)}62%{clip:rect(0.16rem, 99999px, 3.4rem, 0)}62.6666666667%{clip:rect(0.14rem, 99999px, 4.8rem, 0)}63.3333333333%{clip:rect(0.16rem, 99999px, 2.8rem, 0)}64%{clip:rect(0.02rem, 99999px, 4.6rem, 0)}64.6666666667%{clip:rect(0.06rem, 99999px, 2.2rem, 0)}65.3333333333%{clip:rect(0.14rem, 99999px, 0.2rem, 0)}66%{clip:rect(0.04rem, 99999px, 7.9rem, 0)}66.6666666667%{clip:rect(0.04rem, 99999px, 8.1rem, 0)}67.3333333333%{clip:rect(0.14rem, 99999px, 8.8rem, 0)}68%{clip:rect(0.12rem, 99999px, 7.9rem, 0)}68.6666666667%{clip:rect(0.14rem, 99999px, 0.9rem, 0)}69.3333333333%{clip:rect(0.1rem, 99999px, 2.2rem, 0)}70%{clip:rect(0.2rem, 99999px, 3.5rem, 0)}70.6666666667%{clip:rect(0.02rem, 99999px, 2.6rem, 0)}71.3333333333%{clip:rect(0.12rem, 99999px, 4.6rem, 0)}72%{clip:rect(0.14rem, 99999px, 4.2rem, 0)}72.6666666667%{clip:rect(0.1rem, 99999px, 2.4rem, 0)}73.3333333333%{clip:rect(0.04rem, 99999px, 6.4rem, 0)}74%{clip:rect(0.02rem, 99999px, 3.1rem, 0)}74.6666666667%{clip:rect(0.1rem, 99999px, 7.7rem, 0)}75.3333333333%{clip:rect(0.16rem, 99999px, 0.8rem, 0)}76%{clip:rect(0.08rem, 99999px, 4.8rem, 0)}76.6666666667%{clip:rect(0.04rem, 99999px, 1.9rem, 0)}77.3333333333%{clip:rect(0.02rem, 99999px, 0.8rem, 0)}78%{clip:rect(0.2rem, 99999px, 7.9rem, 0)}78.6666666667%{clip:rect(0.12rem, 99999px, 1.1rem, 0)}79.3333333333%{clip:rect(0.08rem, 99999px, 7.6rem, 0)}80%{clip:rect(0.1rem, 99999px, 4.7rem, 0)}80.6666666667%{clip:rect(0.1rem, 99999px, 6.3rem, 0)}81.3333333333%{clip:rect(0.18rem, 99999px, 7.3rem, 0)}82%{clip:rect(0.2rem, 99999px, 3.2rem, 0)}82.6666666667%{clip:rect(0.16rem, 99999px, 5.5rem, 0)}83.3333333333%{clip:rect(0.06rem, 99999px, 4.6rem, 0)}84%{clip:rect(0.18rem, 99999px, 7rem, 0)}84.6666666667%{clip:rect(0.04rem, 99999px, 3.8rem, 0)}85.3333333333%{clip:rect(0.08rem, 99999px, 3.5rem, 0)}86%{clip:rect(0.1rem, 99999px, 4.7rem, 0)}86.6666666667%{clip:rect(0.16rem, 99999px, 8.8rem, 0)}87.3333333333%{clip:rect(0.14rem, 99999px, 4.5rem, 0)}88%{clip:rect(0.16rem, 99999px, 5.7rem, 0)}88.6666666667%{clip:rect(0.1rem, 99999px, 3rem, 0)}89.3333333333%{clip:rect(0.04rem, 99999px, 5.9rem, 0)}90%{clip:rect(0.16rem, 99999px, 4.2rem, 0)}90.6666666667%{clip:rect(0.2rem, 99999px, 8.2rem, 0)}91.3333333333%{clip:rect(0.1rem, 99999px, 3.3rem, 0)}92%{clip:rect(0.08rem, 99999px, 7.9rem, 0)}92.6666666667%{clip:rect(0.08rem, 99999px, 9.7rem, 0)}93.3333333333%{clip:rect(0.08rem, 99999px, 4.8rem, 0)}94%{clip:rect(0.16rem, 99999px, 4.3rem, 0)}94.6666666667%{clip:rect(0.04rem, 99999px, 5.4rem, 0)}95.3333333333%{clip:rect(0.12rem, 99999px, 0.6rem, 0)}96%{clip:rect(0.04rem, 99999px, 2.4rem, 0)}96.6666666667%{clip:rect(0.04rem, 99999px, 2.2rem, 0)}97.3333333333%{clip:rect(0.08rem, 99999px, 2rem, 0)}98%{clip:rect(0.14rem, 99999px, 6.7rem, 0)}98.6666666667%{clip:rect(0.08rem, 99999px, 4.4rem, 0)}99.3333333333%{clip:rect(0.02rem, 99999px, 9.6rem, 0)}}@keyframes svelte-1my4ea4-glitch-skew{0%{transform:skew(4deg)}10%{transform:skew(4deg)}20%{transform:skew(0deg)}30%{transform:skew(0deg)}40%{transform:skew(1deg)}50%{transform:skew(-4deg)}60%{transform:skew(2deg)}70%{transform:skew(-2deg)}80%{transform:skew(0deg)}90%{transform:skew(2deg)}}#bar.svelte-1my4ea4 .logo.hover-effect-1.logo-behind-a.svelte-1my4ea4{color:var(--accent-light);transform:translateX(-0.5rem);color:#ff5500 !important;text-shadow:-2px 0 #ff5500, 2px 2px #ff5500;clip:rect(44px, 450px, 56px, 0);animation:svelte-1my4ea4-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-1my4ea4 .logo.hover-effect-1.logo-behind-b.svelte-1my4ea4{color:#bfcc2e !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #450f8b;clip:rect(44px, 450px, 56px, 0);animation:svelte-1my4ea4-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-1my4ea4 .logo.logo-behind.svelte-1my4ea4{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-1my4ea4 .logo.logo-behind.svelte-1my4ea4:not(.hovered){display:none}#bar.svelte-1my4ea4 #bar-right.svelte-1my4ea4{margin-left:auto;display:flex;margin-right:1rem;margin-top:1rem;position:relative}#bar.svelte-1my4ea4 #bar-right #menus.svelte-1my4ea4{display:flex}#bar.svelte-1my4ea4 #bar-right #menus #menu.svelte-1my4ea4{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-1my4ea4 #bar-right #menus #menu.svelte-1my4ea4 .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function NavBar_svelte_create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			style = dom_element("style");
			style.innerHTML = ``;
			add_location(style, NavBar_svelte_file, -1, 25962);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(style, NavBar_svelte_file, -1, 25845);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function NavBar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-1my4ea4");
			add_location(mark, NavBar_svelte_file, -1, 26195);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-1my4ea4");
			add_location(a0, NavBar_svelte_file, -1, 26123);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-1my4ea4");
			add_location(a1, NavBar_svelte_file, -1, 26238);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-1my4ea4");
			add_location(a2, NavBar_svelte_file, -1, 26330);
			attr_dev(div0, "id", "logo-container");
			add_location(div0, NavBar_svelte_file, -1, 26094);
			attr_dev(div1, "id", "bar-left");
			attr_dev(div1, "class", "svelte-1my4ea4");
			add_location(div1, NavBar_svelte_file, -1, 26047);
			attr_dev(div2, "id", "menu");
			attr_dev(div2, "class", "svelte-1my4ea4");
			add_location(div2, NavBar_svelte_file, -1, 26632);
			attr_dev(div3, "id", "menu");
			attr_dev(div3, "class", "svelte-1my4ea4");
			add_location(div3, NavBar_svelte_file, -1, 26933);
			attr_dev(div4, "id", "menus");
			attr_dev(div4, "class", "svelte-1my4ea4");
			add_location(div4, NavBar_svelte_file, -1, 26586);
			attr_dev(div5, "id", "bar-right");
			attr_dev(div5, "class", "svelte-1my4ea4");
			add_location(div5, NavBar_svelte_file, -1, 26487);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-1my4ea4");
			add_location(nav, NavBar_svelte_file, -1, 26004);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*hovered_class*/ 64 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-1my4ea4")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-1my4ea4")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-1my4ea4")) {
