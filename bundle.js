...
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 47, 0, 1795);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 61, 0, 2353);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, a, anchor);
...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(brb0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 18, 0, 808);
			add_location(brb1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 19, 0, 818);
			add_location(strong0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 20, 1, 830);
			add_location(h20, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 20, 0, 826);
			attr_dev(a0, "href", "https://en.wikipedia.org/wiki/Lightmap");
			attr_dev(a0, "rel", "nofollow");
			add_location(a0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 21, 39, 918);
			...
			add_location(a1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 25, 2, 1008);
			add_location(p0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 21, 0, 865);
			add_location(p1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 30, 0, 1321);
			add_location(brb2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 31, 0, 1397);
			add_location(brb3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 32, 0, 1405);
			add_location(brb4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 49, 0, 1900);
			attr_dev(a2, "href", "https://en.wikipedia.org/wiki/Implicit_surface");
			attr_dev(a2, "rel", "nofollow");
			add_location(a2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 50, 0, 1985);
			add_location(p2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 50, 0, 1908);
			add_location(brb5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 57, 0, 2261);
			add_location(brb6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 58, 0, 2269);
			add_location(brb7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 63, 0, 2417);
			add_location(br, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 64, 0, 2500);
			attr_dev(a3, "href", "https://web.archive.org/web/20040131013212/http://lycium.cfxweb.net/");
			attr_dev(a3, "rel", "nofollow");
			add_location(a3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 65, 0, 2524);
			attr_dev(a4, "href", "https://www.deviantart.com/lyc");
			add_location(a4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 68, 6, 2682);
			add_location(p3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 64, 0, 2425);
			add_location(p4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 69, 0, 2739);
			add_location(wbr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 70, 0, 2855);
			add_location(hr0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 72, 2, 2889);
			attr_dev(a5, "href", "https://cs.dartmouth.edu/wjarosz/publications/jarosz12theory.html");
			add_location(a5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 74, 0, 2912);
			add_location(brb8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 74, 0, 3106);
			attr_dev(a6, "href", "https://en.wikipedia.org/wiki/Irradiance");
			add_location(a6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 75, 7, 3123);
			add_location(ol0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 73, 2, 2898);
			add_location(hr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 77, 2, 3357);
			attr_dev(div, "class", "footnotes");
			add_location(div, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 71, 0, 2863);
			add_location(wbr1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 79, 0, 3371);
			add_location(strong1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 80, 0, 3383);
			add_location(h21, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 80, 0, 3379);
			add_location(p5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 81, 0, 3414);
			add_location(brb9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 82, 0, 3567);
			add_location(brb10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 88, 0, 3800);
			add_location(p6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 89, 0, 3808);
			add_location(li0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 91, 0, 3850);
			add_location(li1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 92, 0, 3931);
			add_location(li2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 93, 0, 4025);
			add_location(li3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 94, 0, 4113);
			add_location(ol1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 90, 0, 3845);
			add_location(p7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 96, 0, 4240);
			add_location(wbr2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 97, 0, 4276);
			attr_dev(pre0, "class", "language-glsl");
			add_location(pre0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 98, 0, 4284);
			add_location(brb11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 142, 0, 10673);
			add_location(strong2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 143, 0, 10685);
			add_location(h22, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 143, 0, 10681);
			add_location(wbr3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 144, 0, 10722);
			attr_dev(pre1, "class", "language-undefined");
			add_location(pre1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 145, 0, 10730);
			attr_dev(a7, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 147, 1, 10925);
			attr_dev(a8, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 152, 5, 11199);
			add_location(li4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 147, 0, 10885);
			add_location(li5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 157, 0, 11375);
			add_location(li6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 159, 0, 11992);
			add_location(ul, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 146, 0, 10880);
			attr_dev(a9, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a9, "rel", "nofollow");
			add_location(a9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 162, 19, 12125);
			add_location(p8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 162, 0, 12105);
			add_location(wbr4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 166, 0, 12235);
			add_location(strong3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 167, 4, 12247);
			add_location(h23, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 167, 0, 12243);
			add_location(brb12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 171, 0, 12426);
			attr_dev(a10, "href", "https://www.shadertoy.com/view/4dX3zl");
			add_location(a10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 173, 0, 12459);
			add_location(p9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 168, 0, 12283);
			add_location(brb13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 177, 0, 12688);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 178, 0, 12698);
			add_location(brb14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 203, 0, 19971);
			attr_dev(pre3, "class", "language-glsl");
			add_location(pre3, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 204, 0, 19978);
			attr_dev(a11, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 205, 6, 20308);
			attr_dev(a12, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 208, 47, 20451);
			add_location(p10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 205, 0, 20299);
			attr_dev(a13, "href", "https://registry.khronos.org/OpenGL/extensions/NV/NV_shader_atomic_float.txt");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 212, 58, 20707);
			attr_dev(a14, "href", "https://en.wikipedia.org/wiki/Compare-and-swap");
			attr_dev(a14, "rel", "nofollow");
			add_location(a14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 216, 1, 20843);
			add_location(p11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 212, 0, 20625);
			add_location(brb15, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 220, 0, 20956);
			add_location(strong4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 221, 0, 20967);
			add_location(h24, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 221, 0, 20963);
			add_location(p12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 222, 0, 21001);
			add_location(article, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 17, 0, 798);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function _2023_08_17_flame_fractals_in_comp_shader_svelte_create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 53, 2, 2018);
			attr_dev(a1, "href", "https://www.technochroma.art");
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 53, 30, 2113);
		},
		m: function mount(target, anchor) {
...
function _2023_08_17_flame_fractals_in_comp_shader_svelte_create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 67, 0, 2658);
			attr_dev(a1, "href", "https://www.pouet.net/groups.php?which=12701");
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 67, 0, 2728);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a0, anchor);
			insert_dev(target, t1, anchor);
...
<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>uv <span class="token operator">+</span> anti_aliasing <span class="token operator">+</span> dof_sample<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(brb0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 19, 0, 828);
			add_location(brb1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 20, 0, 836);
			add_location(strong0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 21, 4, 848);
			add_location(h20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 21, 0, 844);
			attr_dev(a0, "href", "https://en.wikipedia.org/wiki/Fractal_flame");
			attr_dev(a0, "rel", "nofollow");
			add_location(a0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 22, 1, 886);
			attr_dev(a1, "href", "https://en.wikipedia.org/wiki/Scott_Draves");
			attr_dev(a1, "rel", "nofollow");
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 26, 23, 1083);
			attr_dev(a2, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a2, "rel", "nofollow");
			add_location(a2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 29, 7, 1178);
			attr_dev(a3, "href", "https://maths-people.anu.edu.au/~john/Assets/Research%20Papers/fractals_self-similarity.pdf");
			attr_dev(a3, "rel", "nofollow");
			add_location(a3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 30, 0, 1283);
			...
			add_location(a4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 33, 0, 1458);
			add_location(p0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 22, 0, 883);
			attr_dev(a5, "href", "https://github.com/bezo97/IFSRenderer");
			attr_dev(a5, "rel", "nofollow");
			add_location(a5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 38, 0, 1689);
			attr_dev(a6, "href", "https://www.chaoticafractals.com");
			attr_dev(a6, "rel", "nofollow");
			add_location(a6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 41, 1, 1764);
			attr_dev(a7, "href", "https://github.com/3Dickulus/FragM");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 44, 7, 1833);
			add_location(p1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 37, 0, 1615);
			add_location(brb2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 48, 0, 1928);
			add_location(brb3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 49, 0, 1936);
			add_location(brb4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 55, 0, 2181);
			attr_dev(a8, "href", "https://en.wikipedia.org/wiki/Demoscene");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 56, 53, 2243);
			attr_dev(a9, "href", "https://www.pouet.net/groups.php?which=12701");
			attr_dev(a9, "rel", "nofollow");
			add_location(a9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 59, 0, 2322);
			attr_dev(a10, "href", "https://files.scene.org/view/parties/2019/assembly19/4k/terrarium_by_eos.zip");
			attr_dev(a10, "rel", "nofollow");
			add_location(a10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 59, 0, 2472);
			add_location(p2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 56, 0, 2189);
			add_location(brb5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 63, 0, 2593);
			add_location(wbr, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 64, 0, 2601);
			add_location(brb6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 69, 0, 2803);
			add_location(brb7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 70, 0, 2811);
			attr_dev(a11, "href", "https://github.com/demoscene-source-archive/terrarium/blob/master/src/shaders/fragment.glsl");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 71, 49, 2868);
			add_location(p3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 71, 0, 2819);
			add_location(p4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 75, 0, 3011);
			add_location(li0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 77, 0, 3084);
			add_location(li1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 78, 0, 3179);
			add_location(li2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 79, 0, 3237);
			add_location(li3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 81, 0, 3309);
			add_location(li4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 82, 0, 3347);
			add_location(li5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 83, 0, 3424);
			add_location(ul0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 80, 0, 3304);
			add_location(li6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 80, 0, 3274);
			add_location(li7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 85, 0, 3520);
			add_location(ul1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 76, 0, 3079);
			add_location(p5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 87, 0, 3597);
			add_location(brb8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 88, 0, 3656);
			add_location(brb9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 89, 0, 3664);
			add_location(brb10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 91, 0, 3708);
			add_location(brb11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 92, 0, 3716);
			attr_dev(a12, "href", "https://en.wikipedia.org/wiki/Chaos_game");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 93, 24, 3758);
			attr_dev(a13, "href", "https://en.wikipedia.org/wiki/Iterated_function_system");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 96, 40, 3912);
			add_location(p6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 93, 0, 3724);
			attr_dev(a14, "href", "https://en.wikipedia.org/wiki/Tone_mapping");
			attr_dev(a14, "rel", "nofollow");
			add_location(a14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 102, 1, 4078);
			add_location(li8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 102, 0, 4074);
			add_location(li9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 103, 0, 4207);
			add_location(ul2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 101, 0, 4069);
			attr_dev(a15, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a15, "rel", "nofollow");
			add_location(a15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 105, 0, 4399);
			add_location(p7, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 105, 0, 4357);
			add_location(brb12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 109, 0, 4595);
			add_location(strong1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 110, 4, 4607);
			add_location(h21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 110, 0, 4603);
			add_location(brb13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 111, 0, 4639);
			attr_dev(pre0, "class", "language-glsl");
			add_location(pre0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 112, 0, 4647);
			add_location(brb14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 177, 0, 18117);
			attr_dev(pre1, "class", "language-glsl");
			add_location(pre1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 178, 0, 18125);
			attr_dev(a16, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a16, "rel", "nofollow");
			add_location(a16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 179, 7, 18518);
			attr_dev(a17, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a17, "rel", "nofollow");
			add_location(a17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 182, 17, 18661);
			add_location(p8, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 179, 0, 18509);
			add_location(brb15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 186, 0, 18757);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 187, 0, 18765);
			attr_dev(a18, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a18, "rel", "nofollow");
			add_location(a18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 189, 26, 19290);
			attr_dev(a19, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a19, "rel", "nofollow");
			add_location(a19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 194, 12, 19564);
			add_location(li10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 189, 0, 19250);
			add_location(li11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 199, 0, 19740);
			add_location(li12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 201, 0, 19958);
			add_location(ul3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 188, 0, 19245);
			attr_dev(a20, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a20, "rel", "nofollow");
			add_location(a20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 204, 19, 20091);
			add_location(p9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 204, 0, 20071);
			add_location(brb16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 208, 0, 20201);
			add_location(strong2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 209, 0, 20213);
			add_location(h22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 209, 0, 20209);
			add_location(brb17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 210, 0, 20251);
			attr_dev(pre3, "class", "language-glsl");
			add_location(pre3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 211, 0, 20259);
			add_location(brb18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 227, 0, 25944);
			add_location(p10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 228, 0, 25952);
			attr_dev(a21, "href", "https://en.wikipedia.org/wiki/Affine_transformation");
			attr_dev(a21, "rel", "nofollow");
			add_location(a21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 229, 25, 26054);
			add_location(p11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 229, 0, 25993);
			attr_dev(a22, "href", "https://en.wikipedia.org/wiki/Inversive_geometry");
			attr_dev(a22, "rel", "nofollow");
			add_location(a22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 233, 3, 26193);
			add_location(code, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 236, 1, 26296);
			attr_dev(a23, "href", "https://en.wikipedia.org/wiki/M%C3%B6bius_transformation");
			attr_dev(a23, "rel", "nofollow");
			add_location(a23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 236, 1, 26345);
			attr_dev(a24, "href", "https://en.wikipedia.org/wiki/Conformal_map");
			attr_dev(a24, "rel", "nofollow");
			add_location(a24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 240, 0, 26539);
			add_location(p12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 233, 0, 26190);
			add_location(brb19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 244, 0, 26673);
			add_location(brb20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 0, 26717);
			attr_dev(a25, "href", "https://github.com/bezo97/IFSRenderer");
			attr_dev(a25, "rel", "nofollow");
			add_location(a25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 247, 0, 26728);
			...
			add_location(a26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 247, 0, 26809);
			add_location(p13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 247, 0, 26725);
			add_location(brb21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 251, 0, 27008);
			add_location(strong3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 4, 27020);
			add_location(h23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 0, 27016);
			attr_dev(a27, "href", "https://flam3.com/flame_draves.pdf");
			attr_dev(a27, "rel", "nofollow");
			add_location(a27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 253, 39, 27105);
			add_location(p14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 253, 0, 27064);
			add_location(p15, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 257, 0, 27331);
			attr_dev(a28, "href", "https://64.github.io/tonemapping/");
			attr_dev(a28, "rel", "nofollow");
			add_location(a28, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 258, 7, 27498);
			add_location(p16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 258, 0, 27376);
			attr_dev(a29, "href", "https://www-old.cs.utah.edu/docs/techreports/2002/pdf/UUCS-02-001.pdf");
			attr_dev(a29, "rel", "nofollow");
			add_location(a29, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 262, 76, 27690);
			add_location(p17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 262, 0, 27590);
			add_location(brb22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 267, 0, 28032);
			attr_dev(pre4, "class", "language-glsl");
			add_location(pre4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 268, 0, 28040);
			add_location(strong4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 292, 1, 32127);
			add_location(h24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 292, 0, 32123);
			attr_dev(a30, "href", "https://www.pouet.net/prod.php?which=82417");
			attr_dev(a30, "rel", "nofollow");
			add_location(a30, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 293, 0, 32167);
			add_location(p18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 293, 0, 32164);
			add_location(brb23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 295, 0, 32421);
			attr_dev(pre5, "class", "language-glsl");
			add_location(pre5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 296, 0, 32429);
			add_location(brb24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 301, 0, 34500);
			add_location(strong5, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 302, 4, 34512);
			add_location(h25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 302, 0, 34508);
			attr_dev(a31, "href", "https://www.pouet.net/prod.php?which=82417");
			attr_dev(a31, "rel", "nofollow");
			add_location(a31, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 303, 0, 34562);
			add_location(p19, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 303, 0, 34546);
			add_location(brb25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 308, 0, 34880);
			add_location(strong6, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 309, 0, 34892);
			add_location(h26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 309, 0, 34888);
			add_location(brb26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 310, 0, 34926);
			add_location(p20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 311, 0, 34934);
			add_location(brb27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 312, 0, 34997);
			add_location(p21, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 313, 0, 35005);
			add_location(brb28, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 314, 0, 35040);
			add_location(brb29, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 316, 0, 35145);
			add_location(brb30, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 318, 0, 35251);
			add_location(brb31, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 320, 0, 35356);
			add_location(brb32, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 322, 0, 35461);
			add_location(brb33, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 324, 0, 35566);
			add_location(brb34, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 326, 0, 35671);
			add_location(brb35, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 328, 0, 35736);
			add_location(brb36, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 330, 0, 35801);
			add_location(brb37, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 332, 0, 35867);
			add_location(brb38, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 335, 1, 35933);
			add_location(article, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 18, 0, 818);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function NavBar_svelte_add_css(target) {
	append_styles(target, "svelte-14v5lfi", "#bar.svelte-14v5lfi.svelte-14v5lfi{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-14v5lfi #bar-left.svelte-14v5lfi{display:flex;flex-direction:column}#bar.svelte-14v5lfi mark.svelte-14v5lfi{background:var(--accent-dark)}#bar.svelte-14v5lfi .logo.svelte-14v5lfi{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-14v5lfi .logo.logo-behind.svelte-14v5lfi{position:absolute}#bar.svelte-14v5lfi .logo.hovered.svelte-14v5lfi{color:var(--accent-dark) !important}#bar.svelte-14v5lfi .logo.hovered.hover-effect-0.svelte-14v5lfi{animation:svelte-14v5lfi-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-14v5lfi-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-14v5lfi-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-14v5lfi-glitch-anim3{0%{clip:rect(3.6rem, 9999px, 1.5rem, 0);transform-origin:center}2%{clip:rect(3.8rem, 9999px, 3rem, 0);transform-origin:center}4%{clip:rect(3.3rem, 9999px, 2.5rem, 0);transform-origin:center}6%{clip:rect(4rem, 9999px, 1rem, 0);transform-origin:center}8%{clip:rect(3.5rem, 9999px, 0.5rem, 0);transform-origin:center}10%{clip:rect(1.1rem, 9999px, 4rem, 0);transform-origin:center}12%{clip:rect(1.6rem, 9999px, 2rem, 0);transform-origin:center}14%{clip:rect(0.7rem, 9999px, 2.5rem, 0);transform-origin:center}16%{clip:rect(2rem, 9999px, 2rem, 0);transform-origin:center}18%{clip:rect(3.3rem, 9999px, 2.5rem, 0);transform-origin:center}20%{clip:rect(1.5rem, 9999px, 1.5rem, 0);transform-origin:center}22%{clip:rect(0.4rem, 9999px, 2.5rem, 0);transform-origin:center}24%{clip:rect(3rem, 9999px, 2rem, 0);transform-origin:center}26%{clip:rect(3.7rem, 9999px, 5rem, 0);transform-origin:center}28%{clip:rect(2.3rem, 9999px, 3.5rem, 0);transform-origin:center}30%{clip:rect(1rem, 9999px, 4.5rem, 0);transform-origin:center}32%{clip:rect(2.2rem, 9999px, 3rem, 0);transform-origin:center}34%{clip:rect(3.4rem, 9999px, 2rem, 0);transform-origin:center}36%{clip:rect(3.9rem, 9999px, 3rem, 0);transform-origin:center}38%{clip:rect(1.6rem, 9999px, 0.5rem, 0);transform-origin:center}40%{clip:rect(1.4rem, 9999px, 3rem, 0);transform-origin:center}42%{clip:rect(3.1rem, 9999px, 3.5rem, 0);transform-origin:center}44%{clip:rect(3rem, 9999px, 4.5rem, 0);transform-origin:center}46%{clip:rect(3.6rem, 9999px, 2rem, 0);transform-origin:center}48%{clip:rect(3.8rem, 9999px, 1.5rem, 0);transform-origin:center}50%{clip:rect(1.7rem, 9999px, 5rem, 0);transform-origin:center}52%{clip:rect(3.6rem, 9999px, 4.5rem, 0);transform-origin:center}54%{clip:rect(3.3rem, 9999px, 1.5rem, 0);transform-origin:center}56%{clip:rect(0.8rem, 9999px, 1rem, 0);transform-origin:center}58%{clip:rect(2.6rem, 9999px, 5rem, 0);transform-origin:center}60%{clip:rect(1.6rem, 9999px, 2.5rem, 0);transform-origin:center}62%{clip:rect(0.3rem, 9999px, 2rem, 0);transform-origin:center}64%{clip:rect(2.8rem, 9999px, 0.5rem, 0);transform-origin:center}66%{clip:rect(3.8rem, 9999px, 4.5rem, 0);transform-origin:center}68%{clip:rect(4rem, 9999px, 1rem, 0);transform-origin:center}70%{clip:rect(1rem, 9999px, 5rem, 0);transform-origin:center}72%{clip:rect(0.7rem, 9999px, 0.5rem, 0);transform-origin:center}74%{clip:rect(1.7rem, 9999px, 1.5rem, 0);transform-origin:center}76%{clip:rect(0.2rem, 9999px, 1.5rem, 0);transform-origin:center}78%{clip:rect(0.6rem, 9999px, 4rem, 0);transform-origin:center}80%{clip:rect(1.1rem, 9999px, 0.5rem, 0);transform-origin:center}82%{clip:rect(1.7rem, 9999px, 1.5rem, 0);transform-origin:center}84%{clip:rect(0.9rem, 9999px, 1rem, 0);transform-origin:center}86%{clip:rect(2.4rem, 9999px, 2rem, 0);transform-origin:center}88%{clip:rect(1.7rem, 9999px, 1.5rem, 0);transform-origin:center}90%{clip:rect(0.4rem, 9999px, 3.5rem, 0);transform-origin:center}92%{clip:rect(1.7rem, 9999px, 3rem, 0);transform-origin:center}94%{clip:rect(2rem, 9999px, 0.5rem, 0);transform-origin:center}96%{clip:rect(1.6rem, 9999px, 4rem, 0);transform-origin:center}98%{clip:rect(3.2rem, 9999px, 0.5rem, 0);transform-origin:center}}@keyframes svelte-14v5lfi-cooool{0%{color:pink !important}2%{color:pink !important}4%{color:pink !important}6%{color:pink !important}8%{color:pink !important}10%{color:pink !important}12%{color:pink !important}14%{color:pink !important}16%{color:pink !important}18%{color:pink !important}20%{color:pink !important}22%{color:pink !important}24%{color:pink !important}26%{color:pink !important}28%{color:pink !important}30%{color:pink !important}32%{color:pink !important}34%{color:pink !important}36%{color:pink !important}38%{color:pink !important}40%{color:pink !important}42%{color:pink !important}44%{color:pink !important}46%{color:pink !important}48%{color:pink !important}50%{color:pink !important}52%{color:pink !important}54%{color:pink !important}56%{color:pink !important}58%{color:pink !important}60%{color:pink !important}62%{color:pink !important}64%{color:pink !important}66%{color:pink !important}68%{color:pink !important}70%{color:pink !important}72%{color:pink !important}74%{color:pink !important}76%{color:pink !important}78%{color:pink !important}80%{color:pink !important}82%{color:pink !important}84%{color:pink !important}86%{color:pink !important}88%{color:pink !important}90%{color:pink !important}92%{color:pink !important}94%{color:pink !important}96%{color:pink !important}98%{color:pink !important}}#bar.svelte-14v5lfi .logo.hovered.hover-effect-0.logo-behind-a.svelte-14v5lfi{color:#ff5500 !important;animation:svelte-14v5lfi-distort1 300ms linear infinite, svelte-14v5lfi-glitch-anim3 5s infinite linear alternate-reverse, svelte-14v5lfi-cooool 5s infinite linear alternate-reverse}#bar.svelte-14v5lfi .logo.hovered.hover-effect-0.logo-behind-b.svelte-14v5lfi{color:#450f8b !important;animation:svelte-14v5lfi-distort2 300ms linear infinite, svelte-14v5lfi-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-14v5lfi .logo.hover-effect-1.svelte-14v5lfi{animation:svelte-14v5lfi-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-14v5lfi-glitch-anim{0%{clip:rect(1rem, 9999px, 2.5rem, 0);transform:skew(1.1deg);z-index:4}2%{clip:rect(1.3rem, 9999px, 1rem, 0);transform:skew(7.5deg);z-index:1}4%{clip:rect(3.7rem, 9999px, 1rem, 0);transform:skew(7.4deg);z-index:2}6%{clip:rect(0.6rem, 9999px, 1rem, 0);transform:skew(8.6deg);z-index:2}8%{clip:rect(2rem, 9999px, 3.5rem, 0);transform:skew(6.5deg);z-index:3}10%{clip:rect(3.9rem, 9999px, 0.5rem, 0);transform:skew(2.4deg);z-index:3}12%{clip:rect(1.9rem, 9999px, 5rem, 0);transform:skew(1.9deg);z-index:4}14%{clip:rect(0.9rem, 9999px, 2rem, 0);transform:skew(8.5deg);z-index:4}16%{clip:rect(0.4rem, 9999px, 5rem, 0);transform:skew(6.2deg);z-index:2}18%{clip:rect(1.2rem, 9999px, 4rem, 0);transform:skew(8.8deg);z-index:4}20%{clip:rect(0.4rem, 9999px, 0.5rem, 0);transform:skew(3.2deg);z-index:1}22%{clip:rect(4rem, 9999px, 0.5rem, 0);transform:skew(7.7deg);z-index:4}24%{clip:rect(3.1rem, 9999px, 0.5rem, 0);transform:skew(8deg);z-index:4}26%{clip:rect(2rem, 9999px, 2rem, 0);transform:skew(1.8deg);z-index:4}28%{clip:rect(1.8rem, 9999px, 3.5rem, 0);transform:skew(4.5deg);z-index:1}30%{clip:rect(3.6rem, 9999px, 4rem, 0);transform:skew(0.1deg);z-index:3}32%{clip:rect(3.6rem, 9999px, 2.5rem, 0);transform:skew(2deg);z-index:1}34%{clip:rect(1.9rem, 9999px, 4rem, 0);transform:skew(1.5deg);z-index:2}36%{clip:rect(2.2rem, 9999px, 4.5rem, 0);transform:skew(5.6deg);z-index:1}38%{clip:rect(3rem, 9999px, 4rem, 0);transform:skew(3.8deg);z-index:3}40%{clip:rect(2.7rem, 9999px, 5rem, 0);transform:skew(7deg);z-index:2}42%{clip:rect(2rem, 9999px, 4.5rem, 0);transform:skew(4.3deg);z-index:2}44%{clip:rect(1.3rem, 9999px, 1rem, 0);transform:skew(6.2deg);z-index:1}46%{clip:rect(3.7rem, 9999px, 2rem, 0);transform:skew(0.6deg);z-index:4}48%{clip:rect(1.1rem, 9999px, 4rem, 0);transform:skew(0.2deg);z-index:3}50%{clip:rect(1.7rem, 9999px, 5rem, 0);transform:skew(3.7deg);z-index:3}52%{clip:rect(0.2rem, 9999px, 0.5rem, 0);transform:skew(8.7deg);z-index:3}54%{clip:rect(0.8rem, 9999px, 4rem, 0);transform:skew(7.8deg);z-index:4}56%{clip:rect(0.5rem, 9999px, 0.5rem, 0);transform:skew(2.7deg);z-index:2}58%{clip:rect(3.9rem, 9999px, 3.5rem, 0);transform:skew(3.4deg);z-index:2}60%{clip:rect(0.6rem, 9999px, 4rem, 0);transform:skew(7.9deg);z-index:3}62%{clip:rect(1.2rem, 9999px, 3.5rem, 0);transform:skew(5.8deg);z-index:1}64%{clip:rect(3.7rem, 9999px, 2.5rem, 0);transform:skew(7.3deg);z-index:3}66%{clip:rect(3.1rem, 9999px, 5rem, 0);transform:skew(1deg);z-index:1}68%{clip:rect(1.1rem, 9999px, 0.5rem, 0);transform:skew(4.7deg);z-index:1}70%{clip:rect(2.7rem, 9999px, 0.5rem, 0);transform:skew(7.1deg);z-index:1}72%{clip:rect(2rem, 9999px, 0.5rem, 0);transform:skew(2.5deg);z-index:4}74%{clip:rect(0.8rem, 9999px, 0.5rem, 0);transform:skew(5.1deg);z-index:1}76%{clip:rect(3.9rem, 9999px, 2.5rem, 0);transform:skew(2.5deg);z-index:2}78%{clip:rect(1.1rem, 9999px, 4rem, 0);transform:skew(9.2deg);z-index:4}80%{clip:rect(4rem, 9999px, 1rem, 0);transform:skew(8.9deg);z-index:2}82%{clip:rect(1.6rem, 9999px, 0.5rem, 0);transform:skew(1.8deg);z-index:3}84%{clip:rect(2.6rem, 9999px, 4rem, 0);transform:skew(5.1deg);z-index:4}86%{clip:rect(2rem, 9999px, 3rem, 0);transform:skew(2.2deg);z-index:2}88%{clip:rect(0.9rem, 9999px, 2rem, 0);transform:skew(4.1deg);z-index:2}90%{clip:rect(0.2rem, 9999px, 4.5rem, 0);transform:skew(7deg);z-index:4}92%{clip:rect(1.6rem, 9999px, 1.5rem, 0);transform:skew(6.6deg);z-index:2}94%{clip:rect(2.6rem, 9999px, 4.5rem, 0);transform:skew(2deg);z-index:1}96%{clip:rect(3.7rem, 9999px, 1.5rem, 0);transform:skew(9.9deg);z-index:2}98%{clip:rect(2.6rem, 9999px, 3rem, 0);transform:skew(7.7deg);z-index:2}}@keyframes svelte-14v5lfi-glitch-anim2{0%{clip:rect(0.02rem, 99999px, 6.7rem, 0)}0.6666666667%{clip:rect(0.04rem, 99999px, 5rem, 0)}1.3333333333%{clip:rect(0.1rem, 99999px, 5.2rem, 0)}2%{clip:rect(0.12rem, 99999px, 5.2rem, 0)}2.6666666667%{clip:rect(0.16rem, 99999px, 2.6rem, 0)}3.3333333333%{clip:rect(0.06rem, 99999px, 0.5rem, 0)}4%{clip:rect(0.14rem, 99999px, 4rem, 0)}4.6666666667%{clip:rect(0.04rem, 99999px, 0.8rem, 0)}5.3333333333%{clip:rect(0.08rem, 99999px, 3.7rem, 0)}6%{clip:rect(0.18rem, 99999px, 4.7rem, 0)}6.6666666667%{clip:rect(0.18rem, 99999px, 4.2rem, 0)}7.3333333333%{clip:rect(0.2rem, 99999px, 7.1rem, 0)}8%{clip:rect(0.08rem, 99999px, 5.3rem, 0)}8.6666666667%{clip:rect(0.12rem, 99999px, 6.6rem, 0)}9.3333333333%{clip:rect(0.12rem, 99999px, 8.2rem, 0)}10%{clip:rect(0.04rem, 99999px, 2.1rem, 0)}10.6666666667%{clip:rect(0.08rem, 99999px, 7.5rem, 0)}11.3333333333%{clip:rect(0.04rem, 99999px, 0.4rem, 0)}12%{clip:rect(0.1rem, 99999px, 5rem, 0)}12.6666666667%{clip:rect(0.2rem, 99999px, 0.1rem, 0)}13.3333333333%{clip:rect(0.16rem, 99999px, 0.3rem, 0)}14%{clip:rect(0.04rem, 99999px, 9.2rem, 0)}14.6666666667%{clip:rect(0.16rem, 99999px, 8.8rem, 0)}15.3333333333%{clip:rect(0.08rem, 99999px, 6.5rem, 0)}16%{clip:rect(0.14rem, 99999px, 5.3rem, 0)}16.6666666667%{clip:rect(0.02rem, 99999px, 2.6rem, 0)}17.3333333333%{clip:rect(0.08rem, 99999px, 5.3rem, 0)}18%{clip:rect(0.12rem, 99999px, 4.9rem, 0)}18.6666666667%{clip:rect(0.12rem, 99999px, 7.4rem, 0)}19.3333333333%{clip:rect(0.02rem, 99999px, 10rem, 0)}20%{clip:rect(0.12rem, 99999px, 2.5rem, 0)}20.6666666667%{clip:rect(0.04rem, 99999px, 3rem, 0)}21.3333333333%{clip:rect(0.02rem, 99999px, 7.8rem, 0)}22%{clip:rect(0.1rem, 99999px, 2.8rem, 0)}22.6666666667%{clip:rect(0.1rem, 99999px, 4.8rem, 0)}23.3333333333%{clip:rect(0.1rem, 99999px, 1.2rem, 0)}24%{clip:rect(0.14rem, 99999px, 5.7rem, 0)}24.6666666667%{clip:rect(0.14rem, 99999px, 4.2rem, 0)}25.3333333333%{clip:rect(0.04rem, 99999px, 8.6rem, 0)}26%{clip:rect(0.14rem, 99999px, 6.7rem, 0)}26.6666666667%{clip:rect(0.12rem, 99999px, 1.1rem, 0)}27.3333333333%{clip:rect(0.14rem, 99999px, 5.6rem, 0)}28%{clip:rect(0.12rem, 99999px, 8rem, 0)}28.6666666667%{clip:rect(0.04rem, 99999px, 3.3rem, 0)}29.3333333333%{clip:rect(0.18rem, 99999px, 0.9rem, 0)}30%{clip:rect(0.16rem, 99999px, 8.7rem, 0)}30.6666666667%{clip:rect(0.12rem, 99999px, 6.5rem, 0)}31.3333333333%{clip:rect(0.06rem, 99999px, 1.7rem, 0)}32%{clip:rect(0.18rem, 99999px, 8.9rem, 0)}32.6666666667%{clip:rect(0.2rem, 99999px, 1.4rem, 0)}33.3333333333%{clip:rect(0.02rem, 99999px, 0.8rem, 0)}34%{clip:rect(0.18rem, 99999px, 4rem, 0)}34.6666666667%{clip:rect(0.06rem, 99999px, 1.6rem, 0)}35.3333333333%{clip:rect(0.1rem, 99999px, 3.8rem, 0)}36%{clip:rect(0.12rem, 99999px, 3.4rem, 0)}36.6666666667%{clip:rect(0.2rem, 99999px, 9.4rem, 0)}37.3333333333%{clip:rect(0.14rem, 99999px, 4.7rem, 0)}38%{clip:rect(0.02rem, 99999px, 7.1rem, 0)}38.6666666667%{clip:rect(0.1rem, 99999px, 5.2rem, 0)}39.3333333333%{clip:rect(0.18rem, 99999px, 5.8rem, 0)}40%{clip:rect(0.06rem, 99999px, 7.8rem, 0)}40.6666666667%{clip:rect(0.04rem, 99999px, 5.2rem, 0)}41.3333333333%{clip:rect(0.06rem, 99999px, 1.2rem, 0)}42%{clip:rect(0.16rem, 99999px, 7.2rem, 0)}42.6666666667%{clip:rect(0.06rem, 99999px, 8.3rem, 0)}43.3333333333%{clip:rect(0.04rem, 99999px, 1.2rem, 0)}44%{clip:rect(0.04rem, 99999px, 8.7rem, 0)}44.6666666667%{clip:rect(0.1rem, 99999px, 7.1rem, 0)}45.3333333333%{clip:rect(0.02rem, 99999px, 8.9rem, 0)}46%{clip:rect(0.12rem, 99999px, 0.5rem, 0)}46.6666666667%{clip:rect(0.14rem, 99999px, 0.5rem, 0)}47.3333333333%{clip:rect(0.14rem, 99999px, 0.1rem, 0)}48%{clip:rect(0.2rem, 99999px, 6.1rem, 0)}48.6666666667%{clip:rect(0.2rem, 99999px, 7.1rem, 0)}49.3333333333%{clip:rect(0.1rem, 99999px, 2rem, 0)}50%{clip:rect(0.02rem, 99999px, 1.2rem, 0)}50.6666666667%{clip:rect(0.2rem, 99999px, 5.4rem, 0)}51.3333333333%{clip:rect(0.08rem, 99999px, 6.5rem, 0)}52%{clip:rect(0.18rem, 99999px, 3.3rem, 0)}52.6666666667%{clip:rect(0.04rem, 99999px, 8rem, 0)}53.3333333333%{clip:rect(0.1rem, 99999px, 2.2rem, 0)}54%{clip:rect(0.1rem, 99999px, 9.9rem, 0)}54.6666666667%{clip:rect(0.04rem, 99999px, 8.7rem, 0)}55.3333333333%{clip:rect(0.1rem, 99999px, 9.6rem, 0)}56%{clip:rect(0.18rem, 99999px, 5.9rem, 0)}56.6666666667%{clip:rect(0.18rem, 99999px, 4.5rem, 0)}57.3333333333%{clip:rect(0.04rem, 99999px, 9.7rem, 0)}58%{clip:rect(0.1rem, 99999px, 0.7rem, 0)}58.6666666667%{clip:rect(0.12rem, 99999px, 5rem, 0)}59.3333333333%{clip:rect(0.14rem, 99999px, 3.1rem, 0)}60%{clip:rect(0.12rem, 99999px, 8.5rem, 0)}60.6666666667%{clip:rect(0.14rem, 99999px, 1.9rem, 0)}61.3333333333%{clip:rect(0.02rem, 99999px, 3.5rem, 0)}62%{clip:rect(0.12rem, 99999px, 4.1rem, 0)}62.6666666667%{clip:rect(0.02rem, 99999px, 2.4rem, 0)}63.3333333333%{clip:rect(0.08rem, 99999px, 6.6rem, 0)}64%{clip:rect(0.2rem, 99999px, 6.8rem, 0)}64.6666666667%{clip:rect(0.02rem, 99999px, 8.2rem, 0)}65.3333333333%{clip:rect(0.02rem, 99999px, 7.6rem, 0)}66%{clip:rect(0.02rem, 99999px, 4.3rem, 0)}66.6666666667%{clip:rect(0.04rem, 99999px, 6.1rem, 0)}67.3333333333%{clip:rect(0.14rem, 99999px, 7.6rem, 0)}68%{clip:rect(0.2rem, 99999px, 4.5rem, 0)}68.6666666667%{clip:rect(0.2rem, 99999px, 5.6rem, 0)}69.3333333333%{clip:rect(0.12rem, 99999px, 8.2rem, 0)}70%{clip:rect(0.06rem, 99999px, 2.5rem, 0)}70.6666666667%{clip:rect(0.06rem, 99999px, 6rem, 0)}71.3333333333%{clip:rect(0.04rem, 99999px, 1.2rem, 0)}72%{clip:rect(0.14rem, 99999px, 3.4rem, 0)}72.6666666667%{clip:rect(0.18rem, 99999px, 9.4rem, 0)}73.3333333333%{clip:rect(0.14rem, 99999px, 9.1rem, 0)}74%{clip:rect(0.18rem, 99999px, 4.6rem, 0)}74.6666666667%{clip:rect(0.12rem, 99999px, 2.6rem, 0)}75.3333333333%{clip:rect(0.1rem, 99999px, 5.1rem, 0)}76%{clip:rect(0.14rem, 99999px, 9.8rem, 0)}76.6666666667%{clip:rect(0.06rem, 99999px, 6.8rem, 0)}77.3333333333%{clip:rect(0.02rem, 99999px, 8.6rem, 0)}78%{clip:rect(0.18rem, 99999px, 1.1rem, 0)}78.6666666667%{clip:rect(0.1rem, 99999px, 7.7rem, 0)}79.3333333333%{clip:rect(0.16rem, 99999px, 4.7rem, 0)}80%{clip:rect(0.02rem, 99999px, 1.4rem, 0)}80.6666666667%{clip:rect(0.08rem, 99999px, 9.2rem, 0)}81.3333333333%{clip:rect(0.16rem, 99999px, 8.4rem, 0)}82%{clip:rect(0.1rem, 99999px, 8.8rem, 0)}82.6666666667%{clip:rect(0.18rem, 99999px, 7.3rem, 0)}83.3333333333%{clip:rect(0.18rem, 99999px, 5.7rem, 0)}84%{clip:rect(0.06rem, 99999px, 2.6rem, 0)}84.6666666667%{clip:rect(0.06rem, 99999px, 7.9rem, 0)}85.3333333333%{clip:rect(0.16rem, 99999px, 5.1rem, 0)}86%{clip:rect(0.04rem, 99999px, 1.7rem, 0)}86.6666666667%{clip:rect(0.04rem, 99999px, 7.6rem, 0)}87.3333333333%{clip:rect(0.04rem, 99999px, 7.9rem, 0)}88%{clip:rect(0.14rem, 99999px, 4.4rem, 0)}88.6666666667%{clip:rect(0.18rem, 99999px, 2.6rem, 0)}89.3333333333%{clip:rect(0.16rem, 99999px, 4.7rem, 0)}90%{clip:rect(0.2rem, 99999px, 2.2rem, 0)}90.6666666667%{clip:rect(0.18rem, 99999px, 1.2rem, 0)}91.3333333333%{clip:rect(0.02rem, 99999px, 2.3rem, 0)}92%{clip:rect(0.02rem, 99999px, 7.8rem, 0)}92.6666666667%{clip:rect(0.08rem, 99999px, 9.9rem, 0)}93.3333333333%{clip:rect(0.02rem, 99999px, 7.7rem, 0)}94%{clip:rect(0.04rem, 99999px, 9.9rem, 0)}94.6666666667%{clip:rect(0.14rem, 99999px, 1.9rem, 0)}95.3333333333%{clip:rect(0.16rem, 99999px, 9.3rem, 0)}96%{clip:rect(0.04rem, 99999px, 5.3rem, 0)}96.6666666667%{clip:rect(0.2rem, 99999px, 4.1rem, 0)}97.3333333333%{clip:rect(0.14rem, 99999px, 7.9rem, 0)}98%{clip:rect(0.06rem, 99999px, 6.4rem, 0)}98.6666666667%{clip:rect(0.06rem, 99999px, 0.4rem, 0)}99.3333333333%{clip:rect(0.02rem, 99999px, 9.8rem, 0)}}@keyframes svelte-14v5lfi-glitch-skew{0%{transform:skew(-4deg)}10%{transform:skew(-4deg)}20%{transform:skew(2deg)}30%{transform:skew(1deg)}40%{transform:skew(4deg)}50%{transform:skew(-4deg)}60%{transform:skew(-4deg)}70%{transform:skew(-1deg)}80%{transform:skew(3deg)}90%{transform:skew(1deg)}}#bar.svelte-14v5lfi .logo.hover-effect-1.logo-behind-a.svelte-14v5lfi{color:var(--accent-light);transform:translateX(-0.5rem);color:#ff5500 !important;text-shadow:-2px 0 #ff5500, 2px 2px #ff5500;clip:rect(44px, 450px, 56px, 0);animation:svelte-14v5lfi-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-14v5lfi .logo.hover-effect-1.logo-behind-b.svelte-14v5lfi{color:#bfcc2e !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #450f8b;clip:rect(44px, 450px, 56px, 0);animation:svelte-14v5lfi-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-14v5lfi .logo.logo-behind.svelte-14v5lfi{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-14v5lfi .logo.logo-behind.svelte-14v5lfi:not(.hovered){display:none}#bar.svelte-14v5lfi #bar-right.svelte-14v5lfi{margin-left:auto;display:flex;margin-right:1rem;margin-top:1rem;position:relative}#bar.svelte-14v5lfi #bar-right #menus.svelte-14v5lfi{display:flex}#bar.svelte-14v5lfi #bar-right #menus #menu.svelte-14v5lfi{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-14v5lfi #bar-right #menus #menu.svelte-14v5lfi .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function NavBar_svelte_create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			style = dom_element("style");
			style.innerHTML = ``;
			add_location(style, NavBar_svelte_file, -1, 25982);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(style, NavBar_svelte_file, -1, 25865);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function NavBar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-14v5lfi");
			add_location(mark, NavBar_svelte_file, -1, 26215);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-14v5lfi");
			add_location(a0, NavBar_svelte_file, -1, 26143);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-14v5lfi");
			add_location(a1, NavBar_svelte_file, -1, 26258);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-14v5lfi");
			add_location(a2, NavBar_svelte_file, -1, 26350);
			attr_dev(div0, "id", "logo-container");
			add_location(div0, NavBar_svelte_file, -1, 26114);
			attr_dev(div1, "id", "bar-left");
			attr_dev(div1, "class", "svelte-14v5lfi");
			add_location(div1, NavBar_svelte_file, -1, 26067);
			attr_dev(div2, "id", "menu");
			attr_dev(div2, "class", "svelte-14v5lfi");
			add_location(div2, NavBar_svelte_file, -1, 26652);
			attr_dev(div3, "id", "menu");
			attr_dev(div3, "class", "svelte-14v5lfi");
			add_location(div3, NavBar_svelte_file, -1, 26953);
			attr_dev(div4, "id", "menus");
			attr_dev(div4, "class", "svelte-14v5lfi");
			add_location(div4, NavBar_svelte_file, -1, 26606);
			attr_dev(div5, "id", "bar-right");
			attr_dev(div5, "class", "svelte-14v5lfi");
			add_location(div5, NavBar_svelte_file, -1, 26507);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-14v5lfi");
			add_location(nav, NavBar_svelte_file, -1, 26024);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*hovered_class*/ 64 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-14v5lfi")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-14v5lfi")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-14v5lfi")) {
