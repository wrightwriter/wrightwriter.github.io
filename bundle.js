...
<span class="token punctuation">&#125;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(brb8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 75, 0, 2875);
			...
			add_location(brb9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 79, 6, 3126);
			...
			add_location(p5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 84, 0, 3391);
			add_location(brb10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 85, 0, 3536);
			add_location(brb11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 86, 0, 3544);
			add_location(brb12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 92, 0, 3800);
			add_location(brb13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 93, 0, 3808);
			add_location(p6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 94, 0, 3816);
			...
			add_location(p7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 101, 0, 4242);
			attr_dev(pre0, "class", "language-glsl");
			add_location(pre0, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 102, 0, 4292);
			add_location(p8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 146, 0, 10680);
			add_location(brb14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 147, 0, 10708);
			attr_dev(pre1, "class", "language-undefined");
			add_location(pre1, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 148, 0, 10716);
			attr_dev(a6, "href", "https://www.khronos.org/opengl/wiki/Shader#Execution_and_invocations");
			attr_dev(a6, "rel", "nofollow");
			add_location(a6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 150, 0, 10914);
			attr_dev(a7, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a7, "rel", "nofollow");
			add_location(a7, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 155, 3, 11188);
			add_location(li4, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 150, 0, 10874);
			add_location(li5, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 160, 0, 11364);
			add_location(li6, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 162, 0, 11582);
			add_location(ul, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 149, 0, 10869);
			attr_dev(a8, "href", "https://www.khronos.org/opengl/wiki/Type_Qualifier_(GLSL)");
			attr_dev(a8, "rel", "nofollow");
			add_location(a8, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 165, 0, 11715);
			add_location(p9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 165, 0, 11695);
			add_location(brb15, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 169, 0, 11825);
			add_location(brb16, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 170, 0, 11835);
			attr_dev(a9, "href", "https://www.shadertoy.com/view/4dX3zl");
			add_location(a9, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 174, 0, 11964);
			add_location(p10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 171, 0, 11845);
			add_location(p11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 175, 0, 12051);
			attr_dev(pre2, "class", "language-glsl");
			add_location(pre2, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 176, 0, 12099);
			attr_dev(a10, "href", "https://en.wikipedia.org/wiki/Linearizability");
			attr_dev(a10, "rel", "nofollow");
			add_location(a10, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 201, 3, 19381);
			attr_dev(a11, "href", "https://en.wikipedia.org/wiki/Race_condition");
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 204, 66, 19524);
			add_location(p12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 201, 0, 19372);
			attr_dev(a12, "href", "https://registry.khronos.org/OpenGL/extensions/NV/NV_shader_atomic_float.txt");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 208, 75, 19702);
			attr_dev(a13, "href", "https://en.wikipedia.org/wiki/Compare-and-swap");
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 212, 5, 19838);
			add_location(p13, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 208, 0, 19620);
			add_location(p14, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 216, 0, 19951);
			add_location(p15, _2023_08_18_forward_pathtracing_in_comp_shader_svelte_file, 217, 0, 20009);
...
function _2023_08_17_flame_fractals_in_comp_shader_svelte_create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 52, 2, 2002);
			attr_dev(a1, "href", "https://www.technochroma.art");
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 52, 50, 2097);
		},
		m: function mount(target, anchor) {
...
function _2023_08_17_flame_fractals_in_comp_shader_svelte_create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 65, 65, 2621);
		},
		m: function mount(target, anchor) {
			insert_dev(target, a0, anchor);
			insert_dev(target, t1, anchor);
...
<span class="token keyword">ivec2</span> int_p <span class="token operator">=</span> <span class="token keyword">ivec2</span><span class="token punctuation">(</span>uv <span class="token operator">+</span> anti_aliasing <span class="token operator">+</span> dof_sample<span class="token punctuation">)</span><span class="token operator">*</span><span class="token keyword">ivec2</span><span class="token punctuation">(</span>resolution<span class="token punctuation">)</span><span class="token punctuation">;</span></code>` + "";
	...
	const block = {
		c: function create() {
			...
			add_location(strong0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 20, 1, 832);
			...
			attr_dev(a3, "rel", "nofollow");
			add_location(a3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 29, 0, 1267);
			...
			add_location(a4, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 32, 10, 1442);
			...
			add_location(a9, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 57, 7, 2365);
			...
			attr_dev(a10, "rel", "nofollow");
			add_location(a10, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 69, 0, 2761);
			...
			add_location(em0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 76, 30, 3103);
			...
			add_location(em1, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 80, 22, 3316);
			...
			add_location(ul0, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 78, 30, 3206);
			...
			attr_dev(a11, "rel", "nofollow");
			add_location(a11, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 92, 0, 3669);
			attr_dev(a12, "href", "https://en.wikipedia.org/wiki/Iterated_function_system");
			attr_dev(a12, "rel", "nofollow");
			add_location(a12, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 95, 0, 3823);
			...
			attr_dev(a13, "rel", "nofollow");
			add_location(a13, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 101, 4, 3989);
			...
			add_location(a14, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 104, 19, 4310);
			...
			add_location(a16, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 181, 6, 18657);
			...
			add_location(a17, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 188, 0, 19286);
			attr_dev(a18, "href", "https://www.khronos.org/opengl/wiki/Memory_Model#Ensuring_visibility");
			attr_dev(a18, "rel", "nofollow");
			add_location(a18, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 193, 8, 19560);
			...
			add_location(strong2, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 208, 4, 20209);
			...
			add_location(a20, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 227, 30, 26042);
			...
			add_location(code, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 234, 24, 26284);
			attr_dev(a22, "href", "https://en.wikipedia.org/wiki/M%C3%B6bius_transformation");
			attr_dev(a22, "rel", "nofollow");
			add_location(a22, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 234, 56, 26333);
			attr_dev(a23, "href", "https://en.wikipedia.org/wiki/Conformal_map");
			attr_dev(a23, "rel", "nofollow");
			add_location(a23, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 238, 26, 26527);
			...
			add_location(a24, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 1, 26724);
			...
			add_location(a25, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 246, 82, 26805);
			...
			add_location(strong3, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 251, 3, 27016);
			...
			add_location(a26, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 252, 29, 27101);
			...
			add_location(a27, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 257, 3, 27494);
			...
			add_location(a28, _2023_08_17_flame_fractals_in_comp_shader_svelte_file, 261, 53, 27686);
...
function NavBar_svelte_add_css(target) {
	append_styles(target, "svelte-zqgyzq", "#bar.svelte-zqgyzq.svelte-zqgyzq{width:100%;margin-top:1rem;margin-bottom:1rem;display:flex;flex-wrap:wrap;width:100%}#bar.svelte-zqgyzq #bar-left.svelte-zqgyzq{display:flex;flex-direction:column}#bar.svelte-zqgyzq mark.svelte-zqgyzq{background:var(--accent-dark)}#bar.svelte-zqgyzq .logo.svelte-zqgyzq{font-size:4rem;margin-left:1rem;height:fit-content;text-decoration:none}#bar.svelte-zqgyzq .logo.logo-behind.svelte-zqgyzq{position:absolute}#bar.svelte-zqgyzq .logo.hovered.svelte-zqgyzq{color:var(--accent-dark) !important}#bar.svelte-zqgyzq .logo.hovered.hover-effect-0.svelte-zqgyzq{animation:svelte-zqgyzq-glitch-anim3 10s infinite linear alternate-reverse}@keyframes svelte-zqgyzq-distort1{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0.5rem, 0rem)}25%{transform:translate(0.5rem, 1.5rem)}37.5%{transform:translate(0rem, 0.5rem)}50%{transform:translate(0.5rem, 0.5rem)}62.5%{transform:translate(0.5rem, 0rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0rem, 0.5rem)}100%{transform:translate(1.5rem, 0.5rem)}}@keyframes svelte-zqgyzq-distort2{0%{transform:translate(0.5rem, 0.5rem)}12.5%{transform:translate(0rem, 0.5rem)}25%{transform:translate(1.5rem, 0.5rem)}37.5%{transform:translate(1.5rem, 0rem)}50%{transform:translate(1.5rem, 0.5rem)}62.5%{transform:translate(0rem, 1.5rem)}75%{transform:translate(0.5rem, 0.5rem)}87.5%{transform:translate(0.5rem, 0rem)}100%{transform:translate(0.5rem, 0.5rem)}}@keyframes svelte-zqgyzq-glitch-anim3{0%{clip:rect(1.9rem, 9999px, 1rem, 0);transform-origin:center}2%{clip:rect(3.4rem, 9999px, 2.5rem, 0);transform-origin:center}4%{clip:rect(2.8rem, 9999px, 1rem, 0);transform-origin:center}6%{clip:rect(3.8rem, 9999px, 4.5rem, 0);transform-origin:center}8%{clip:rect(0.7rem, 9999px, 5rem, 0);transform-origin:center}10%{clip:rect(1rem, 9999px, 5rem, 0);transform-origin:center}12%{clip:rect(3.7rem, 9999px, 0.5rem, 0);transform-origin:center}14%{clip:rect(3.7rem, 9999px, 1rem, 0);transform-origin:center}16%{clip:rect(0.7rem, 9999px, 1rem, 0);transform-origin:center}18%{clip:rect(2.8rem, 9999px, 1.5rem, 0);transform-origin:center}20%{clip:rect(0.6rem, 9999px, 3rem, 0);transform-origin:center}22%{clip:rect(1.6rem, 9999px, 4.5rem, 0);transform-origin:center}24%{clip:rect(2.9rem, 9999px, 2rem, 0);transform-origin:center}26%{clip:rect(2rem, 9999px, 5rem, 0);transform-origin:center}28%{clip:rect(4rem, 9999px, 3.5rem, 0);transform-origin:center}30%{clip:rect(0.2rem, 9999px, 2.5rem, 0);transform-origin:center}32%{clip:rect(1.4rem, 9999px, 3rem, 0);transform-origin:center}34%{clip:rect(0.1rem, 9999px, 3rem, 0);transform-origin:center}36%{clip:rect(1.1rem, 9999px, 5rem, 0);transform-origin:center}38%{clip:rect(3.4rem, 9999px, 4.5rem, 0);transform-origin:center}40%{clip:rect(0.3rem, 9999px, 5rem, 0);transform-origin:center}42%{clip:rect(0.3rem, 9999px, 2.5rem, 0);transform-origin:center}44%{clip:rect(0.4rem, 9999px, 2.5rem, 0);transform-origin:center}46%{clip:rect(1.4rem, 9999px, 4.5rem, 0);transform-origin:center}48%{clip:rect(0.8rem, 9999px, 5rem, 0);transform-origin:center}50%{clip:rect(1.7rem, 9999px, 2rem, 0);transform-origin:center}52%{clip:rect(0.5rem, 9999px, 3.5rem, 0);transform-origin:center}54%{clip:rect(2.2rem, 9999px, 2rem, 0);transform-origin:center}56%{clip:rect(1.7rem, 9999px, 4.5rem, 0);transform-origin:center}58%{clip:rect(2.8rem, 9999px, 2.5rem, 0);transform-origin:center}60%{clip:rect(3.6rem, 9999px, 4rem, 0);transform-origin:center}62%{clip:rect(1rem, 9999px, 4.5rem, 0);transform-origin:center}64%{clip:rect(3.7rem, 9999px, 0.5rem, 0);transform-origin:center}66%{clip:rect(3.7rem, 9999px, 3.5rem, 0);transform-origin:center}68%{clip:rect(3.9rem, 9999px, 4.5rem, 0);transform-origin:center}70%{clip:rect(3.2rem, 9999px, 1.5rem, 0);transform-origin:center}72%{clip:rect(0.8rem, 9999px, 5rem, 0);transform-origin:center}74%{clip:rect(2rem, 9999px, 4.5rem, 0);transform-origin:center}76%{clip:rect(2.4rem, 9999px, 5rem, 0);transform-origin:center}78%{clip:rect(1.1rem, 9999px, 3rem, 0);transform-origin:center}80%{clip:rect(3.7rem, 9999px, 3rem, 0);transform-origin:center}82%{clip:rect(0.4rem, 9999px, 4rem, 0);transform-origin:center}84%{clip:rect(1.5rem, 9999px, 2rem, 0);transform-origin:center}86%{clip:rect(1.1rem, 9999px, 0.5rem, 0);transform-origin:center}88%{clip:rect(1.1rem, 9999px, 0.5rem, 0);transform-origin:center}90%{clip:rect(3.7rem, 9999px, 3rem, 0);transform-origin:center}92%{clip:rect(1.6rem, 9999px, 4rem, 0);transform-origin:center}94%{clip:rect(3rem, 9999px, 2.5rem, 0);transform-origin:center}96%{clip:rect(4rem, 9999px, 4.5rem, 0);transform-origin:center}98%{clip:rect(2.4rem, 9999px, 3rem, 0);transform-origin:center}}@keyframes svelte-zqgyzq-cooool{0%{color:red !important}2%{color:red !important}4%{color:red !important}6%{color:red !important}8%{color:red !important}10%{color:red !important}12%{color:red !important}14%{color:red !important}16%{color:red !important}18%{color:red !important}20%{color:red !important}22%{color:red !important}24%{color:red !important}26%{color:red !important}28%{color:red !important}30%{color:red !important}32%{color:red !important}34%{color:red !important}36%{color:red !important}38%{color:red !important}40%{color:red !important}42%{color:red !important}44%{color:red !important}46%{color:red !important}48%{color:red !important}50%{color:red !important}52%{color:red !important}54%{color:red !important}56%{color:red !important}58%{color:red !important}60%{color:red !important}62%{color:red !important}64%{color:red !important}66%{color:red !important}68%{color:red !important}70%{color:red !important}72%{color:red !important}74%{color:red !important}76%{color:red !important}78%{color:red !important}80%{color:red !important}82%{color:red !important}84%{color:red !important}86%{color:red !important}88%{color:red !important}90%{color:red !important}92%{color:red !important}94%{color:red !important}96%{color:red !important}98%{color:red !important}}#bar.svelte-zqgyzq .logo.hovered.hover-effect-0.logo-behind-a.svelte-zqgyzq{color:#ffc800 !important;animation:svelte-zqgyzq-distort1 300ms linear infinite, svelte-zqgyzq-glitch-anim3 5s infinite linear alternate-reverse, svelte-zqgyzq-cooool 5s infinite linear alternate-reverse}#bar.svelte-zqgyzq .logo.hovered.hover-effect-0.logo-behind-b.svelte-zqgyzq{color:#aa10f2 !important;animation:svelte-zqgyzq-distort2 300ms linear infinite, svelte-zqgyzq-glitch-anim3 3s infinite linear alternate-reverse}#bar.svelte-zqgyzq .logo.hover-effect-1.svelte-zqgyzq{animation:svelte-zqgyzq-glitch-skew 1s infinite linear alternate-reverse}@keyframes svelte-zqgyzq-glitch-anim{0%{clip:rect(1rem, 9999px, 2.5rem, 0);transform:skew(5.9deg);z-index:2}2%{clip:rect(0.2rem, 9999px, 2rem, 0);transform:skew(4deg);z-index:2}4%{clip:rect(2.1rem, 9999px, 5rem, 0);transform:skew(6.1deg);z-index:1}6%{clip:rect(1.5rem, 9999px, 0.5rem, 0);transform:skew(3.6deg);z-index:2}8%{clip:rect(2rem, 9999px, 1.5rem, 0);transform:skew(4.6deg);z-index:1}10%{clip:rect(3.4rem, 9999px, 5rem, 0);transform:skew(5.8deg);z-index:2}12%{clip:rect(2.7rem, 9999px, 3rem, 0);transform:skew(2.1deg);z-index:2}14%{clip:rect(0.7rem, 9999px, 3rem, 0);transform:skew(5.5deg);z-index:1}16%{clip:rect(2.7rem, 9999px, 5rem, 0);transform:skew(2.8deg);z-index:1}18%{clip:rect(2.2rem, 9999px, 2rem, 0);transform:skew(4.6deg);z-index:2}20%{clip:rect(3.9rem, 9999px, 5rem, 0);transform:skew(0.8deg);z-index:3}22%{clip:rect(2.1rem, 9999px, 3.5rem, 0);transform:skew(1.2deg);z-index:4}24%{clip:rect(2.3rem, 9999px, 1rem, 0);transform:skew(3deg);z-index:1}26%{clip:rect(0.4rem, 9999px, 1rem, 0);transform:skew(9.7deg);z-index:1}28%{clip:rect(3.5rem, 9999px, 4.5rem, 0);transform:skew(3.3deg);z-index:3}30%{clip:rect(2.7rem, 9999px, 1rem, 0);transform:skew(2.4deg);z-index:2}32%{clip:rect(2.2rem, 9999px, 2rem, 0);transform:skew(5.1deg);z-index:1}34%{clip:rect(2.8rem, 9999px, 2.5rem, 0);transform:skew(3.5deg);z-index:4}36%{clip:rect(1.7rem, 9999px, 2.5rem, 0);transform:skew(2.5deg);z-index:3}38%{clip:rect(4rem, 9999px, 4.5rem, 0);transform:skew(0.2deg);z-index:4}40%{clip:rect(3.8rem, 9999px, 4rem, 0);transform:skew(4.8deg);z-index:1}42%{clip:rect(3rem, 9999px, 2.5rem, 0);transform:skew(7.3deg);z-index:2}44%{clip:rect(3.4rem, 9999px, 1rem, 0);transform:skew(1.7deg);z-index:4}46%{clip:rect(3.9rem, 9999px, 3.5rem, 0);transform:skew(2.1deg);z-index:4}48%{clip:rect(1.8rem, 9999px, 1rem, 0);transform:skew(6.6deg);z-index:2}50%{clip:rect(1.5rem, 9999px, 1.5rem, 0);transform:skew(6.2deg);z-index:1}52%{clip:rect(3.5rem, 9999px, 4rem, 0);transform:skew(7.6deg);z-index:3}54%{clip:rect(3.6rem, 9999px, 0.5rem, 0);transform:skew(0.3deg);z-index:3}56%{clip:rect(3.3rem, 9999px, 0.5rem, 0);transform:skew(8.7deg);z-index:1}58%{clip:rect(1.8rem, 9999px, 4rem, 0);transform:skew(3.2deg);z-index:1}60%{clip:rect(2.8rem, 9999px, 0.5rem, 0);transform:skew(9.5deg);z-index:1}62%{clip:rect(1.9rem, 9999px, 3rem, 0);transform:skew(3.6deg);z-index:4}64%{clip:rect(1.1rem, 9999px, 5rem, 0);transform:skew(8.3deg);z-index:1}66%{clip:rect(0.4rem, 9999px, 1.5rem, 0);transform:skew(9.6deg);z-index:2}68%{clip:rect(4rem, 9999px, 1rem, 0);transform:skew(3.5deg);z-index:1}70%{clip:rect(3.4rem, 9999px, 3.5rem, 0);transform:skew(4.4deg);z-index:3}72%{clip:rect(3.8rem, 9999px, 3rem, 0);transform:skew(4.7deg);z-index:3}74%{clip:rect(0.4rem, 9999px, 1rem, 0);transform:skew(2.3deg);z-index:1}76%{clip:rect(3.8rem, 9999px, 0.5rem, 0);transform:skew(4deg);z-index:3}78%{clip:rect(4rem, 9999px, 4rem, 0);transform:skew(7.1deg);z-index:1}80%{clip:rect(1rem, 9999px, 4.5rem, 0);transform:skew(8.5deg);z-index:2}82%{clip:rect(3.6rem, 9999px, 3.5rem, 0);transform:skew(4.5deg);z-index:1}84%{clip:rect(2.9rem, 9999px, 2.5rem, 0);transform:skew(6.4deg);z-index:4}86%{clip:rect(1.7rem, 9999px, 4.5rem, 0);transform:skew(3deg);z-index:2}88%{clip:rect(0.3rem, 9999px, 3.5rem, 0);transform:skew(3.2deg);z-index:1}90%{clip:rect(1.9rem, 9999px, 1.5rem, 0);transform:skew(5.7deg);z-index:2}92%{clip:rect(3.7rem, 9999px, 2rem, 0);transform:skew(1.7deg);z-index:3}94%{clip:rect(2.6rem, 9999px, 1.5rem, 0);transform:skew(0.9deg);z-index:4}96%{clip:rect(2rem, 9999px, 3rem, 0);transform:skew(2.8deg);z-index:4}98%{clip:rect(3.5rem, 9999px, 5rem, 0);transform:skew(4deg);z-index:4}}@keyframes svelte-zqgyzq-glitch-anim2{0%{clip:rect(0.04rem, 99999px, 6.1rem, 0);transform:skew(8.2deg);transform:translateX(0.4259259259rem)}0.6666666667%{clip:rect(0.14rem, 99999px, 5rem, 0);transform:skew(9deg);transform:translateX(0.4444444444rem)}1.3333333333%{clip:rect(0.18rem, 99999px, 8.4rem, 0);transform:skew(6.4deg);transform:translateX(0rem)}2%{clip:rect(0.16rem, 99999px, 0.2rem, 0);transform:skew(10.3deg);transform:translateX(0.2777777778rem)}2.6666666667%{clip:rect(0.06rem, 99999px, 4.7rem, 0);transform:skew(0.2deg);transform:translateX(0.2037037037rem)}3.3333333333%{clip:rect(0.14rem, 99999px, 7.5rem, 0);transform:skew(8.5deg);transform:translateX(0.3888888889rem)}4%{clip:rect(0.14rem, 99999px, 6.4rem, 0);transform:skew(6.2deg);transform:translateX(0.3888888889rem)}4.6666666667%{clip:rect(0.08rem, 99999px, 4.6rem, 0);transform:skew(13deg);transform:translateX(0.2777777778rem)}5.3333333333%{clip:rect(0.02rem, 99999px, 4.3rem, 0);transform:skew(14.9deg);transform:translateX(0.0555555556rem)}6%{clip:rect(0.02rem, 99999px, 6.5rem, 0);transform:skew(14.2deg);transform:translateX(0.3888888889rem)}6.6666666667%{clip:rect(0.18rem, 99999px, 0.6rem, 0);transform:skew(8.5deg);transform:translateX(0.2777777778rem)}7.3333333333%{clip:rect(0.06rem, 99999px, 6.7rem, 0);transform:skew(8.2deg);transform:translateX(0.1666666667rem)}8%{clip:rect(0.12rem, 99999px, 0.5rem, 0);transform:skew(10.7deg);transform:translateX(0.1666666667rem)}8.6666666667%{clip:rect(0.06rem, 99999px, 4rem, 0);transform:skew(8deg);transform:translateX(0.2037037037rem)}9.3333333333%{clip:rect(0.08rem, 99999px, 0.6rem, 0);transform:skew(6.7deg);transform:translateX(0.3888888889rem)}10%{clip:rect(0.14rem, 99999px, 7.5rem, 0);transform:skew(7.6deg);transform:translateX(0.4259259259rem)}10.6666666667%{clip:rect(0.14rem, 99999px, 1.2rem, 0);transform:skew(9.1deg);transform:translateX(0.4259259259rem)}11.3333333333%{clip:rect(0.1rem, 99999px, 8.9rem, 0);transform:skew(6.9deg);transform:translateX(0.1666666667rem)}12%{clip:rect(0.14rem, 99999px, 1.9rem, 0);transform:skew(13deg);transform:translateX(0.1666666667rem)}12.6666666667%{clip:rect(0.06rem, 99999px, 8.1rem, 0);transform:skew(10.7deg);transform:translateX(0rem)}13.3333333333%{clip:rect(0.08rem, 99999px, 8.4rem, 0);transform:skew(13.7deg);transform:translateX(0.3888888889rem)}14%{clip:rect(0.18rem, 99999px, 2.2rem, 0);transform:skew(9.4deg);transform:translateX(0.2777777778rem)}14.6666666667%{clip:rect(0.12rem, 99999px, 5.4rem, 0);transform:skew(3.3deg);transform:translateX(0.3888888889rem)}15.3333333333%{clip:rect(0.2rem, 99999px, 7.2rem, 0);transform:skew(1.2deg);transform:translateX(0.4444444444rem)}16%{clip:rect(0.16rem, 99999px, 6.3rem, 0);transform:skew(14.8deg);transform:translateX(0.462962963rem)}16.6666666667%{clip:rect(0.12rem, 99999px, 7.4rem, 0);transform:skew(6.1deg);transform:translateX(0.2777777778rem)}17.3333333333%{clip:rect(0.02rem, 99999px, 1.7rem, 0);transform:skew(13.7deg);transform:translateX(0.3888888889rem)}18%{clip:rect(0.2rem, 99999px, 5rem, 0);transform:skew(4.4deg);transform:translateX(-0.1666666667rem)}18.6666666667%{clip:rect(0.1rem, 99999px, 6.9rem, 0);transform:skew(7.7deg);transform:translateX(0.462962963rem)}19.3333333333%{clip:rect(0.12rem, 99999px, 2.9rem, 0);transform:skew(1.6deg);transform:translateX(0.3888888889rem)}20%{clip:rect(0.14rem, 99999px, 2.3rem, 0);transform:skew(6.2deg);transform:translateX(0.3518518519rem)}20.6666666667%{clip:rect(0.14rem, 99999px, 1.5rem, 0);transform:skew(1.9deg);transform:translateX(0.1666666667rem)}21.3333333333%{clip:rect(0.2rem, 99999px, 8.4rem, 0);transform:skew(5.7deg);transform:translateX(0.2777777778rem)}22%{clip:rect(0.16rem, 99999px, 7.8rem, 0);transform:skew(2.6deg);transform:translateX(0.3888888889rem)}22.6666666667%{clip:rect(0.08rem, 99999px, 6.7rem, 0);transform:skew(7.3deg);transform:translateX(0.462962963rem)}23.3333333333%{clip:rect(0.04rem, 99999px, 3.4rem, 0);transform:skew(7.6deg);transform:translateX(0.1666666667rem)}24%{clip:rect(0.14rem, 99999px, 4.4rem, 0);transform:skew(5.9deg);transform:translateX(0.0555555556rem)}24.6666666667%{clip:rect(0.08rem, 99999px, 1.9rem, 0);transform:skew(5.3deg);transform:translateX(0.3888888889rem)}25.3333333333%{clip:rect(0.18rem, 99999px, 5rem, 0);transform:skew(8.5deg);transform:translateX(0.0555555556rem)}26%{clip:rect(0.08rem, 99999px, 6.2rem, 0);transform:skew(13.4deg);transform:translateX(0.2037037037rem)}26.6666666667%{clip:rect(0.2rem, 99999px, 5.7rem, 0);transform:skew(13.3deg);transform:translateX(0.3888888889rem)}27.3333333333%{clip:rect(0.1rem, 99999px, 6.6rem, 0);transform:skew(0.5deg);transform:translateX(0.2777777778rem)}28%{clip:rect(0.2rem, 99999px, 3rem, 0);transform:skew(15deg);transform:translateX(0.2777777778rem)}28.6666666667%{clip:rect(0.12rem, 99999px, 10rem, 0);transform:skew(6.1deg);transform:translateX(0.462962963rem)}29.3333333333%{clip:rect(0.16rem, 99999px, 1.2rem, 0);transform:skew(3.3deg);transform:translateX(0.0555555556rem)}30%{clip:rect(0.12rem, 99999px, 7.2rem, 0);transform:skew(13.1deg);transform:translateX(0.462962963rem)}30.6666666667%{clip:rect(0.2rem, 99999px, 4.8rem, 0);transform:skew(3.2deg);transform:translateX(0.2037037037rem)}31.3333333333%{clip:rect(0.1rem, 99999px, 3.7rem, 0);transform:skew(7.4deg);transform:translateX(0.3518518519rem)}32%{clip:rect(0.12rem, 99999px, 6.3rem, 0);transform:skew(11.9deg);transform:translateX(0.3888888889rem)}32.6666666667%{clip:rect(0.04rem, 99999px, 5.7rem, 0);transform:skew(0.1deg);transform:translateX(0.4444444444rem)}33.3333333333%{clip:rect(0.08rem, 99999px, 8.3rem, 0);transform:skew(10.5deg);transform:translateX(0.2777777778rem)}34%{clip:rect(0.16rem, 99999px, 6rem, 0);transform:skew(8deg);transform:translateX(0.0555555556rem)}34.6666666667%{clip:rect(0.1rem, 99999px, 9.2rem, 0);transform:skew(7.1deg);transform:translateX(0.1666666667rem)}35.3333333333%{clip:rect(0.12rem, 99999px, 3.4rem, 0);transform:skew(1.7deg);transform:translateX(0.1666666667rem)}36%{clip:rect(0.1rem, 99999px, 4.1rem, 0);transform:skew(5.1deg);transform:translateX(0.3888888889rem)}36.6666666667%{clip:rect(0.18rem, 99999px, 9.6rem, 0);transform:skew(4.6deg);transform:translateX(0.1666666667rem)}37.3333333333%{clip:rect(0.16rem, 99999px, 3.2rem, 0);transform:skew(11.5deg);transform:translateX(0.4814814815rem)}38%{clip:rect(0.1rem, 99999px, 2.2rem, 0);transform:skew(13.2deg);transform:translateX(0.2037037037rem)}38.6666666667%{clip:rect(0.2rem, 99999px, 0.3rem, 0);transform:skew(9.1deg);transform:translateX(0.2777777778rem)}39.3333333333%{clip:rect(0.18rem, 99999px, 6.4rem, 0);transform:skew(5.4deg);transform:translateX(0.3888888889rem)}40%{clip:rect(0.18rem, 99999px, 6.2rem, 0);transform:skew(0.2deg);transform:translateX(-0.1666666667rem)}40.6666666667%{clip:rect(0.06rem, 99999px, 9.9rem, 0);transform:skew(4.5deg);transform:translateX(0.1666666667rem)}41.3333333333%{clip:rect(0.02rem, 99999px, 1.5rem, 0);transform:skew(1.7deg);transform:translateX(0.3888888889rem)}42%{clip:rect(0.02rem, 99999px, 7.1rem, 0);transform:skew(5.4deg);transform:translateX(0.3333333333rem)}42.6666666667%{clip:rect(0.18rem, 99999px, 5.8rem, 0);transform:skew(1.2deg);transform:translateX(0.2777777778rem)}43.3333333333%{clip:rect(0.04rem, 99999px, 5.8rem, 0);transform:skew(10.6deg);transform:translateX(0.2777777778rem)}44%{clip:rect(0.06rem, 99999px, 7.3rem, 0);transform:skew(13.9deg);transform:translateX(0.3518518519rem)}44.6666666667%{clip:rect(0.16rem, 99999px, 8.5rem, 0);transform:skew(9.4deg);transform:translateX(0.4259259259rem)}45.3333333333%{clip:rect(0.06rem, 99999px, 3.6rem, 0);transform:skew(6.9deg);transform:translateX(0.4444444444rem)}46%{clip:rect(0.16rem, 99999px, 7rem, 0);transform:skew(3.3deg);transform:translateX(0.3888888889rem)}46.6666666667%{clip:rect(0.04rem, 99999px, 6.9rem, 0);transform:skew(14.2deg);transform:translateX(0.3518518519rem)}47.3333333333%{clip:rect(0.18rem, 99999px, 7rem, 0);transform:skew(1.6deg);transform:translateX(-0.1666666667rem)}48%{clip:rect(0.1rem, 99999px, 4.3rem, 0);transform:skew(2.2deg);transform:translateX(0.2777777778rem)}48.6666666667%{clip:rect(0.14rem, 99999px, 1.9rem, 0);transform:skew(6.9deg);transform:translateX(0.1666666667rem)}49.3333333333%{clip:rect(0.06rem, 99999px, 0.2rem, 0);transform:skew(2.8deg);transform:translateX(0.462962963rem)}50%{clip:rect(0.16rem, 99999px, 5.9rem, 0);transform:skew(7.2deg);transform:translateX(0.4259259259rem)}50.6666666667%{clip:rect(0.2rem, 99999px, 5.8rem, 0);transform:skew(12.8deg);transform:translateX(0.1666666667rem)}51.3333333333%{clip:rect(0.14rem, 99999px, 5.5rem, 0);transform:skew(11.9deg);transform:translateX(0.4259259259rem)}52%{clip:rect(0.12rem, 99999px, 0.7rem, 0);transform:skew(1.8deg);transform:translateX(0.0555555556rem)}52.6666666667%{clip:rect(0.16rem, 99999px, 9.2rem, 0);transform:skew(3.1deg);transform:translateX(0.3333333333rem)}53.3333333333%{clip:rect(0.12rem, 99999px, 6.2rem, 0);transform:skew(2deg);transform:translateX(0.4259259259rem)}54%{clip:rect(0.18rem, 99999px, 7.2rem, 0);transform:skew(0.6deg);transform:translateX(0.4259259259rem)}54.6666666667%{clip:rect(0.14rem, 99999px, 0.6rem, 0);transform:skew(5.1deg);transform:translateX(0.3888888889rem)}55.3333333333%{clip:rect(0.02rem, 99999px, 9.3rem, 0);transform:skew(12.3deg);transform:translateX(-0.5rem)}56%{clip:rect(0.18rem, 99999px, 6.5rem, 0);transform:skew(3.1deg);transform:translateX(0.3518518519rem)}56.6666666667%{clip:rect(0.08rem, 99999px, 4.6rem, 0);transform:skew(10.3deg);transform:translateX(0.462962963rem)}57.3333333333%{clip:rect(0.08rem, 99999px, 7.6rem, 0);transform:skew(12.6deg);transform:translateX(0.3888888889rem)}58%{clip:rect(0.12rem, 99999px, 4.3rem, 0);transform:skew(12.7deg);transform:translateX(0.4444444444rem)}58.6666666667%{clip:rect(0.18rem, 99999px, 1.8rem, 0);transform:skew(5.9deg);transform:translateX(0.3888888889rem)}59.3333333333%{clip:rect(0.18rem, 99999px, 4.7rem, 0);transform:skew(1.9deg);transform:translateX(0.2777777778rem)}60%{clip:rect(0.1rem, 99999px, 7.4rem, 0);transform:skew(10.8deg);transform:translateX(0.4259259259rem)}60.6666666667%{clip:rect(0.14rem, 99999px, 9.9rem, 0);transform:skew(1.4deg);transform:translateX(0.0555555556rem)}61.3333333333%{clip:rect(0.16rem, 99999px, 0.3rem, 0);transform:skew(8.4deg);transform:translateX(0.2777777778rem)}62%{clip:rect(0.18rem, 99999px, 2.2rem, 0);transform:skew(0.1deg);transform:translateX(0.4444444444rem)}62.6666666667%{clip:rect(0.2rem, 99999px, 0.9rem, 0);transform:skew(6.3deg);transform:translateX(0.1666666667rem)}63.3333333333%{clip:rect(0.1rem, 99999px, 8.8rem, 0);transform:skew(9.9deg);transform:translateX(0.2777777778rem)}64%{clip:rect(0.02rem, 99999px, 8.5rem, 0);transform:skew(1.5deg);transform:translateX(0.3888888889rem)}64.6666666667%{clip:rect(0.16rem, 99999px, 5.7rem, 0);transform:skew(13.9deg);transform:translateX(0.3888888889rem)}65.3333333333%{clip:rect(0.12rem, 99999px, 9.9rem, 0);transform:skew(3.4deg);transform:translateX(0.0555555556rem)}66%{clip:rect(0.08rem, 99999px, 9.3rem, 0);transform:skew(8.2deg);transform:translateX(0rem)}66.6666666667%{clip:rect(0.2rem, 99999px, 9.9rem, 0);transform:skew(3.6deg);transform:translateX(0.462962963rem)}67.3333333333%{clip:rect(0.02rem, 99999px, 4.2rem, 0);transform:skew(7.4deg);transform:translateX(0.3518518519rem)}68%{clip:rect(0.04rem, 99999px, 9.1rem, 0);transform:skew(3.5deg);transform:translateX(0.0555555556rem)}68.6666666667%{clip:rect(0.18rem, 99999px, 6.2rem, 0);transform:skew(0.7deg);transform:translateX(0.3888888889rem)}69.3333333333%{clip:rect(0.02rem, 99999px, 3.3rem, 0);transform:skew(7deg);transform:translateX(0.2777777778rem)}70%{clip:rect(0.12rem, 99999px, 4.9rem, 0);transform:skew(2.5deg);transform:translateX(0.462962963rem)}70.6666666667%{clip:rect(0.16rem, 99999px, 4.2rem, 0);transform:skew(12.9deg);transform:translateX(0.3888888889rem)}71.3333333333%{clip:rect(0.04rem, 99999px, 5.3rem, 0);transform:skew(8.8deg);transform:translateX(0.3518518519rem)}72%{clip:rect(0.14rem, 99999px, 4.5rem, 0);transform:skew(13.2deg);transform:translateX(0.4259259259rem)}72.6666666667%{clip:rect(0.04rem, 99999px, 8.9rem, 0);transform:skew(9.2deg);transform:translateX(0.2777777778rem)}73.3333333333%{clip:rect(0.18rem, 99999px, 0.5rem, 0);transform:skew(14.4deg);transform:translateX(0.4259259259rem)}74%{clip:rect(0.1rem, 99999px, 0.7rem, 0);transform:skew(5deg);transform:translateX(0.4444444444rem)}74.6666666667%{clip:rect(0.16rem, 99999px, 6.1rem, 0);transform:skew(12.5deg);transform:translateX(0.1666666667rem)}75.3333333333%{clip:rect(0.08rem, 99999px, 7.1rem, 0);transform:skew(11.9deg);transform:translateX(0.0555555556rem)}76%{clip:rect(0.14rem, 99999px, 3.7rem, 0);transform:skew(14.5deg);transform:translateX(0.3888888889rem)}76.6666666667%{clip:rect(0.14rem, 99999px, 7.4rem, 0);transform:skew(14.5deg);transform:translateX(0.3333333333rem)}77.3333333333%{clip:rect(0.02rem, 99999px, 9.7rem, 0);transform:skew(14.9deg);transform:translateX(0.4259259259rem)}78%{clip:rect(0.02rem, 99999px, 7.8rem, 0);transform:skew(8.5deg);transform:translateX(0rem)}78.6666666667%{clip:rect(0.18rem, 99999px, 5.2rem, 0);transform:skew(9.7deg);transform:translateX(0.2777777778rem)}79.3333333333%{clip:rect(0.14rem, 99999px, 1.2rem, 0);transform:skew(9.2deg);transform:translateX(0.1666666667rem)}80%{clip:rect(0.12rem, 99999px, 1.5rem, 0);transform:skew(5.4deg);transform:translateX(0.3518518519rem)}80.6666666667%{clip:rect(0.08rem, 99999px, 7.4rem, 0);transform:skew(5.3deg);transform:translateX(0.462962963rem)}81.3333333333%{clip:rect(0.04rem, 99999px, 7.4rem, 0);transform:skew(15deg);transform:translateX(0.3888888889rem)}82%{clip:rect(0.2rem, 99999px, 5.7rem, 0);transform:skew(11.9deg);transform:translateX(0.462962963rem)}82.6666666667%{clip:rect(0.02rem, 99999px, 8.2rem, 0);transform:skew(7.9deg);transform:translateX(0.2777777778rem)}83.3333333333%{clip:rect(0.02rem, 99999px, 4.7rem, 0);transform:skew(6.5deg);transform:translateX(0.2777777778rem)}84%{clip:rect(0.18rem, 99999px, 3.6rem, 0);transform:skew(6.5deg);transform:translateX(0.462962963rem)}84.6666666667%{clip:rect(0.14rem, 99999px, 0.2rem, 0);transform:skew(0.1deg);transform:translateX(0.1666666667rem)}85.3333333333%{clip:rect(0.16rem, 99999px, 1.1rem, 0);transform:skew(0.7deg);transform:translateX(0.462962963rem)}86%{clip:rect(0.16rem, 99999px, 8.2rem, 0);transform:skew(5.6deg);transform:translateX(0.2777777778rem)}86.6666666667%{clip:rect(0.18rem, 99999px, 6.4rem, 0);transform:skew(2.8deg);transform:translateX(0.3888888889rem)}87.3333333333%{clip:rect(0.14rem, 99999px, 9.2rem, 0);transform:skew(9.9deg);transform:translateX(0.2037037037rem)}88%{clip:rect(0.02rem, 99999px, 9.6rem, 0);transform:skew(6.3deg);transform:translateX(0.0555555556rem)}88.6666666667%{clip:rect(0.14rem, 99999px, 8rem, 0);transform:skew(9.8deg);transform:translateX(0.1666666667rem)}89.3333333333%{clip:rect(0.12rem, 99999px, 3.4rem, 0);transform:skew(8.7deg);transform:translateX(0rem)}90%{clip:rect(0.14rem, 99999px, 3.2rem, 0);transform:skew(3.5deg);transform:translateX(0.1666666667rem)}90.6666666667%{clip:rect(0.06rem, 99999px, 9.1rem, 0);transform:skew(13.2deg);transform:translateX(0.2777777778rem)}91.3333333333%{clip:rect(0.08rem, 99999px, 8rem, 0);transform:skew(12.9deg);transform:translateX(0.3888888889rem)}92%{clip:rect(0.02rem, 99999px, 7.8rem, 0);transform:skew(14deg);transform:translateX(0.3518518519rem)}92.6666666667%{clip:rect(0.16rem, 99999px, 8rem, 0);transform:skew(6.2deg);transform:translateX(0.2777777778rem)}93.3333333333%{clip:rect(0.08rem, 99999px, 5.9rem, 0);transform:skew(2.8deg);transform:translateX(0.2777777778rem)}94%{clip:rect(0.12rem, 99999px, 8.4rem, 0);transform:skew(2.8deg);transform:translateX(0.4814814815rem)}94.6666666667%{clip:rect(0.2rem, 99999px, 5.9rem, 0);transform:skew(5.1deg);transform:translateX(0.4259259259rem)}95.3333333333%{clip:rect(0.08rem, 99999px, 5.8rem, 0);transform:skew(13.8deg);transform:translateX(0.2777777778rem)}96%{clip:rect(0.12rem, 99999px, 9.9rem, 0);transform:skew(7.6deg);transform:translateX(0.3333333333rem)}96.6666666667%{clip:rect(0.18rem, 99999px, 2.2rem, 0);transform:skew(7.3deg);transform:translateX(0.3333333333rem)}97.3333333333%{clip:rect(0.12rem, 99999px, 8.8rem, 0);transform:skew(6.6deg);transform:translateX(0.4444444444rem)}98%{clip:rect(0.16rem, 99999px, 7rem, 0);transform:skew(12.1deg);transform:translateX(0.2777777778rem)}98.6666666667%{clip:rect(0.2rem, 99999px, 1.8rem, 0);transform:skew(6.8deg);transform:translateX(0.2777777778rem)}99.3333333333%{clip:rect(0.06rem, 99999px, 2.3rem, 0);transform:skew(1.9deg);transform:translateX(0.3518518519rem)}}@keyframes svelte-zqgyzq-glitch-skew{0%{transform:skew(0deg)}10%{transform:skew(-3deg)}20%{transform:skew(-2deg)}30%{transform:skew(-1deg)}40%{transform:skew(-3deg)}50%{transform:skew(0deg)}60%{transform:skew(-3deg)}70%{transform:skew(0deg)}80%{transform:skew(-4deg)}90%{transform:skew(4deg)}}#bar.svelte-zqgyzq .logo.hover-effect-1.logo-behind-a.svelte-zqgyzq{color:var(--accent-light);transform:translateX(-0.5rem);color:#ffc800 !important;text-shadow:-2px 0 #ffc800, 2px 2px #ffc800;clip:rect(44px, 450px, 56px, 0);animation:svelte-zqgyzq-glitch-anim2 5s infinite linear alternate-reverse}#bar.svelte-zqgyzq .logo.hover-effect-1.logo-behind-b.svelte-zqgyzq{color:rgb(165, 49, 49) !important;z-index:1;transform:translateX(0.2rem);text-shadow:-2px 0 #aa10f2;clip:rect(44px, 450px, 56px, 0);animation:svelte-zqgyzq-glitch-anim 5s infinite linear alternate-reverse}#bar.svelte-zqgyzq .logo.logo-behind.svelte-zqgyzq{width:0px;height:0px;overflow:visible;pointer-events:none}#bar.svelte-zqgyzq .logo.logo-behind.svelte-zqgyzq:not(.hovered){display:none}#bar.svelte-zqgyzq #bar-right.svelte-zqgyzq{margin-left:auto;display:flex;margin-right:1rem;margin-top:1rem;position:relative}#bar.svelte-zqgyzq #bar-right #menus.svelte-zqgyzq{display:flex}#bar.svelte-zqgyzq #bar-right #menus #menu.svelte-zqgyzq{height:10rem;display:flex;flex-direction:column;justify-content:space-between;margin-right:1rem}#bar.svelte-zqgyzq #bar-right #menus #menu.svelte-zqgyzq .menu-item{font-weight:750;font-style:italic;width:fit-content}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function NavBar_svelte_create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			style = dom_element("style");
			style.innerHTML = ``;
			add_location(style, NavBar_svelte_file, -1, 36943);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(style, NavBar_svelte_file, -1, 36826);
		},
		m: function mount(target, anchor) {
			insert_dev(target, style, anchor);
		},
...
function NavBar_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(mark, "class", "svelte-zqgyzq");
			add_location(mark, NavBar_svelte_file, -1, 37176);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-zqgyzq");
			add_location(a0, NavBar_svelte_file, -1, 37104);
			attr_dev(a1, "href", "/");
			attr_dev(a1, "class", a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-zqgyzq");
			add_location(a1, NavBar_svelte_file, -1, 37219);
			attr_dev(a2, "href", "/");
			attr_dev(a2, "class", a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-zqgyzq");
			add_location(a2, NavBar_svelte_file, -1, 37311);
			attr_dev(div0, "id", "logo-container");
			add_location(div0, NavBar_svelte_file, -1, 37075);
			attr_dev(div1, "id", "bar-left");
			attr_dev(div1, "class", "svelte-zqgyzq");
			add_location(div1, NavBar_svelte_file, -1, 37028);
			attr_dev(div2, "id", "menu");
			attr_dev(div2, "class", "svelte-zqgyzq");
			add_location(div2, NavBar_svelte_file, -1, 37613);
			attr_dev(div3, "id", "menu");
			attr_dev(div3, "class", "svelte-zqgyzq");
			add_location(div3, NavBar_svelte_file, -1, 37914);
			attr_dev(div4, "id", "menus");
			attr_dev(div4, "class", "svelte-zqgyzq");
			add_location(div4, NavBar_svelte_file, -1, 37567);
			attr_dev(div5, "id", "bar-right");
			attr_dev(div5, "class", "svelte-zqgyzq");
			add_location(div5, NavBar_svelte_file, -1, 37468);
			attr_dev(nav, "id", "bar");
			attr_dev(nav, "class", "svelte-zqgyzq");
			add_location(nav, NavBar_svelte_file, -1, 36985);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*hovered_class*/ 64 && a0_class_value !== (a0_class_value = "logo logo-behind logo-behind-a " + /*hovered_class*/ ctx[6] + " svelte-zqgyzq")) {
				attr_dev(a0, "class", a0_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a1_class_value !== (a1_class_value = "logo logo-behind logo-behind-b " + /*hovered_class*/ ctx[6] + " svelte-zqgyzq")) {
				attr_dev(a1, "class", a1_class_value);
			}

			if (!current || dirty & /*hovered_class*/ 64 && a2_class_value !== (a2_class_value = "logo " + /*hovered_class*/ ctx[6] + " svelte-zqgyzq")) {
...
// (123:1) {#if path_name === "/favdemos" || path_name === "/favdemos.html" }
function App_svelte_create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(123:1) {#if path_name === \\\"/favdemos\\\" || path_name === \\\"/favdemos.html\\\" }",
		ctx
	});
...
function App_svelte_create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(link0, App_svelte_file, -1, 2618);
			...
			add_location(link1, App_svelte_file, -1, 2716);
			set_style(div, "width", "100%");
			set_style(div, "height", "100%");
			add_location(div, App_svelte_file, -1, 2833);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
